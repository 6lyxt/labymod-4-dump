...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<atm>> cir) {
        final List<atm> selectedPacks = (List<atm>)cir.getReturnValue();
