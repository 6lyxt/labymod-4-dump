...
import net.labymod.v1_21.client.player.inventory.InventoryTracker;
...
public class MixinInventory implements Inventory
{
    ...
    public <E> jv<E> withSize(final int size, final E object) {
    ...
    public cuq removeItem(final List<cuq> list, final int index, final int amount) {
        final cuq itemStack = bql.a((List)list, index, amount);
