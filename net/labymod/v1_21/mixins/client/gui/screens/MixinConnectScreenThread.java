...
public class MixinConnectScreenThread
{
    ...
    private Optional<gaw> labyMod$resolveAddress(final gaz resolver, final gax address) {
    ...
    public wz labyMod$fireServerKickEvent(final wz reason) {
        ...
        return (wz)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN)).reason());
    }
}
