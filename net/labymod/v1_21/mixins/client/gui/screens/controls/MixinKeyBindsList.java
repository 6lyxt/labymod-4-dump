...
@Mixin({ frn.class })
public abstract class MixinKeyBindsList extends fis<frn.b>
{
    public MixinKeyBindsList(final fgo $$0, final int $$1, final int $$2, final int $$3, final int $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    
    @Redirect(method = { "<init>" }, at = @At(value = "FIELD", target = "Lnet/minecraft/client/Options;keyMappings:[Lnet/minecraft/client/KeyMapping;"))
    private fgm[] labyMod$addCustomKeybindings(final fgs instance) {
        final List<fgm> keyMappings = new ArrayList<fgm>(Arrays.asList(instance.W));
        ...
        return keyMappings.toArray(new fgm[0]);
    }
}
