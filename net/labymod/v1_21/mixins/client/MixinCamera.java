...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final exc position = this.b();
        this.labymod$cameraPosition.set((float)position.a(ji.a.a), (float)position.a(ji.a.b), (float)position.a(ji.a.c));
    ...
    public DoubleVector3 position() {
        final exc position = this.b();
        this.labyMod$position.set(position.a(ji.a.a), position.a(ji.a.b), position.a(ji.a.c));
