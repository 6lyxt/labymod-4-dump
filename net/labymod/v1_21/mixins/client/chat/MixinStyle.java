...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract xw a(@Nullable final wx p0);
    
    @Shadow
    public abstract xw a(@Nullable final xy p0);
    ...
    @Shadow
    public abstract xw a(@Nullable final Boolean p0);
    
    @Shadow
    public abstract xw b(@Nullable final Boolean p0);
    
    @Shadow
    public abstract xw c(@Nullable final Boolean p0);
    
    @Shadow
    public abstract xw d(@Nullable final Boolean p0);
    
    @Shadow
    public abstract xw e(@Nullable final Boolean p0);
    
    @Shadow
    public abstract akr shadow$k();
    
    @Shadow
    public abstract xw a(@Nullable final akr p0);
    
    @Shadow
    public abstract xw a(@Nullable final String p0);
