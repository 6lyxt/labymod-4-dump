...
public class MixinBookScreenVanillaFont
{
    ...
    public void labyMod$enableVanillaFont(final fhz graphics, final int mouseX, final int mouseY, final float partialTicks, final InsertInfo ci) {
    ...
    public void labyMod$resetFont(final fhz graphics, final int mouseX, final int mouseY, final float partialTicks, final InsertInfo ci) {
        final RenderAttributesStack renderAttributesStack = this.renderAttributesStack();
