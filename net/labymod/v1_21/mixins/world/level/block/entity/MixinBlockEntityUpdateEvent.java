...
public class MixinBlockEntityUpdateEvent
{
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final dcw level, final jd pos, final dtc state, final InsertInfo ci) {
        final dqh blockEntity = level.c_(pos);
