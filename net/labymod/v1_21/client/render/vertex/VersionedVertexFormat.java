...
{
    private static final Supplier<gfn> NULLABLE_SUPPLIER;
    private final fbn vertexFormat;
    private final Supplier<gfn> shaderSupplier;
    private final Collection<String> attributeNames;
    
    public VersionedVertexFormat(final fbn format) {
        this(format, VersionedVertexFormat.NULLABLE_SUPPLIER);
    }
    
    public VersionedVertexFormat(final fbn vertexFormat, final Supplier<gfn> shaderSupplier) {
