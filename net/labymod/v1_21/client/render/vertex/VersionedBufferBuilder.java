...
package net.labymod.v1_21.client.render.vertex;

import org.jetbrains.annotations.Nullable;
import org.jetbrains.annotations.NotNull;
import net.labymod.api.util.color.format.ColorFormat;
import net.labymod.v1_21.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, gfh> RENDER_TYPE_FUNCTION;
    private final fbk tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private fbm consumer;
    private fbd bufferBuilder;
    @Deprecated
    private gez.a bufferSource;
    private RenderPhase renderPhase;
    private gfh renderType;
    private OldVertexFormat currentFormat;
    private fbh meshData;
    
    public VersionedBufferBuilder() {
        this.tesselator = fbk.b();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final fbd builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder = this.tesselator.a(LabyModRenderType.getMode(mode), (fbn)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final gez multiBufferSource) {
    ...
    public void uploadToBuffer() {
        ...
        final fbh meshData = this.bufferBuilder.a();
        if (meshData == null) {
            return;
        }
    ...
    public boolean building() {
        ...
        final fbm consumer = this.consumer;
        if (consumer instanceof final fbd bufferBuilder) {
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder = this.tesselator.a(LabyModRenderType.getMode(phase.getMode()), (fbn)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public fbd getBufferBuilder() {
        return this.bufferBuilder;
    }
    
    public fbh renderedBuffer() {
