...
{
    public static faj read(final ByteBuffer buffer) throws IOException {
        return faj.a(buffer);
    }
    
    public static faj read(final InputStream inputStream) throws IOException {
        return faj.a(inputStream);
    }
    
    public static faj asNativeImage(final BufferedImage image) {
        return asNativeImage(image, NativeImageUtils::processImage);
    }
    
    public static faj asNativeImage(final BufferedImage image, final BufferedImageProcessor processor) {
        final faj result = new faj(image.getWidth(), image.getHeight(), true);
    ...
    public static void fillSubImage(final faj source, final faj destination, final int parentX, final int parentY, final int width, final int height) {
    ...
    public static BufferedImage asBufferedImage(final faj image) {
