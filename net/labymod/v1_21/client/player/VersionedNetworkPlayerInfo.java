...
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo
{
    ...
    public VersionedNetworkPlayerInfo(final fzq wrapped) {
    ...
    public Component displayName() {
        final wz displayName = this.wrapped.i();
        if (displayName == null) {
    ...
    private wz decorateComponent(@NotNull final fzq info, final xn mutableComponent) {
        return (wz)((info.e() == dct.d) ? mutableComponent.a(n.u) : mutableComponent);
    }
