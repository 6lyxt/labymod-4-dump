...
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, xa> implements TextComponent
{
    ...
    public VersionedTextComponent(final xn holder, final boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    public String getText() {
        ...
        if (contents instanceof final yg.a literal) {
            return literal.b();
        }
    ...
    public TextComponent text(final String text) {
        if (this.empty) {
            ((MutableComponentAccessor)this.holder).setContents((xa)new yg.a(text));
            this.empty = false;
            return this;
        }
