...
{
    private final wz.b serializerAdapter;
    
    public VersionedComponentSerializerWrapper() {
        this.serializerAdapter = new wz.b((jo.a)ka.b);
    }
    ...
    public JsonElement serialize(final Component src, final Type typeOfSrc, final JsonSerializationContext context) {
        final xn holder = ((VersionedBaseComponent)src).getHolder();
        return this.serializerAdapter.a((wz)holder, typeOfSrc, context);
    }
}
