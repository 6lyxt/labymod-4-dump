...
import net.labymod.v1_19_4.client.render.vertex.VersionedVertexFormat;
...
public class VersionedPlatform extends Platform
{
    public void onInitialization() {
        this.setMinecraft((Minecraft)emh.N());
    ...
    private void registerVertexFormats() {
        this.register(VertexFormatType.POSITION_COLOR, this.createFormat(ehc.n, fhz::q));
        this.register(VertexFormatType.POSITION_TEXTURE_COLOR, this.createFormat(ehc.s, fhz::t));
        this.register(VertexFormatType.POSITION_COLOR_NORMAL, this.createFormat(ehc.o, fhz::as));
        this.register(VertexFormatType.ENTITY, this.createFormat(ehc.k, fhz::v));
        this.register(VertexFormatType.POSITION_COLOR_TEXTURE_LIGHTMAP, this.createFormat(ehc.t, fhz::y));
    }
    ...
    @NotNull
    private OldVertexFormat createFormat(final ehj format, final Supplier<fir> shaderSupplier) {
