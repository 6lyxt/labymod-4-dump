...
package net.labymod.v1_19_4.client.gfx.pipeline.target;
...
{
    private final efr renderTarget;
    
    public VersionedRenderTarget(final efr renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final efr renderTarget2 = this.renderTarget;
        ...
        final efr renderTarget3 = this.renderTarget;
