...
package net.labymod.v1_19_4.client.gfx.buffer;
...
public class VersionedBlaze3DBufferSource extends DefaultBlaze3DBufferSource
{
    ...
    public BufferConsumer getBuffer(final Blaze3DRenderType renderType) {
        fig bufferSource = (fig)this.getBufferSource();
        if (this.temporaryBuffer != null) {
            bufferSource = (fig)this.temporaryBuffer;
        }
        final ehi buffer = bufferSource.getBuffer((fio)renderType);
