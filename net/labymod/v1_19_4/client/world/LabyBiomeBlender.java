...
public class LabyBiomeBlender implements cll
{
    ...
    public LabyBiomeBlender setLevel(final cmi level) {
        this.level = level;
        return this;
    }
    ...
    public float a(@NotNull final gz direction, final boolean shade) {
    ...
    @Nullable
    public cze c_(@NotNull final gt blockPos) {
        return this.level.c_(blockPos);
    }
    
    @NotNull
    public dbq a_(@NotNull final gt blockPos) {
        return this.level.a_(blockPos);
    }
    
    @NotNull
    public dwj b_(@NotNull final gt blockPos) {
    ...
    public int a(@NotNull final gt blockPos, @NotNull final clt resolver) {
    ...
    private int processZAxis(final int x, final int y, final int z, final gt.a currentPos, final clt resolver, int total, final int[] rgb, final int xIndex) {
    ...
    private int blendColors(final gt.a currentPos, final clt resolver, int total, final int[] rgb) {
        final hd<cnf> holder = (hd<cnf>)this.level.v((gt)currentPos);
        final cnf biome = (holder == null) ? null : ((cnf)holder.a());
        if (biome != null) {
