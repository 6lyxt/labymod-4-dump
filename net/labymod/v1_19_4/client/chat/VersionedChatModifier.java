...
public class VersionedChatModifier implements InternalChatModifier
{
    ...
    public void deleteMessage(final ChatMessage message) {
        final VersionedChatComponent accessor = (VersionedChatComponent)emh.N().l.d();
    ...
    public void editMessage(final ChatMessage message, final Component component) {
        ...
        final emb prevMessage = accessor.getMessages().get(index);
        final tj mapped = (tj)new VersionedChatMessageComponent(message, (tj)this.componentMapper.toMinecraftComponent(component));
        accessor.getMessages().set(index, new emb(prevMessage.a(), mapped, prevMessage.c(), prevMessage.d()));
        final Predicate<emb.a> predicate = this.formattedFilter(message);
        int first = -1;
    ...
    private Predicate<emb> messageFilter(final ChatMessage message) {
    ...
    private Predicate<emb.a> formattedFilter(final ChatMessage message) {
