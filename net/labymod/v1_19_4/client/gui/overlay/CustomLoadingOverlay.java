...
package net.labymod.v1_19_4.client.gui.overlay;
...
public class CustomLoadingOverlay extends esq
{
    ...
    public CustomLoadingOverlay(final emh minecraft, final ald reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final ehe stack, final int mouseX, final int mouseY, final float partialTicks) {
        final egi window = this.minecraft.aM();
