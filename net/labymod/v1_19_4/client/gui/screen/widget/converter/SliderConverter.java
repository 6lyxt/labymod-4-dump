...
public class SliderConverter extends AbstractMinecraftWidgetConverter<enx, SliderWidget>
{
    ...
    @Override
    public SliderWidget createDefault(final enx source) {
    ...
    @Override
    public void update(final enx source, final SliderWidget destination) {
    ...
    @Override
    public String getWidgetId(final enx source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.k());
    }
    
    @Override
    public List<String> getWidgetIds(final enx source) {
