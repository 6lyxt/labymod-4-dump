...
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<ept, AbstractWidget<?>>
{
    ...
    @Override
    public void update(final ept source, final AbstractWidget<?> destination) {
        final TabNavigationBarAccessor accessor = (TabNavigationBarAccessor)source;
        final eps tabManager = accessor.getTabManager();
