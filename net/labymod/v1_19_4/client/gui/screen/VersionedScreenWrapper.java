...
public class VersionedScreenWrapper implements ScreenWrapper
{
    ...
    public VersionedScreenWrapper(final etd screen) {
        if (screen == null) {
    ...
    public void render(final Stack stack, final MutableMouse mouse, final float partialTicks) {
        this.screen.a((ehe)stack.getProvider().getPoseStack(), mouse.getX(), mouse.getY(), partialTicks);
    }
    ...
    public void render(final ScreenContext context) {
        ...
        final ehe poseStack = (ehe)context.stack().getProvider().getPoseStack();
