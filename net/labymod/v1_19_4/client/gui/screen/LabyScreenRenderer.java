...
public class LabyScreenRenderer extends etd implements FileDropHandler, LabyScreenAccessor
{
    private final VanillaLabyScreen screen;
    
    public LabyScreenRenderer(final LabyScreen screen) {
        super((tj)Laby.labyAPI().minecraft().componentMapper().toMinecraftComponent(Component.empty()));
    ...
    public void a(@NotNull final ehe poseStack, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void a(final ehe poseStack) {
        final Stack stack = ((VanillaStackAccessor)poseStack).stack();
    ...
    public void a(@NotNull final emh mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
