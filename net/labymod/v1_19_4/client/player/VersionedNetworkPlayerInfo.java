...
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo
{
    ...
    public VersionedNetworkPlayerInfo(final fdo wrapped) {
    ...
    public Component displayName() {
        final tj displayName = this.wrapped.o();
        if (displayName == null) {
    ...
    private tj decorateComponent(@NotNull final fdo info, final tw mutableComponent) {
        return (tj)((info.e() == cmf.d) ? mutableComponent.a(n.u) : mutableComponent);
    }
