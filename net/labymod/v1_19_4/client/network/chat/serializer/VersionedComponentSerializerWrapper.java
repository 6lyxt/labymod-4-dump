...
package net.labymod.v1_19_4.client.network.chat.serializer;
...
{
    private final tj.a serializer;
    
    public VersionedComponentSerializerWrapper() {
        this.serializer = new tj.a();
    }
    ...
    public JsonElement serialize(final Component src, final Type typeOfSrc, final JsonSerializationContext context) {
        final tw holder = ((VersionedBaseComponent)src).getHolder();
        return this.serializer.a((tj)holder, typeOfSrc, context);
    }
}
