...
{
    public static void bindAttributeLocation(final ehj vertexFormat, final ShaderProgram program) {
        final ImmutableList<ehk> elements = (ImmutableList<ehk>)vertexFormat.c();
        for (int index = 0; index < elements.size(); ++index) {
            final ehk element = (ehk)elements.get(index);
