...
import net.labymod.v1_19_4.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, fio> RENDER_TYPE_FUNCTION;
    private final ehg tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private ehi consumer;
    private egz bufferBuilder;
    @Deprecated
    private fig.a bufferSource;
    private RenderPhase renderPhase;
    private fio renderType;
    private OldVertexFormat currentFormat;
    private egz.b renderedBuffer;
    
    public VersionedBufferBuilder() {
        this.tesselator = ehg.a();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final egz builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (ehj)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final fig multiBufferSource) {
    ...
    public boolean building() {
        ...
        final ehi consumer = this.consumer;
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (ehj)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public egz getBufferBuilder() {
        return this.bufferBuilder;
    }
    
    public egz.b renderedBuffer() {
