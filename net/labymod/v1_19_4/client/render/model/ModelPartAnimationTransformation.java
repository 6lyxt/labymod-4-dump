...
{
    public ModelPartAnimationTransformation(final fcr modelPart, final Transformation modelPartTransform) {
    ...
    private static class ModelPartPositionVector extends FloatVector3
    {
        ...
        public ModelPartPositionVector(final fcr modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final fcr modelPart) {
            this.modelPart = modelPart;
        }
