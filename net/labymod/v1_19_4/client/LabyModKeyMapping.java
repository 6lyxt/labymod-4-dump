...
{
    private static final Function<Hotkey, emf> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? efz.b.c : efz.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static emf create(final Hotkey hotkey) {
    ...
    public efz.a h() {
        ...
        final efz.b type = (key instanceof MouseButton) ? efz.b.c : efz.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final efz.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == efz.b.a || key.a() == efz.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
