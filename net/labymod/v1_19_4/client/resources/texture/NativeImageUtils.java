...
{
    public static egf read(final ByteBuffer buffer) throws IOException {
        return egf.a(buffer);
    }
    
    public static egf read(final InputStream inputStream) throws IOException {
        return egf.a(inputStream);
    }
    
    public static egf asNativeImage(final BufferedImage image) {
        return asNativeImage(image, NativeImageUtils::processImage);
    }
    
    public static egf asNativeImage(final BufferedImage image, final BufferedImageProcessor processor) {
        final egf result = new egf(image.getWidth(), image.getHeight(), true);
    ...
    public static void fillSubImage(final egf source, final egf destination, final int parentX, final int parentY, final int width, final int height) {
    ...
    public static BufferedImage asBufferedImage(final egf image) {
