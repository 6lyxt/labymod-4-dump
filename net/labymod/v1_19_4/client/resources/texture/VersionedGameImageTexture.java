...
public class VersionedGameImageTexture extends fsv implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((add)location.getMinecraftLocation());
    ...
    public void a(final alh resourceManager) {
        this.prepareImage();
    }
