...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner
{
    ...
    private boolean isExternalPack(final ajv pack) {
    ...
    private IncompatibleResourcePack scanPack(final ajv pack) {
    ...
    private void scanPack(final ajv pack, final String baseDirectory, final ajv.a output) {
        pack.a(ajw.a, "minecraft", baseDirectory, output);
    }
    
    private Collection<String> collectIgnoredFiles(final ajv pack) {
        final Set<String> ignoredFiles = new HashSet<String>();
        for (final String namespace : pack.a(ajw.a)) {
            final akz<InputStream> resource = (akz<InputStream>)pack.a(ajw.a, new add(namespace, "labymod/ignored_files.json"));
            if (resource == null) {
                continue;
            }
