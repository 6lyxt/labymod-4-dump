...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    @Final
    @Shadow
    private Map<String, rx> x;
    
    @Shadow
    public abstract rx a(final String p0, final rx p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract rx shadow$c(final String p0);
    ...
    @Shadow
    public abstract re shadow$p(final String p0);
    
    @Shadow
    public abstract rk c(final String p0, final int p1);
