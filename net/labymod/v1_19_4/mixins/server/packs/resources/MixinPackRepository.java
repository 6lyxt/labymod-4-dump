...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<akq>> cir) {
        final List<akq> selectedPacks = (List<akq>)cir.getReturnValue();
