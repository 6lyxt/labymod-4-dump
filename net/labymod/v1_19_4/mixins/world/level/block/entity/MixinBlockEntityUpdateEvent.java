...
public class MixinBlockEntityUpdateEvent
{
    ...
    private void labyMod$fireTileEntityPreLoadEvent(final re tag, final InsertInfo ci) {
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final cmi level, final gt pos, final dbq state, final InsertInfo ci) {
        final cze blockEntity = level.c_(pos);
