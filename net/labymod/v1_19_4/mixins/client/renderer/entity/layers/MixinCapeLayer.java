...
public class MixinCapeLayer
{
    ...
    private void labyMod$firePreCapeRenderEvent(final ehe poseStack, final fig param1, final int param2, final fhh clientPlayer, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
    ...
    private void labyMod$firePostCapeRenderEvent(final ehe poseStack, final fig param1, final int param2, final fhh clientPlayer, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
        this.labyMod$fireCapeRenderEvent(poseStack, clientPlayer, Phase.POST);
    }
    
    @WrapOperation(method = { "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V" }, at = { @At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/RenderType;entitySolid(Lnet/minecraft/resources/ResourceLocation;)Lnet/minecraft/client/renderer/RenderType;") })
    private fio labyMod$attach(final add location, final Operation<fio> original) {
        return this.labyMod$renderType = (fio)original.call(new Object[] { location });
    }
    
    @Insert(method = { "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V" }, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/model/PlayerModel;renderCloak(Lcom/mojang/blaze3d/vertex/PoseStack;Lcom/mojang/blaze3d/vertex/VertexConsumer;II)V", shift = At.Shift.AFTER))
    private void labyMod$renderCapeParticles(final ehe param0, final fig param1, final int param2, final fhh player, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
    ...
    private boolean labyMod$fireCapeRenderEvent(final ehe poseStack, final fhh clientPlayer, final Phase phase) {
        final Player player = (Player)clientPlayer;
        final PlayerModel playerModel = (PlayerModel)((frn)this).c();
