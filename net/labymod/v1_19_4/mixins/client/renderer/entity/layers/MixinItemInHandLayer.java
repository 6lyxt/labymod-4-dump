...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final fic renderer, final bfx livingEntity, final cfv itemStack, final cfs type, final boolean leftHand, final ehe poseStack, final fig bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final bfx livingEntity, final cfv itemStack, final cfs type, final boolean leftHand, final int combinedLight) {
