...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final etd instance, final ehe poseStack, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
