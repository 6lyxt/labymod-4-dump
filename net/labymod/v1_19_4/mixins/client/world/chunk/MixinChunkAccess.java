...
public abstract class MixinChunkAccess implements Chunk
{
    ...
    @Shadow
    public abstract dgz a(final dgz.a p0);
    
    @Shadow
    public abstract ddz b(final int p0);
    ...
    public Heightmap heightmap(final HeightmapType type) {
        ...
        return (Heightmap)this.a(dgz.a.b);
    }
    ...
    public BlockState getBlockState(final int x, final int y, final int z) {
        final int index = ((ddn)this).e(y);
        if (index < 0 || index >= this.k.length) {
            return (BlockState)cpj.a.o();
        }
        final ddz section = this.k[index];
        if (section == null) {
            return (BlockState)cpj.a.o();
        }
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (final Map.Entry<gt, cze> entry : this.i.entrySet()) {
    ...
    public int getHeightBasedOnSection(final int startY) {
        ...
        for (int index = startSectionIndex; index < sections.length; ++index) {
            final ddz section = sections[index];
            if (section != null) {
                if (!section.c()) {
