...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final ede position = this.b();
        this.labymod$cameraPosition.set((float)position.a(gz.a.a), (float)position.a(gz.a.b), (float)position.a(gz.a.c));
    ...
    public DoubleVector3 position() {
        final ede position = this.b();
        this.labyMod$position.set(position.a(gz.a.a), position.a(gz.a.b), position.a(gz.a.c));
