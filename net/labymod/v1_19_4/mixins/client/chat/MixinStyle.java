...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract uf a(@Nullable final to p0);
    ...
    @Shadow
    public abstract uf a(@Nullable final th p0);
    
    @Shadow
    public abstract uf a(@Nullable final uh p0);
    ...
    @Shadow
    public abstract uf a(@Nullable final Boolean p0);
    
    @Shadow
    public abstract uf b(@Nullable final Boolean p0);
    
    @Shadow
    public abstract uf c(@Nullable final Boolean p0);
    
    @Shadow
    public abstract uf d(@Nullable final Boolean p0);
    
    @Shadow
    public abstract uf e(@Nullable final Boolean p0);
    
    @Shadow
    public abstract add shadow$k();
    
    @Shadow
    public abstract uf a(@Nullable final add p0);
    
    @Shadow
    public abstract uf a(@Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((to)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((th)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final add resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, uf> setter) {
