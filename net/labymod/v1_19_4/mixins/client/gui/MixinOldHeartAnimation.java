...
public class MixinOldHeartAnimation
{
    ...
    private void labyMod$applyOldHeartAnimation(final ehe poseStack, final int i0, final int i1, int i2, final int i3, final int i4, final int i5, final Operation<Void> original) {
        ...
        original.call(new Object[] { poseStack, i0, i1, i2, i3, i4, i5 });
    }
}
