...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final ehe poseStack, final int screenWidth, final eec scoreboard, final edz objective, final InsertInfo ci) {
