...
public class MixinKeyBindsList
{
    ...
    private emf[] labyMod$addCustomKeybindings(final eml instance) {
        final List<emf> keyMappings = new ArrayList<emf>(Arrays.asList(instance.X));
        ...
        return keyMappings.toArray(new emf[0]);
    }
}
