...
public class MixinConnectScreenThread
{
    ...
    private Optional<fem> labyMod$resolveAddress(final fep resolver, final fen address) {
    ...
    public tj labyMod$fireServerKickEvent(final tj reason) {
        ...
        return (tj)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN)).reason());
    }
}
