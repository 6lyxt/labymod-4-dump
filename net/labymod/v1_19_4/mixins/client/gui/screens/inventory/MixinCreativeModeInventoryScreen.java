...
@Mixin({ eup.class })
public abstract class MixinCreativeModeInventoryScreen extends eus<eup.b>
{
    ...
    public MixinCreativeModeInventoryScreen(final eup.b pickerMenu, final byl inventory, final tj component) {
        super((cbd)pickerMenu, inventory, component);
    }
    ...
    private void labyMod$setEntityToOldPosition(final ehe poseStack, final int x, final int y, final int scale, final float mouseX, final float mouseY, final bfx entity) {
    ...
    private void labyMod$setOldCreativeTexture(final int slot, final add location) {
        if (!this.labyMod$oldCreativeLayoutTexture) {
    ...
    private void labyMod$onSelectTab(final ced tab, final CallbackInfo ci) {
        this.labyMod$modifySlots();
    }
    
    private void labyMod$modifySlots() {
        if (this.labyMod$oldCreativeLayoutTexture) {
            for (final ccw slot : ((eup.b)this.C()).i) {
    ...
    @NotNull
    private ccw getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final InventorySlotData legacySlot, @NotNull final ccw slot) {
