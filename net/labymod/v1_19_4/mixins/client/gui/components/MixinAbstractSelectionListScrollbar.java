...
public abstract class MixinAbstractSelectionListScrollbar
{
    ...
    private int labyMod$render(final enw instance) {
        ...
        final int x = this.c();
        final Bounds scrollBar = new PositionedBounds((float)x, (float)this.f, (float)(x + 6), (float)this.k);
        final float scrollBarHeight = scrollBar.getHeight();
        final int contentHeight = this.a() - this.o;
