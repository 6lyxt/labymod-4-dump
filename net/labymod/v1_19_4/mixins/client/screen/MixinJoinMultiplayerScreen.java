...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final ehe param0, final enp param1, final tj param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final fdq serverData, final InsertInfo ci) {
