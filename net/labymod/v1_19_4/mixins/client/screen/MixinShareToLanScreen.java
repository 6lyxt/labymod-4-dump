...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final fww server, final eoc button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final fww server, final eoc button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
