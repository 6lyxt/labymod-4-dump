...
public abstract class MixinScreen implements FileDropHandler, ScreenAccessor
{
    ...
    public void fireScreenInitEvent(final emh mc, final int width, final int height, final InsertInfo ci) {
    ...
    public void renderThemeBackground(final ehe stack, final InsertInfo ci) {
    ...
    public void renderThemeDirtBackground(final ehe stack, final InsertInfo ci) {
        this.renderThemeBackground(((VanillaStackAccessor)stack).stack(), ci);
    }
    ...
    private void renderThemeBackground(Stack stack, final InsertInfo ci) {
        ...
        stack = ((stack != null) ? stack : ((VanillaStackAccessor)new ehe()).stack());
    ...
    private void labyMod$disableMenuBackground(final ehe poseStack, final InsertInfo ci) {
    ...
    public void renderComponentHoverEffect(final Stack stack, final Style style, final int x, final int y) {
        this.shadow$a((ehe)stack.getProvider().getPoseStack(), (uf)style, x, y);
    }
    
    @Shadow
    protected abstract void shadow$a(final ehe p0, @Nullable final uf p1, final int p2, final int p3);
    
    @Override
    public void setMinecraft(final emh minecraft) {
        this.e = minecraft;
    }
    ...
    public List<Object> getWrappedWidgets() {
        ...
        for (final epl child : this.p) {
            wrappedWidgets.add(this.asVersionedWidget(child));
        }
        return wrappedWidgets;
    }
    
    private VersionedWidget asVersionedWidget(final epl child) {
        ...
        if (child instanceof final epk container) {
            for (final epl entry : container.i()) {
