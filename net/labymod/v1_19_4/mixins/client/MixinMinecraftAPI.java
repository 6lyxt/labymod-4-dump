...
import net.labymod.v1_19_4.client.gfx.pipeline.target.VersionedRenderTarget;
...
public abstract class MixinMinecraftAPI implements Minecraft
{
    ...
    @Shadow
    public abstract void a(@Nullable final etd p0);
    ...
    public Entity getTargetEntity() {
        return (Entity)emh.N().v;
    }
    
    @Override
    public Entity getCameraEntity() {
        return (Entity)emh.N().al();
    }
    
    @Override
    public MinecraftCamera getCamera() {
        return (emh.N().al() != null) ? ((MinecraftCamera)this.j.m()) : null;
    }
    ...
    public void openChat(final String defaultInput) {
        final erw chatScreen = new erw("");
        emh.N().a((etd)chatScreen);
