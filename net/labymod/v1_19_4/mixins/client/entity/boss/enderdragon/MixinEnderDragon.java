...
package net.labymod.v1_19_4.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_19_4.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final bfl<? extends btz> type, final cmi level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final btx part : this.ce) {
