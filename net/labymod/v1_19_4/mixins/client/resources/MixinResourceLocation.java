...
public abstract class MixinResourceLocation implements ResourceLocation
{
    ...
    public InputStream openStream() throws IOException {
        ...
        return emh.N().Y().getResource((add)this.getMinecraftLocation()).orElseThrow(IOException::new).d();
    }
    
    @Override
    public boolean exists() {
        return ResourcesUtil.hasResource(this.getMinecraftLocation()) || emh.N().Y().getResource((add)this.getMinecraftLocation()).isPresent();
    }
