...
public class HashMultimap<K, V> implements Multimap<K, V>
{
    ...
    public HashMultimap(final int initialCapacity, final float loadFactor) {
        this.map = new HashMap<K, Collection<V>>(initialCapacity, loadFactor);
    }
    
    public HashMultimap(final Map<K, Collection<V>> entries) {
        this.map = new HashMap<K, Collection<V>>((Map<? extends K, ? extends Collection<V>>)entries);
    }
