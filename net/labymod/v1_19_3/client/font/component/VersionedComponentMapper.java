...
package net.labymod.v1_19_3.client.font.component;
...
public class VersionedComponentMapper implements ComponentMapper
{
    ...
    public String getTranslationKeyOfComponent(final Object minecraftComponent) {
        if (minecraftComponent instanceof final ss component) {
            final st contents = component.b();
            if (contents instanceof final uc uc) {
                return uc.a();
            }
        }
        return null;
