...
package net.labymod.v1_19_3.client.overlay;
...
public class CustomLoadingOverlay extends eoo
{
    private final ejf minecraft;
    private final aka reload;
    private final Consumer<Optional<Throwable>> onFinish;
    private final AbstractBootLogoRenderer loadingRenderer;
    private final DynamicBackgroundController caveRenderer;
    
    public CustomLoadingOverlay(final ejf minecraft, final aka reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final eed stack, final int mouseX, final int mouseY, final float partialTicks) {
        final edh window = this.minecraft.aN();
