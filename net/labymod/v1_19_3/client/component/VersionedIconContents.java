...
public class VersionedIconContents implements st
{
    private Icon icon;
    private int width;
    private int height;
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final sw.a<T> consumer) {
        return consumer.accept(this.placeholder);
    }
    
    @NotNull
    public <T> Optional<T> a(@NotNull final sw.b<T> consumer, @NotNull final to style) {
