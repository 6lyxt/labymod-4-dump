...
package net.labymod.v1_19_3.client.component;

import java.util.Collection;
import java.util.ArrayList;
import com.google.gson.TypeAdapterFactory;
import com.google.gson.GsonBuilder;
import net.labymod.v1_19_3.client.network.chat.serializer.VersionedComponentSerializerWrapper;
...
public class VersionedComponentService extends ComponentService
{
    ...
    public TextComponent createTextComponent(final String text) {
        return (TextComponent)((MutableComponentAccessor)ss.b(text)).getLabyComponent();
    }
    
    @Override
    public TextComponent createTextComponent(final String text, final Style style, final List<Component> children) {
        final tx contents = new tx(text);
        return (TextComponent)this.applyStyleAndSiblings((st)contents, style, children);
    }
    
    @Override
    public ScoreComponent createScoreComponent(final String name, final String objective) {
        return (ScoreComponent)((MutableComponentAccessor)ss.a(name, objective)).getLabyComponent();
    }
    ...
    public ScoreComponent createScoreComponent(final String name, final String objective, final Style style, final List<Component> children) {
        final tz contents = new tz(name, objective);
        return (ScoreComponent)this.applyStyleAndSiblings((st)contents, style, children);
    }
    
    @Override
    public KeybindComponent createKeybindComponent(final String keybind) {
        return (KeybindComponent)((MutableComponentAccessor)ss.d(keybind)).getLabyComponent();
    }
    
    @Override
    public KeybindComponent createKeybindComponent(final String keybind, final Style style, final List<Component> children) {
        final tv contents = new tv(keybind);
        return (KeybindComponent)this.applyStyleAndSiblings((st)contents, style, children);
    }
    
    @Override
    protected IconComponent createIconComponent(final Icon icon) {
        return (IconComponent)((MutableComponentAccessor)tf.a((st)new VersionedIconContents(icon))).getLabyComponent();
    }
    ...
    protected IconComponent createIconComponent(final Icon icon, final Style style, final List<Component> children) {
        ...
        return (IconComponent)this.applyStyleAndSiblings((st)contents, style, children);
    }
    
    @Override
    public TextComponent createEmptyComponent() {
        return (TextComponent)((MutableComponentAccessor)ss.h()).getLabyComponent();
    }
    ...
    public <T> HoverEvent<T> createHoverEvent(@NotNull final HoverEvent.Action<T> action, @NotNull final T value) {
        ...
        if (value instanceof VersionedBaseComponent) {
            ...
            return (HoverEvent<T>)new sx(sx.a.a, (Object)component.holder);
        }
    ...
    public ClickEvent createClickEvent(final ClickEvent.Action action, @NotNull final String value) {
        Objects.requireNonNull(action, "Action cannot be null!");
        Objects.requireNonNull(value, "Value cannot be null!");
        final sq.a vanillaAction = switch (action) {
            default -> throw new MatchException(null, null);
            case OPEN_URL -> sq.a.a;
            case OPEN_FILE -> sq.a.b;
            case RUN_COMMAND -> sq.a.c;
            case SUGGEST_COMMAND -> sq.a.d;
            case CHANGE_PAGE -> sq.a.e;
            case COPY_TO_CLIPBOARD -> sq.a.f;
        };
        return (ClickEvent)new sq(vanillaAction, value);
    }
    
    @Override
    public TextColor createTextColor(final int value) {
        return (TextColor)tq.a(value);
    }
    ...
    public TranslatableComponent createTranslatableComponent(final String key, final Component... arguments) {
        return (TranslatableComponent)((MutableComponentAccessor)ss.a(key, (Object[])arguments)).getLabyComponent();
    }
    ...
    public TranslatableComponent createTranslatableComponent(final String key, final Style style, final List<Component> children, final List<Component> arguments) {
        ...
        if (arguments == null) {
            ...
            contents = new uc(key, (Object[])arguments.toArray(new Component[0]));
        }
        return (TranslatableComponent)this.applyStyleAndSiblings((st)contents, style, children);
    }
    ...
    public Style getEmptyStyle() {
        to style = to.a;
        if (style == null) {
            style = new to((tq)null, (Boolean)null, (Boolean)null, (Boolean)null, (Boolean)null, (Boolean)null, (sq)null, (sx)null, (String)null, (acf)null);
        }
        return (Style)style;
    }
    ...
    public Style createStyleFromBuilder(final TextColor color, final Integer shadowColor, final Boolean bold, final Boolean italic, final Boolean underlined, final Boolean strikethrough, final Boolean obfuscated, final ClickEvent clickEvent, final HoverEvent<?> hoverEvent, final String insertion, final ResourceLocation fontLocation) {
        return (Style)new to((tq)color, bold, italic, underlined, strikethrough, obfuscated, (sq)clickEvent, (sx)hoverEvent, insertion, (fontLocation == null) ? null : fontLocation.getMinecraftLocation());
    }
    ...
    public Serializer createStyleSerializer() {
        return (Serializer)new to.b();
    }
    
    @Override
    public void applyGsonTypeAdapters(final GsonBuilder builder) {
        builder.registerTypeAdapterFactory((TypeAdapterFactory)new anz());
    }
    
    private Component applyStyleAndSiblings(final st componentContents, final Style style, final List<Component> children) {
        to vanillaStyle;
        if (style == null) {
            vanillaStyle = to.a;
        }
        else {
            vanillaStyle = (to)style;
        }
        final tf component = new tf(componentContents, (List)new ArrayList(), vanillaStyle);
