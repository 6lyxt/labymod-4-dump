...
package net.labymod.v1_19_3.client;
...
public class LabyModKeyMapping extends ejd
{
    private static final Function<Hotkey, ejd> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? ecy.b.c : ecy.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static ejd create(final Hotkey hotkey) {
    ...
    public ecy.a h() {
        ...
        final ecy.b type = (key instanceof MouseButton) ? ecy.b.c : ecy.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final ecy.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == ecy.b.a || key.a() == ecy.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
