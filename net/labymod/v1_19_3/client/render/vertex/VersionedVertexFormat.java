...
{
    private static final Supplier<feg> NULLABLE_SUPPLIER;
    private final eei vertexFormat;
    private final Supplier<feg> shaderSupplier;
    private final Collection<String> attributeNames;
    
    public VersionedVertexFormat(final eei format) {
        this(format, VersionedVertexFormat.NULLABLE_SUPPLIER);
    }
    
    public VersionedVertexFormat(final eei vertexFormat, final Supplier<feg> shaderSupplier) {
