...
package net.labymod.v1_19_3.client.render.model;
...
{
    public ModelPartAnimationTransformation(final eyh modelPart, final Transformation modelPartTransform) {
    ...
    {
        private final eyh modelPart;
        private final FloatVector3 modelPartTranslation;
        
        public ModelPartPositionVector(final eyh modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final eyh modelPart) {
            this.modelPart = modelPart;
        }
