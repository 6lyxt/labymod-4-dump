...
package net.labymod.v1_19_3.client.renderer.entity.layers;
...
public class VersionedShopItemLayer extends fmx<fcw, ewo<fcw>>
{
    private final ewo<fcw> playerModel;
    
    public VersionedShopItemLayer(final fkl<fcw, ewo<fcw>> layerParent) {
        super((fkl)layerParent);
        this.playerModel = (ewo<fcw>)layerParent.a();
    }
    
    public void render(@NotNull final eed poseStack, @NotNull final fdv bufferSource, final int packedLight, @NotNull final fcw player, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch) {
