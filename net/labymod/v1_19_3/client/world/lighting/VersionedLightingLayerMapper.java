...
package net.labymod.v1_19_3.client.world.lighting;
...
public class VersionedLightingLayerMapper implements LightingLayerMapper
{
    ...
    public LightType fromMinecraft(final Object value) {
        if (value instanceof final ckf lightLayer) {
        ...
        throw new IllegalArgumentException(value.getClass().getName() + " is not an instance of " + ckf.class.getName());
    }
