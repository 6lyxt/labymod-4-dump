...
package net.labymod.v1_19_3.client.util.math;
...
public class VersionedGameMathMapper implements GameMathMapper
{
    ...
    public AxisAlignedBoundingBox fromAABB(final Object aabb) {
        if (aabb instanceof final dzz gameAABB) {
    ...
    public <T> T toAABB(final AxisAlignedBoundingBox aabb) {
        return (T)new dzz(aabb.getMinX(), aabb.getMinY(), aabb.getMinZ(), aabb.getMaxX(), aabb.getMaxY(), aabb.getMaxZ());
    }
