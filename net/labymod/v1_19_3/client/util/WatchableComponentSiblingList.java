...
public class WatchableComponentSiblingList implements WatchableList<ss>
{
    ...
    @Override
    public void onAdd(final ss component) {
    ...
    @Override
    public void onAdd(final int index, final ss component) {
        if (component instanceof final MutableComponentAccessor accessor) {
    ...
    @Override
    public void onRemove(final ss component) {
        if (component instanceof final MutableComponentAccessor accessor) {
