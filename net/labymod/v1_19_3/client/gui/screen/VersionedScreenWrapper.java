...
package net.labymod.v1_19_3.client.gui.screen;
...
{
    private final epb screen;
    private Metadata metadata;
    private boolean initialized;
    
    public VersionedScreenWrapper(final epb screen) {
        if (screen == null) {
    ...
    public void initialize(final Parent parent) {
        if (parent != null) {
            this.screen.b(ejf.N(), (int)parent.bounds().getWidth(BoundsType.INNER), (int)parent.bounds().getHeight(BoundsType.INNER));
        }
        else {
            final Window window = Laby.labyAPI().minecraft().minecraftWindow();
            this.screen.b(ejf.N(), window.getScaledWidth(), window.getScaledHeight());
        }
    ...
    public void render(final Stack stack, final MutableMouse mouse, final float partialTicks) {
        this.screen.a((eed)stack.getProvider().getPoseStack(), mouse.getX(), mouse.getY(), partialTicks);
    }
    ...
    public void resize(final int width, final int height) {
        this.screen.b(ejf.N(), width, height);
        this.initialized = true;
    }
    ...
    public void render(final ScreenContext context) {
        ...
        final eed poseStack = (eed)context.stack().getProvider().getPoseStack();
