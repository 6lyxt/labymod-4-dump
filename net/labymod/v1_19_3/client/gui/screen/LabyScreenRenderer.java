...
public class LabyScreenRenderer extends epb implements FileDropHandler, LabyScreenAccessor
{
    private final VanillaLabyScreen screen;
    
    public LabyScreenRenderer(final LabyScreen screen) {
        super((ss)Laby.labyAPI().minecraft().componentMapper().toMinecraftComponent(Component.empty()));
    ...
    public void a(@NotNull final eed poseStack, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void a(final eed poseStack) {
        final Stack stack = ((VanillaStackAccessor)poseStack).stack();
    ...
    public void a(@NotNull final ejf mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
