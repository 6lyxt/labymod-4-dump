...
package net.labymod.v1_19_3.client.gfx.pipeline.target;
...
{
    private final ecq renderTarget;
    
    public VersionedRenderTarget(final ecq renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final ecq renderTarget2 = this.renderTarget;
        ...
        final ecq renderTarget3 = this.renderTarget;
