...
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, st> implements TextComponent
{
    private static final String EMPTY = "";
    private boolean empty;
    
    public VersionedTextComponent(final tf holder, final boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    public String getText() {
        ...
        if (contents instanceof final tx literal) {
            return literal.a();
        }
    ...
    public TextComponent text(final String text) {
        if (this.empty) {
            ((MutableComponentAccessor)this.holder).setContents((st)new tx(text));
            this.empty = false;
            return this;
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof VersionedBaseComponent)) {
            return obj instanceof tf && this.holder.equals(obj);
        }
