...
{
    public final tf holder;
    
    public VersionedBaseComponent(final tf holder) {
        this.holder = holder;
    }
    ...
    public T style(final Style style) {
        this.holder.b((to)style);
        return (T)this;
    }
    
    @Override
    public T append(final Component component) {
        this.holder.b((ss)((VersionedBaseComponent)component).holder);
        return (T)this;
    }
    ...
    public T setChildren(final Collection<Component> children) {
        ...
        for (final Component child : children) {
            if (child instanceof VersionedBaseComponent) {
                ...
                this.holder.b((ss)versionedChild.holder);
            }
        }
        return (T)this;
    }
