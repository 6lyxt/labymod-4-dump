...
package net.labymod.v1_19_3.client.network.chat.serializer;
...
{
    private final ss.a serializer;
    
    public VersionedComponentSerializerWrapper() {
        this.serializer = new ss.a();
    }
    ...
    public JsonElement serialize(final Component src, final Type typeOfSrc, final JsonSerializationContext context) {
        final tf holder = ((VersionedBaseComponent)src).getHolder();
        return this.serializer.a((ss)holder, typeOfSrc, context);
    }
}
