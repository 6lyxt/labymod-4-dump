...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner
{
    ...
    private boolean isExternalPack(final ais pack) {
        ...
        return pack instanceof air || pack instanceof aiu;
    }
    
    private IncompatibleResourcePack scanPack(final ais pack) {
    ...
    private void scanPack(final ais pack, final String baseDirectory, final ais.a output) {
        pack.a(ait.a, "minecraft", baseDirectory, output);
    }
    
    private Collection<String> collectIgnoredFiles(final ais pack) {
        final Set<String> ignoredFiles = new HashSet<String>();
        for (final String namespace : pack.a(ait.a)) {
            final ajw<InputStream> resource = (ajw<InputStream>)pack.a(ait.a, new acf(namespace, "labymod/ignored_files.json"));
            if (resource == null) {
                continue;
            }
