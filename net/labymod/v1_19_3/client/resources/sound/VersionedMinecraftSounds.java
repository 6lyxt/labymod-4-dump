...
package net.labymod.v1_19_3.client.resources.sound;
...
public class VersionedMinecraftSounds implements MinecraftSounds
{
    ...
    public void playChatFilterSound() {
        ejf.N().ah().a((frn)frj.a((gz)alo.pb, 1.0f));
    }
    
    @Override
    public void playSound(final ResourceLocation location, final float volume, final float pitch) {
        this.playSound(frj.a(new aln((acf)location.getMinecraftLocation(), 16.0f, false), pitch, volume));
    }
    
    @Override
    public void playSound(final ResourceLocation location, final float volume, final float pitch, final FloatVector3 position) {
        this.playSound(new frj((acf)location.getMinecraftLocation(), alp.a, volume, pitch, frn.t(), false, 0, frn.a.a, (double)position.getX(), (double)position.getY(), (double)position.getZ(), true));
    }
    
    @Override
    public void playSound(final ResourceLocation location, final float volume, final float pitch, final DoubleVector3 position) {
        this.playSound(new frj((acf)location.getMinecraftLocation(), alp.a, volume, pitch, frn.t(), false, 0, frn.a.a, position.getX(), position.getY(), position.getZ(), true));
    }
    
    private void playSound(final frj sound) {
        sound.a(ejf.N().ah());
        ejf.N().ah().a((frn)sound);
    }
}
