...
public class VersionedGameImageTexture extends foe implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((acf)location.getMinecraftLocation());
    ...
    public void a(final ake resourceManager) {
        this.prepareImage();
    }
