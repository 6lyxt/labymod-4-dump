...
package net.labymod.v1_19_3.mixins.mojang.blaze3d.pipeline;
...
@Mixin({ fed.class })
public abstract class MixinRenderType extends fec implements Blaze3DRenderType
{
    ...
    @Shadow
    public abstract void a(final edy p0, final int p1, final int p2, final int p3);
