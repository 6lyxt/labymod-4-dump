...
import net.labymod.v1_19_3.client.resources.pack.ModifiedRepositorySource;
...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<ajn>> cir) {
        final List<ajn> selectedPacks = (List<ajn>)cir.getReturnValue();
