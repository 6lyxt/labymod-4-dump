...
public class MixinBlockEntityUpdateEvent
{
    ...
    private void labyMod$fireTileEntityPreLoadEvent(final qp tag, final InsertInfo ci) {
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final cjw level, final gp pos, final cyt state, final InsertInfo ci) {
        final cwl blockEntity = level.c_(pos);
