...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    @Final
    @Shadow
    private Map<String, ri> x;
    
    @Shadow
    public abstract ri a(final String p0, final ri p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract ri shadow$c(final String p0);
    ...
    @Shadow
    public abstract qp shadow$p(final String p0);
    
    @Shadow
    public abstract qv c(final String p0, final int p1);
