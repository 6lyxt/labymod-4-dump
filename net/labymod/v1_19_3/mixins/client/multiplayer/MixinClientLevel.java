...
public class MixinClientLevel
{
    ...
    private void labyMod$addEntity(final int entityId, final bdr entity, final InsertInfo ci) {
    ...
    private void labyMod$removeEntity(final bdr entity, final bdr.c param0) {
        entity.b(param0);
