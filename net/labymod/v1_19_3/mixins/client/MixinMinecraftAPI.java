...
import net.labymod.v1_19_3.client.gfx.pipeline.target.VersionedRenderTarget;
...
import net.labymod.v1_19_3.client.resources.texture.VersionedMinecraftTextures;
...
import net.labymod.v1_19_3.client.gui.window.VersionedWindow;
...
public abstract class MixinMinecraftAPI implements Minecraft
{
    ...
    @Shadow
    private static void c(final n par1) {
    }
    
    @Shadow
    public abstract void a(@Nullable final epb p0);
    ...
    public Entity getTargetEntity() {
        return (Entity)ejf.N().v;
    }
    
    @Override
    public Entity getCameraEntity() {
        return (Entity)ejf.N().al();
    }
    
    @Override
    public MinecraftCamera getCamera() {
        return (ejf.N().al() != null) ? ((MinecraftCamera)this.j.m()) : null;
    }
    ...
    public void openChat(final String defaultInput) {
        final env chatScreen = new env("");
        ejf.N().a((epb)chatScreen);
