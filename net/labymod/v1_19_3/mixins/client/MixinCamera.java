...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final eae position = this.b();
        this.labymod$cameraPosition.set((float)position.a(gv.a.a), (float)position.a(gv.a.b), (float)position.a(gv.a.c));
    ...
    public DoubleVector3 position() {
        final eae position = this.b();
        this.labyMod$position.set(position.a(gv.a.a), position.a(gv.a.b), position.a(gv.a.c));
