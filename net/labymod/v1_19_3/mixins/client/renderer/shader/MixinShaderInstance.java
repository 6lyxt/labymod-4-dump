...
package net.labymod.v1_19_3.mixins.client.renderer.shader;
...
import net.labymod.v1_19_3.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final edt shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (feg)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final edt shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (feg)this);
    }
