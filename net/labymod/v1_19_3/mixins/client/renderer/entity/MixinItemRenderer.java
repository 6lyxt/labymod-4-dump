...
{
    @Shadow
    public abstract void a(final ekm p0, final cdt p1, final int p2, final int p3);
    
    @Shadow
    public abstract void c(final cdt p0, final int p1, final int p2);
    ...
    public void renderItemStack(final Stack stack, final ItemStack itemStack, final int x, final int y, final boolean decorate, final float alpha) {
        final cdt minecraftItemStack = MinecraftUtil.toMinecraft(itemStack);
        final eed minecraftModelViewStack = RenderSystem.getModelViewStack();
        ...
        if (decorate) {
            this.a(ejf.N().h, minecraftItemStack, x, y);
        }
        modelViewStack.pop();
        RenderSystem.applyModelViewMatrix();
    }
