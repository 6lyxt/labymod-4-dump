...
public class MixinCapeLayer
{
    ...
    private fcw labyMod$player;
    private fed labyMod$renderType;
    ...
    private void labyMod$firePreCapeRenderEvent(final eed poseStack, final fdv param1, final int param2, final fcw player, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
    ...
    private void labyMod$firePostCapeRenderEvent(final eed poseStack, final fdv param1, final int param2, final fcw player, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
        this.labyMod$fireCapeRenderEvent(poseStack, player, Phase.POST);
    }
    
    @WrapOperation(method = { "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V" }, at = { @At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/RenderType;entitySolid(Lnet/minecraft/resources/ResourceLocation;)Lnet/minecraft/client/renderer/RenderType;") })
    private fed labyMod$attach(final acf location, final Operation<fed> original) {
        return this.labyMod$renderType = (fed)original.call(new Object[] { location });
    }
    
    @Insert(method = { "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V" }, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/model/PlayerModel;renderCloak(Lcom/mojang/blaze3d/vertex/PoseStack;Lcom/mojang/blaze3d/vertex/VertexConsumer;II)V", shift = At.Shift.AFTER))
    private void labyMod$renderCapeParticles(final eed param0, final fdv param1, final int param2, final fcw player, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
    ...
    private boolean labyMod$fireCapeRenderEvent(final eed poseStack, final fcw clientPlayer, final Phase phase) {
        final Player player = (Player)clientPlayer;
        final PlayerModel playerModel = (PlayerModel)((fmx)this).c();
