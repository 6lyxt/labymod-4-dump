...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final fdr renderer, final beg livingEntity, final cdt itemStack, final ffb.b type, final boolean leftHand, final eed poseStack, final fdv bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final beg livingEntity, final cdt itemStack, final ffb.b type, final boolean leftHand, final int combinedLight) {
