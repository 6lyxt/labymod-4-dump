...
package net.labymod.v1_19_3.mixins.client.renderer.texture;
...
public abstract class MixinTextureManager implements GameTextureManager
{
    ...
    @Final
    @Mutable
    private Map<acf, fnx> c;
    
    @Shadow
    public abstract void a(final acf p0, final fnx p1);
    ...
    public void registerAndRelease(final ResourceLocation location, final Object texture) {
        if (texture instanceof final fnx textureObject) {
            final fnx currentTexture = this.c.get(location);
            this.a((acf)location, textureObject);
    ...
    public void labyMod$deleteTexture(final acf location, final InsertInfo callback) {
