...
import net.labymod.v1_19_3.client.gui.ScreenAccessor;
...
public abstract class MixinScreen implements FileDropHandler, ScreenAccessor
{
    ...
    public void fireScreenInitEvent(final ejf mc, final int width, final int height, final InsertInfo ci) {
    ...
    public void renderThemeBackground(final eed stack, final int param1, final InsertInfo ci) {
    ...
    private void renderThemeBackground(Stack stack, final InsertInfo ci) {
        ...
        stack = ((stack != null) ? stack : ((VanillaStackAccessor)new eed()).stack());
    ...
    private void labyMod$disableMenuBackground(final eed poseStack, final int vOffset, final InsertInfo ci) {
    ...
    public void renderComponentHoverEffect(final Stack stack, final Style style, final int x, final int y) {
        this.shadow$a((eed)stack.getProvider().getPoseStack(), (to)style, x, y);
    }
    
    @Shadow
    protected abstract void shadow$a(final eed p0, @Nullable final to p1, final int p2, final int p3);
    
    @Override
    public void setMinecraft(final ejf minecraft) {
        this.e = minecraft;
    }
    ...
    public List<Object> getWrappedWidgets() {
        ...
        for (final emg child : this.o) {
            wrappedWidgets.add(this.asVersionedWidget(child));
        }
        return wrappedWidgets;
    }
    
    private VersionedWidget asVersionedWidget(final emg child) {
        ...
        if (child instanceof final emf container) {
            for (final emg entry : container.ak_()) {
