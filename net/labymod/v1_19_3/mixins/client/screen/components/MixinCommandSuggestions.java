...
package net.labymod.v1_19_3.mixins.client.screen.components;
...
public class MixinCommandSuggestions implements CommandSuggestionsAccessor
{
    ...
    private void labyMod$modifyBackgroundPosition(final eed stack, final int left, final int top, final int right, final int bottom, final int color) {
        eko.a(stack, left, (this.bottomY != -1) ? (this.bottomY - 12) : top, right, (this.bottomY != -1) ? (this.bottomY - 12 + (bottom - top)) : bottom, color);
    }
    ...
    private int labyMod$modifyTextPosition(final ekm font, final eed stack, final ano text, final float x, final float y, final int color) {
