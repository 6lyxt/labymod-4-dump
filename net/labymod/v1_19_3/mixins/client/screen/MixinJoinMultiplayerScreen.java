...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final eed param0, final ekm param1, final ss param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final ezg serverData, final InsertInfo ci) {
