...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final fse server, final eky button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final fse server, final eky button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
