...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final eed poseStack, final int screenWidth, final ebc scoreboard, final eaz objective, final InsertInfo ci) {
