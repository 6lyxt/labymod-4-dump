...
public abstract class MixinAbstractSelectionList
{
    ...
    private void labyMod$getStack(final eed stack, final int mouseX, final int mouseY, final float partialTicks, final InsertInfo ci) {
    ...
    public void labyMod$renderBackground(final eed stack, final int param1, final int param2, final float param3, final InsertInfo ci) {
    ...
    public void labyMod$renderTopAndBottom(final eed stack, final int param1, final int param2, final float param3, final InsertInfo ci) {
        final Theme theme = Laby.labyAPI().themeService().currentTheme();
        if (!theme.metadata().getBoolean("hide_default_background")) {
    ...
    public void labyMod$renderList(final eku instance, final eed stack, final int mouseX, final int mouseY, final float partialTicks, final Operation<Void> original) {
