...
public class MixinKeyBindsList
{
    ...
    private ejd[] labyMod$addCustomKeybindings(final ejj instance) {
        final List<ejd> keyMappings = new ArrayList<ejd>(Arrays.asList(instance.Y));
        ...
        return keyMappings.toArray(new ejd[0]);
    }
}
