...
import net.labymod.v1_8_9.client.gfx.pipeline.target.VersionedRenderTarget;
...
public abstract class MixinMinecraftAPI implements Minecraft
{
    ...
    public Entity getTargetEntity() {
        return (Entity)ave.A().i;
    }
    
    @Override
    public Entity getCameraEntity() {
        return (Entity)ave.A().ac();
    }
    
    @Override
    public MinecraftCamera getCamera() {
        return (ave.A().ac() != null) ? ClientCamera.INSTANCE : null;
    }
    ...
    public void executeNextTick(final Runnable runnable) {
        Objects.requireNonNull(runnable, "runnable");
        this.aM.add((FutureTask<?>)ListenableFutureTask.create(runnable, (Object)null));
    }
    ...
    public String getTranslation(final String translationKey) {
        final bnt locale = VersionedI18n.getLocale();
        if (locale == null) {
    ...
    public ClientPacketListener getClientPacketListener() {
        return (ClientPacketListener)this.shadow$u();
    }
    ...
    public Scoreboard getScoreboard() {
        return (this.f != null) ? ((Scoreboard)this.f.Z()) : null;
    }
    ...
    public MinecraftFrameTimer frameTimer() {
        return (MinecraftFrameTimer)this.y;
    }
    
    @Override
    public SampleLogger frameTimeLogger() {
        return ((MinecraftFrameTimer)this.y).logger();
    }
    ...
    public MouseHandlerAccessor mouseHandler() {
        return (MouseHandlerAccessor)this.u;
    }
