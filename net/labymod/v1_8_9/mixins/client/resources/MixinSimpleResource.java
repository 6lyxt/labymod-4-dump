...
public class MixinSimpleResource
{
    ...
    private void labyMod$transformResourceInputStream(final bno resource, final InputStream stream) {
        ...
        final jy location = resource.a();
        this.d = ((DefaultResourceTransformerRegistry)this.labyMod$resourceTransformerRegistry).applyTransformers((ResourceLocation)location, stream);
    }
}
