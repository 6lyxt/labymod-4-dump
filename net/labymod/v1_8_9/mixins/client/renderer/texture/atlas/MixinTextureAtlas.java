...
public abstract class MixinTextureAtlas implements TextureAtlas
{
    ...
    @Shadow
    public abstract bmi a(final String p0);
    ...
    public TextureSprite findSprite(final ResourceLocation location) {
        final bmi sprite = this.a(location.getPath());
        return (sprite == null) ? null : ((TextureSprite)sprite);
    }
    
    @Override
    public ResourceLocation resource() {
        return (ResourceLocation)bmh.g;
    }
    ...
    private void labyMod$setAtlasDimension(final bmf stitcher) {
        stitcher.c();
