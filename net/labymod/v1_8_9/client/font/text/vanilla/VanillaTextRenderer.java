...
package net.labymod.v1_8_9.client.font.text.vanilla;
...
import net.labymod.v1_8_9.client.font.text.StyledFontRenderer;
...
public class VanillaTextRenderer extends AbstractTextRenderer
{
    ...
    public float width(final int codepoint, final Style style) {
        final avn fontRenderer = this.getFontRenderer();
    ...
    private void applyStyle(final avn fontRenderer, final Style style) {
    ...
    private float getWidth(final avn fontRenderer, final String text) {
    ...
    private float renderComponent(final avn fontRenderer, final RenderableComponent component, final float x, final float y, final int color) {
    ...
    private avn getFontRenderer() {
        if (this.fontRenderer == null) {
            this.fontRenderer = ave.A().k;
        }
