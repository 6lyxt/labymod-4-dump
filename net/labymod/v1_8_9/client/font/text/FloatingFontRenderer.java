...
{
    public FloatingFontRenderer(final avh options, final jy location, final bmj textureManager, final boolean useUnicode) {
    ...
    public List<String> c(final String text, final int maxWidth) {
        return Arrays.asList(this.wrapFormattedStringToWidth(text, (float)maxWidth).split("\n"));
    }
