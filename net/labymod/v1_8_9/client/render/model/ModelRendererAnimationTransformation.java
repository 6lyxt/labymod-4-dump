...
{
    public ModelRendererAnimationTransformation(final bct modelRenderer, final Transformation modelPartTransform) {
    ...
    private static class ModelRendererPositionVector extends FloatVector3
    {
        ...
        public ModelRendererPositionVector(final bct modelRenderer, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelRendererRotationVector extends FloatVector3
    {
        ...
        public ModelRendererRotationVector(final bct modelRenderer) {
            this.modelRenderer = modelRenderer;
        }
