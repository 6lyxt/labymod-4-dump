...
import net.labymod.v1_8_9.client.resources.texture.VersionedRefreshableTextureFactory;
...
import net.labymod.v1_8_9.client.gfx.pipeline.blaze3d.program.VersionedStandardBlaze3DRenderTypes;
import net.labymod.v1_8_9.client.gfx.pipeline.VersionedBlaze3DGlStatePipeline;
import net.labymod.v1_8_9.client.gfx.pipeline.VersionedBlaze3DShaderUniformPipeline;
import net.labymod.v1_8_9.client.gfx.texture.VersionedLightmapTexture;
...
import net.labymod.v1_8_9.client.render.gl.VersionedGlStateBridge;
import net.labymod.v1_8_9.client.render.gl.VersionedGlInformation;
import net.labymod.v1_8_9.client.render.VersionedPlayerHeartRenderer;
...
import net.labymod.v1_8_9.client.font.text.VersionedStringFormatter;
import net.labymod.v1_8_9.client.font.text.vanilla.VanillaTextRenderer;
...
import net.labymod.v1_8_9.client.render.system.shards.layering.VersionedViewOffsetZLayer;
import net.labymod.v1_8_9.client.render.system.shards.output.ItemEntityOutputRender;
...
import net.labymod.v1_8_9.client.resources.texture.VersionedGameImageTextureFactory;
...
public class VersionedReferenceStorage extends ReferenceStorage implements ReferenceStorageAccessor
{
    ...
    public VersionedReferenceStorage() {
        ...
        this.componentServiceReference = new SingletonReference<ComponentService>(ComponentService.class, () -> new VersionedComponentService(this.eventBus()));
        this.systemInfoReference = new SingletonReference<SystemInfo>(SystemInfo.class, () -> new VersionedSystemInfo());
        this.serverControllerReference = new SingletonReference<ServerController>(ServerController.class, () -> new VersionedServerController(this.labyAPI(), this.labyModProtocolService(), this.permissionRegistry(), this.resourceLocationFactory()));
        ...
        this.gameImageProviderReference = new SingletonReference<GameImageProvider>(GameImageProvider.class, () -> new BufferedGameImageProvider());
        ...
        this.bossBarRegistryReference = new SingletonReference<BossBarRegistry>(BossBarRegistry.class, () -> new VersionedBossBarRegistry());
        ...
        this.itemStackFactoryReference = new DynamicReference<ItemStackFactory>(ItemStackFactory.class, () -> new VersionedItemStackFactory());
        ...
        this.sessionAccessorReference = new SingletonReference<SessionAccessor>(SessionAccessor.class, () -> new VersionedSessionAccessor());
        this.particleControllerReference = new DynamicReference<ParticleController>(ParticleController.class, () -> new VersionedParticleController());
        ...
        this.componentMapperReference = new SingletonReference<ComponentMapper>(ComponentMapper.class, () -> new VersionedComponentMapper());
        this.playerHeartRendererReference = new SingletonReference<PlayerHeartRenderer>(PlayerHeartRenderer.class, () -> new VersionedPlayerHeartRenderer(this.eventBus()));
