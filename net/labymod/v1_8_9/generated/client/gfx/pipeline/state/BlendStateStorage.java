...
public final class BlendStateStorage implements StateStorage<bfl.b>
{
    ...
    @Override
    public void store(final bfl.b state) {
    ...
    public void restore() {
        ...
        bfl.a(this.sourceRGB, this.destinationRGB, this.sourceAlpha, this.destinationAlpha);
    }
