...
public class WrappedPropertyMap extends PropertyMap
{
    ...
    public boolean putAll(@NotNull final Multimap<? extends String, ? extends com.mojang.authlib.properties.Property> multimap) {
        ...
        for (final Map.Entry<? extends String, ? extends com.mojang.authlib.properties.Property> entry : multimap.entries()) {
            final Collection<Property> properties = this.getProperties((String)entry.getKey());
            properties.add(this.createProperty((com.mojang.authlib.properties.Property)entry.getValue()));
        }
        return putAllSuccess;
    }
