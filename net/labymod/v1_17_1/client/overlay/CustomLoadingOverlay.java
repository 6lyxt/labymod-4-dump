...
public class CustomLoadingOverlay extends eae
{
    ...
    public CustomLoadingOverlay(final dvp minecraft, final adq reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final dql stack, final int mouseX, final int mouseY, final float partialTicks) {
        final dpr window = this.minecraft.aD();
