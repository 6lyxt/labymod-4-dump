...
{
    public static dpm read(final ByteBuffer buffer) throws IOException {
        return dpm.a(buffer);
    }
    
    public static dpm read(final InputStream inputStream) throws IOException {
        return dpm.a(inputStream);
    }
    
    public static dpm asNativeImage(final BufferedImage image) {
        return asNativeImage(image, NativeImageUtils::processImage);
    }
    
    public static dpm asNativeImage(final BufferedImage image, final BufferedImageProcessor processor) {
        final dpm result = new dpm(image.getWidth(), image.getHeight(), true);
    ...
    public static void fillSubImage(final dpm source, final dpm destination, final int parentX, final int parentY, final int width, final int height) {
    ...
    public static BufferedImage asBufferedImage(final dpm image) {
