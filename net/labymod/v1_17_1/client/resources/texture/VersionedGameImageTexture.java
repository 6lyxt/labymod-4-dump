...
public class VersionedGameImageTexture extends exi implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((ww)location.getMinecraftLocation());
    ...
    public void a(final adt resourceManager) {
        this.prepareImage();
    }
