...
{
    private static final Function<Hotkey, dvm> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? dpg.b.c : dpg.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static dvm create(final Hotkey hotkey) {
    ...
    public dpg.a h() {
        ...
        final dpg.b type = (key instanceof MouseButton) ? dpg.b.c : dpg.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final dpg.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == dpg.b.a || key.a() == dpg.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
