...
package net.labymod.v1_17_1.client.render.vertex;

import org.jetbrains.annotations.Nullable;
import org.jetbrains.annotations.NotNull;
import net.labymod.v1_17_1.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, enq> RENDER_TYPE_FUNCTION;
    private final dqn tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private dqp consumer;
    private dqg bufferBuilder;
    @Deprecated
    private eni.a bufferSource;
    private RenderPhase renderPhase;
    private enq renderType;
    private OldVertexFormat currentFormat;
    
    public VersionedBufferBuilder() {
        this.tesselator = dqn.a();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final dqg builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (dqq)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final eni multiBufferSource) {
    ...
    public boolean building() {
        if (this.bufferBuilder != null) {
            return this.bufferBuilder.i();
        }
        final dqp consumer = this.consumer;
        if (consumer instanceof final dqg bufferBuilder) {
            return bufferBuilder.i();
        }
        return false;
    }
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        this.consumer = null;
        if (this.bufferBuilder != null && this.bufferBuilder.i()) {
            return this;
        }
        this.bufferBuilder = this.tesselator.c();
        final VersionedVertexFormat format = (VersionedVertexFormat)phase.getVertexFormat();
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (dqq)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public dqg getBufferBuilder() {
