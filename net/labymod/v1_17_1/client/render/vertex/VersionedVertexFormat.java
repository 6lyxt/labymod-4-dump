...
{
    private static final Supplier<ent> NULLABLE_SUPPLIER;
    private final dqq vertexFormat;
    private final Supplier<ent> shaderSupplier;
    private final Collection<String> attributeNames;
    
    public VersionedVertexFormat(final dqq format) {
        this(format, VersionedVertexFormat.NULLABLE_SUPPLIER);
    }
    
    public VersionedVertexFormat(final dqq vertexFormat, final Supplier<ent> shaderSupplier) {
