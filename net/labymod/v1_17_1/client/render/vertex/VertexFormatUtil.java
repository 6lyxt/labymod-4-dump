...
{
    public static void bindAttributeLocation(final dqq vertexFormat, final ShaderProgram program) {
        final ImmutableList<dqr> elements = (ImmutableList<dqr>)vertexFormat.c();
        for (int index = 0; index < elements.size(); ++index) {
            final dqr element = (dqr)elements.get(index);
