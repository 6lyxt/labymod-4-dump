...
{
    public ModelPartAnimationTransformation(final eir modelPart, final Transformation modelPartTransform) {
    ...
    private static class ModelPartPositionVector extends FloatVector3
    {
        ...
        public ModelPartPositionVector(final eir modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final eir modelPart) {
            this.modelPart = modelPart;
        }
