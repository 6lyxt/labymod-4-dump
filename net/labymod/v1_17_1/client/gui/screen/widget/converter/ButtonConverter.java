...
public class ButtonConverter extends AbstractMinecraftWidgetConverter<dwu, ButtonWidget>
{
    ...
    @Override
    public ButtonWidget createDefault(final dwu source) {
    ...
    @Override
    public void update(final dwu source, final ButtonWidget destination) {
    ...
    @Override
    public String getWidgetId(final dwu source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.g());
    }
    
    @Override
    public List<String> getWidgetIds(final dwu source) {
    ...
    {
        @Override
        public ButtonWidget map(final dwu source) {
            if (source instanceof final dxj imageButton) {
    ...
    class LockIconButtonMapper implements Mapper<dwu, ButtonWidget>
    {
        ...
        @Override
        public ButtonWidget map(final dwu source) {
            if (source instanceof final dxl lockIconButton) {
                ...
                final boolean enabled = lockIconButton.al_();
