...
public class LabyScreenRenderer extends eaq implements FileDropHandler, LabyScreenAccessor
{
    ...
    public void a(@NotNull final dql poseStack, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void a(final dql poseStack) {
        final Stack stack = ((VanillaStackAccessor)poseStack).stack();
    ...
    public void a(@NotNull final dvp mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
