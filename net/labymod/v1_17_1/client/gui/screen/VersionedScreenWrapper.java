...
public class VersionedScreenWrapper implements ScreenWrapper
{
    ...
    public VersionedScreenWrapper(final eaq screen) {
        if (screen == null) {
    ...
    public void render(final Stack stack, final MutableMouse mouse, final float partialTicks) {
        this.screen.a((dql)stack.getProvider().getPoseStack(), mouse.getX(), mouse.getY(), partialTicks);
    }
    ...
    public void render(final ScreenContext context) {
        ...
        final dql poseStack = (dql)context.stack().getProvider().getPoseStack();
