...
package net.labymod.v1_17_1.client.gfx.pipeline.target;
...
{
    private final doy renderTarget;
    
    public VersionedRenderTarget(final doy renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final doy renderTarget2 = this.renderTarget;
        ...
        final doy renderTarget3 = this.renderTarget;
