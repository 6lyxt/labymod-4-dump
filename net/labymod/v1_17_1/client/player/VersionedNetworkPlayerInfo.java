...
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo
{
    ...
    public VersionedNetworkPlayerInfo(final ejm wrapped) {
    ...
    public Component displayName() {
        final os displayName = this.wrapped.l();
        if (displayName == null) {
    ...
    private os decorateComponent(@NotNull final ejm info, final oy mutableComponent) {
        return (os)((info.b() == bwn.d) ? mutableComponent.a(p.u) : mutableComponent);
    }
