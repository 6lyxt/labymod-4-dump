...
import net.labymod.v1_17_1.client.render.vertex.VersionedVertexFormat;
...
public class VersionedPlatform extends Platform
{
    public void onInitialization() {
        this.setMinecraft((Minecraft)dvp.C());
    ...
    private void registerVertexFormats() {
        this.register(VertexFormatType.POSITION_COLOR, this.createFormat(dqj.n, enb::q));
        this.register(VertexFormatType.POSITION_TEXTURE_COLOR, this.createFormat(dqj.s, enb::t));
        this.register(VertexFormatType.POSITION_COLOR_NORMAL, this.createFormat(dqj.o, enb::ap));
        this.register(VertexFormatType.ENTITY, this.createFormat(dqj.k, enb::v));
        this.register(VertexFormatType.POSITION_COLOR_TEXTURE_LIGHTMAP, this.createFormat(dqj.t, enb::y));
    }
    ...
    @NotNull
    private OldVertexFormat createFormat(final dqq format, final Supplier<ent> shaderSupplier) {
