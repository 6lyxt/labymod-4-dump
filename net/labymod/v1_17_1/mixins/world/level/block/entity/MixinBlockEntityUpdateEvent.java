...
public class MixinBlockEntityUpdateEvent
{
    ...
    private void labyMod$fireTileEntityPreLoadEvent(final na tag, final InsertInfo ci) {
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final bwq level, final gg pos, final ckt state, final InsertInfo ci) {
        final ciq blockEntity = level.c_(pos);
