...
public abstract class MixinHitResult implements HitResult
{
    ...
    private void labyMod$createApiVector(final dna vector, final InsertInfo info) {
        this.labyMod$hitLocation = new FloatVector3((float)vector.b, (float)vector.c, (float)vector.d);
    }
    ...
    protected HitType labyMod$getHitType(final dmy.a type) {
        switch (type) {
            case a: {
                return HitType.MISS;
            }
