...
public abstract class MixinMobEffectInstance implements PotionEffect
{
    ...
    @Override
    public Icon getIcon() {
        final exm sprite = this.labyMod$cacheIcon();
        if (sprite == null) {
            return null;
        }
        final ww location = sprite.m().g();
    ...
    private exm labyMod$cacheIcon() {
        ...
        final ww resourceLocation = gw.V.b((Object)this.b);
        if (resourceLocation == null) {
            return null;
        }
        return this.labyMod$iconSprite = dvp.C().av().a(this.b);
    }
}
