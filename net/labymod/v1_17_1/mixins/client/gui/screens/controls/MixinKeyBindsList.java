...
public class MixinKeyBindsList
{
    ...
    private dvm[] labyMod$addCustomKeybindings(final dvt instance) {
        final List<dvm> keyMappings = new ArrayList<dvm>(Arrays.asList(instance.aN));
        ...
        return keyMappings.toArray(new dvm[0]);
    }
}
