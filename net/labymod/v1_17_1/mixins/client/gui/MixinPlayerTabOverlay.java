...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final dql poseStack, final int screenWidth, final dny scoreboard, final dnv objective, final InsertInfo ci) {
