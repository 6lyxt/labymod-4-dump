...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final eaq instance, final dql poseStack, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
