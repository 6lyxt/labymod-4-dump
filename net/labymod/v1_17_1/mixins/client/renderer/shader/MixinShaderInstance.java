...
package net.labymod.v1_17_1.mixins.client.renderer.shader;
...
import net.labymod.v1_17_1.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final dqc shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (ent)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final dqc shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (ent)this);
    }
