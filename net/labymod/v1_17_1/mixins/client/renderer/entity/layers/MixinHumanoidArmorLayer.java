...
public class MixinHumanoidArmorLayer
{
    ...
    private void labyMod$getLivingEntity(final dql poseStack, final eni bufferSource, final int packedLight, final atu entity, final float param4, final float param5, final float param6, final float param7, final float param8, final float param9, final InsertInfo info) {
        this.labyMod$overlayCoords = esy.c(entity, 0.0f);
    }
    ...
    private void labyMod$enableOverlayTexture(final egl model, final dql stack, final dqp consumer, final int packedLight, final int overlayTexture, final float red, final float green, final float blue, final float alpha) {
