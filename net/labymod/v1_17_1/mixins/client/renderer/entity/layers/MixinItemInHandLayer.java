...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final ene renderer, final atu livingEntity, final bqq itemStack, final eoo.b type, final boolean leftHand, final dql poseStack, final eni bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final atu livingEntity, final bqq itemStack, final eoo.b type, final boolean leftHand, final int combinedLight) {
