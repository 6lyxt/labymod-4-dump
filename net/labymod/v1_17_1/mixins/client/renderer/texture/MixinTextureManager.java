...
public abstract class MixinTextureManager implements GameTextureManager
{
    ...
    @Shadow
    public abstract void a(final ww p0, final exa p1);
    ...
    public void registerAndRelease(final ResourceLocation location, final Object texture) {
        if (texture instanceof final exa textureObject) {
            final exa currentTexture = this.c.get(location);
            this.a((ww)location, textureObject);
    ...
    public void labyMod$deleteTexture(final ww location, final InsertInfo callback) {
