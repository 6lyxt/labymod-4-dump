...
public class MixinCommandSuggestions implements CommandSuggestionsAccessor
{
    ...
    private void labyMod$modifyBackgroundPosition(final dql stack, final int left, final int top, final int right, final int bottom, final int color) {
    ...
    private int labyMod$modifyTextPosition(final dwl font, final dql stack, final ags text, final float x, final float y, final int color) {
