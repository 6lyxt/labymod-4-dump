...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract pc a(@Nullable final ow p0);
    ...
    @Shadow
    public abstract pc a(@Nullable final oq p0);
    
    @Shadow
    public abstract pc a(@Nullable final pe p0);
    ...
    @Shadow
    public abstract pc a(@Nullable final Boolean p0);
    
    @Shadow
    public abstract pc b(@Nullable final Boolean p0);
    
    @Shadow
    public abstract pc c(@Nullable final Boolean p0);
    
    @Shadow
    public abstract pc d(@Nullable final Boolean p0);
    
    @Shadow
    public abstract pc e(@Nullable final Boolean p0);
    
    @Shadow
    public abstract ww shadow$k();
    
    @Shadow
    public abstract pc a(@Nullable final ww p0);
    
    @Shadow
    public abstract pc a(@Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((ow)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((oq)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final ww resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, pc> setter) {
