...
package net.labymod.v1_17_1.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_17_1.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final atk<? extends bfy> type, final bwq level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final bfw part : this.cg) {
