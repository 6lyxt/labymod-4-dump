...
public class MixinClientLevel
{
    ...
    private void labyMod$addEntity(final int entityId, final atg entity, final InsertInfo ci) {
    ...
    private void labyMod$removeEntity(final atg entity, final atg.c param0) {
        entity.b(param0);
