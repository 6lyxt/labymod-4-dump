...
@Mixin({ enq.class })
public abstract class MixinRenderType extends enp implements Blaze3DRenderType
{
    ...
    @Shadow
    public abstract void a(final dqg p0, final int p1, final int p2, final int p3);
