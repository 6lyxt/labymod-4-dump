...
import net.labymod.v1_17_1.client.resources.pack.ModifiedRepositorySource;
...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<adg>> cir) {
        final List<adg> selectedPacks = (List<adg>)cir.getReturnValue();
