...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    ...
    @Shadow
    public abstract ns a(final String p0, final ns p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract ns shadow$c(final String p0);
    ...
    @Shadow
    public abstract na shadow$p(final String p0);
    
    @Shadow
    public abstract ng c(final String p0, final int p1);
