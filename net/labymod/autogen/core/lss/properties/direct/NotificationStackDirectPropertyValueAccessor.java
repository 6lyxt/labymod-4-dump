...
{
    LssPropertyResetter NotificationStackResetter;
    
    public NotificationStackDirectPropertyValueAccessor() {
        this.NotificationStackResetter = new NotificationStackLssPropertyResetter();
    }
