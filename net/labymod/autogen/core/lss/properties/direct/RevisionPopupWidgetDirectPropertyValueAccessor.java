...
{
    LssPropertyResetter RevisionPopupWidgetResetter;
    
    public RevisionPopupWidgetDirectPropertyValueAccessor() {
        this.RevisionPopupWidgetResetter = new RevisionPopupWidgetLssPropertyResetter();
    }
