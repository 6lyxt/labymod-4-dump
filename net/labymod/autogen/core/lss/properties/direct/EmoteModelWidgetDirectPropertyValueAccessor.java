...
{
    LssPropertyResetter EmoteModelWidgetResetter;
    
    public EmoteModelWidgetDirectPropertyValueAccessor() {
        this.EmoteModelWidgetResetter = new EmoteModelWidgetLssPropertyResetter();
    }
