...
{
    LssPropertyResetter StorageServerInfoWidgetResetter;
    
    public StorageServerInfoWidgetDirectPropertyValueAccessor() {
        this.StorageServerInfoWidgetResetter = new StorageServerInfoWidgetLssPropertyResetter();
    }
