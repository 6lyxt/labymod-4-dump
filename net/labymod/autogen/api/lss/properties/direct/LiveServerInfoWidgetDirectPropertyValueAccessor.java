...
{
    LssPropertyResetter LiveServerInfoWidgetResetter;
    
    public LiveServerInfoWidgetDirectPropertyValueAccessor() {
        this.LiveServerInfoWidgetResetter = new LiveServerInfoWidgetLssPropertyResetter();
    }
