...
{
    LssPropertyResetter HudWidgetWidgetResetter;
    
    public HudWidgetWidgetDirectPropertyValueAccessor() {
        this.HudWidgetWidgetResetter = new HudWidgetWidgetLssPropertyResetter();
    }
