...
public final class SplitContentWidgetMaxPercentagePropertyValueAccessor implements PropertyValueAccessor<SplitContentWidget, Float, Float>
{
    @Override
    public LssProperty getProperty(final SplitContentWidget widget) {
        return widget.maxPercentage();
    }
