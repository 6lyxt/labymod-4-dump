...
public final class ScrollbarWidgetScrollBackgroundColorPropertyValueAccessor implements PropertyValueAccessor<ScrollbarWidget, Integer, Integer>
{
    @Override
    public LssProperty getProperty(final ScrollbarWidget widget) {
        return widget.scrollBackgroundColor();
    }
