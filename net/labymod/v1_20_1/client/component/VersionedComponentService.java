...
public class VersionedComponentService extends ComponentService
{
    ...
    public TextComponent createTextComponent(final String text) {
        return (TextComponent)((MutableComponentAccessor)sw.b(text)).getLabyComponent();
    }
    
    @Override
    public TextComponent createTextComponent(final String text, final Style style, final List<Component> children) {
        final ub contents = new ub(text);
        return (TextComponent)this.applyStyleAndSiblings((sx)contents, style, children);
    }
    
    @Override
    public ScoreComponent createScoreComponent(final String name, final String objective) {
        return (ScoreComponent)((MutableComponentAccessor)sw.b(name, objective)).getLabyComponent();
    }
    ...
    public ScoreComponent createScoreComponent(final String name, final String objective, final Style style, final List<Component> children) {
        final ud contents = new ud(name, objective);
        return (ScoreComponent)this.applyStyleAndSiblings((sx)contents, style, children);
    }
    
    @Override
    public KeybindComponent createKeybindComponent(final String keybind) {
        return (KeybindComponent)((MutableComponentAccessor)sw.d(keybind)).getLabyComponent();
    }
    
    @Override
    public KeybindComponent createKeybindComponent(final String keybind, final Style style, final List<Component> children) {
        final tz contents = new tz(keybind);
        return (KeybindComponent)this.applyStyleAndSiblings((sx)contents, style, children);
    }
    
    @Override
    protected IconComponent createIconComponent(final Icon icon) {
        return (IconComponent)((MutableComponentAccessor)tj.a((sx)new VersionedIconContents(icon))).getLabyComponent();
    }
    ...
    protected IconComponent createIconComponent(final Icon icon, final Style style, final List<Component> children) {
        ...
        return (IconComponent)this.applyStyleAndSiblings((sx)contents, style, children);
    }
    
    @Override
    public TextComponent createEmptyComponent() {
        return (TextComponent)((MutableComponentAccessor)sw.h()).getLabyComponent();
    }
    ...
    public <T> HoverEvent<T> createHoverEvent(@NotNull final HoverEvent.Action<T> action, @NotNull final T value) {
        ...
        if (value instanceof VersionedBaseComponent) {
            ...
            return (HoverEvent<T>)new tb(tb.a.a, (Object)component.holder);
        }
    ...
    public ClickEvent createClickEvent(final ClickEvent.Action action, @NotNull final String value) {
        Objects.requireNonNull(action, "Action cannot be null!");
        Objects.requireNonNull(value, "Value cannot be null!");
        final su.a vanillaAction = switch (action) {
            default -> throw new MatchException(null, null);
            case OPEN_URL -> su.a.a;
            case OPEN_FILE -> su.a.b;
            case RUN_COMMAND -> su.a.c;
            case SUGGEST_COMMAND -> su.a.d;
            case CHANGE_PAGE -> su.a.e;
            case COPY_TO_CLIPBOARD -> su.a.f;
        };
        return (ClickEvent)new su(vanillaAction, value);
    }
    
    @Override
    public TextColor createTextColor(final int value) {
        return (TextColor)tu.a(value);
    }
    ...
    public TranslatableComponent createTranslatableComponent(final String key, final Component... arguments) {
        return (TranslatableComponent)((MutableComponentAccessor)sw.a(key, (Object[])arguments)).getLabyComponent();
    }
    ...
    public TranslatableComponent createTranslatableComponent(final String key, final Style style, final List<Component> children, final List<Component> arguments) {
        ...
        if (arguments == null) {
            ...
            contents = new ug(key, key, (Object[])arguments.toArray(new Component[0]));
        }
        return (TranslatableComponent)this.applyStyleAndSiblings((sx)contents, style, children);
    }
    ...
    public Style createStyleFromBuilder(final TextColor color, final Integer shadowColor, final Boolean bold, final Boolean italic, final Boolean underlined, final Boolean strikethrough, final Boolean obfuscated, final ClickEvent clickEvent, final HoverEvent<?> hoverEvent, final String insertion, final ResourceLocation fontLocation) {
        return (Style)new ts((tu)color, bold, italic, underlined, strikethrough, obfuscated, (su)clickEvent, (tb)hoverEvent, insertion, (fontLocation == null) ? null : fontLocation.getMinecraftLocation());
    }
    ...
    public Serializer createStyleSerializer() {
        return (Serializer)new ts.b();
    }
    
    @Override
    public void applyGsonTypeAdapters(final GsonBuilder builder) {
        builder.registerTypeAdapterFactory((TypeAdapterFactory)new aox());
    }
    
    private Component applyStyleAndSiblings(final sx componentContents, final Style style, final List<Component> children) {
        ts vanillaStyle;
        if (style == null) {
            vanillaStyle = ts.a;
        }
        ...
        final tj component = new tj(componentContents, (List)new ArrayList(), vanillaStyle);
