...
public class CustomLoadingOverlay extends eud
{
    ...
    public CustomLoadingOverlay(final enn minecraft, final akt reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final eox gui, final int mouseX, final int mouseY, final float partialTicks) {
        final ehn window = this.minecraft.aM();
