...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner
{
    ...
    private boolean isExternalPack(final ajl pack) {
    ...
    private IncompatibleResourcePack scanPack(final ajl pack) {
    ...
    private void scanPack(final ajl pack, final String baseDirectory, final ajl.a output) {
        pack.a(ajm.a, "minecraft", baseDirectory, output);
    }
    
    private Collection<String> collectIgnoredFiles(final ajl pack) {
        final Set<String> ignoredFiles = new HashSet<String>();
        for (final String namespace : pack.a(ajm.a)) {
            final akp<InputStream> resource = (akp<InputStream>)pack.a(ajm.a, new acq(namespace, "labymod/ignored_files.json"));
            if (resource == null) {
                continue;
            }
