...
public class VersionedGameImageTexture extends fuo implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((acq)location.getMinecraftLocation());
    ...
    public void a(final akx resourceManager) {
        this.prepareImage();
    }
