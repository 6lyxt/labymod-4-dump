...
{
    public static void bindAttributeLocation(final eio vertexFormat, final ShaderProgram program) {
        final ImmutableList<eip> elements = (ImmutableList<eip>)vertexFormat.c();
        for (int index = 0; index < elements.size(); ++index) {
            final eip element = (eip)elements.get(index);
