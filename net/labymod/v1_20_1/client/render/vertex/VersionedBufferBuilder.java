...
import net.labymod.v1_20_1.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, fkf> RENDER_TYPE_FUNCTION;
    private final eil tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private ein consumer;
    private eie bufferBuilder;
    @Deprecated
    private fjx.a bufferSource;
    private RenderPhase renderPhase;
    private fkf renderType;
    private OldVertexFormat currentFormat;
    private eie.b renderedBuffer;
    
    public VersionedBufferBuilder() {
        this.tesselator = eil.a();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final eie builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (eio)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final fjx multiBufferSource) {
    ...
    public void uploadToBuffer() {
        ...
        this.renderType.a(this.bufferBuilder, eir.a);
    }
    ...
    public boolean building() {
        ...
        final ein consumer = this.consumer;
        if (consumer instanceof final eie bufferBuilder) {
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (eio)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public eie getBufferBuilder() {
        return this.bufferBuilder;
    }
    
    public eie.b renderedBuffer() {
