...
{
    public ModelPartAnimationTransformation(final fee modelPart, final Transformation modelPartTransform) {
    ...
    private static class ModelPartPositionVector extends FloatVector3
    {
        ...
        public ModelPartPositionVector(final fee modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final fee modelPart) {
            this.modelPart = modelPart;
        }
