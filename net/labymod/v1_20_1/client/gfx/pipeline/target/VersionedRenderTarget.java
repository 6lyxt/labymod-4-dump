...
package net.labymod.v1_20_1.client.gfx.pipeline.target;
...
{
    private final egv renderTarget;
    
    public VersionedRenderTarget(final egv renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final egv renderTarget2 = this.renderTarget;
        ...
        final egv renderTarget3 = this.renderTarget;
