...
{
    public VersionedScoreComponent(final tj holder) {
        super(holder);
    }
    ...
    public String getName() {
        ...
        if (contents instanceof final ud score) {
            return score.a();
        }
    ...
    public Component value() {
        ...
        if (level != null) {
            final efg scoreboard = level.I();
            final efd objective = scoreboard.d(this.getObjective());
            if (objective != null) {
                final String name = this.getName();
                if (scoreboard.b(name, objective)) {
                    final eff score = scoreboard.c(name, objective);
