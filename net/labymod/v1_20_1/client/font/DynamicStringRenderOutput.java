...
public class DynamicStringRenderOutput extends eov.b
{
    public DynamicStringRenderOutput(final eov font, final fjx bufferSource, final float x, final float y, final int color, final boolean shadow, final Matrix4f modelViewMatrix, final eov.a displayMode, final int packedLightCoords) {
