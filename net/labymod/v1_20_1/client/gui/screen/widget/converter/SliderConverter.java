...
public class SliderConverter extends AbstractMinecraftWidgetConverter<epd, SliderWidget>
{
    ...
    @Override
    public SliderWidget createDefault(final epd source) {
        final SliderWidget destination = new SliderWidget().withFormatter(() -> this.mapComponent(source.l()));
    ...
    @Override
    public void update(final epd source, final SliderWidget destination) {
    ...
    @Override
    public String getWidgetId(final epd source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.l());
    }
    
    @Override
    public List<String> getWidgetIds(final epd source) {
