...
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<erb, AbstractWidget<?>>
{
    ...
    @Override
    public void update(final erb source, final AbstractWidget<?> destination) {
        final TabNavigationBarAccessor accessor = (TabNavigationBarAccessor)source;
        final era tabManager = accessor.getTabManager();
