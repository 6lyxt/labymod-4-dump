...
public final class MinecraftUtil
{
    ...
    public static Stack obtainStackFromGraphics(final eox graphics) {
        return ((VanillaStackAccessor)graphics.c()).stack();
    }
    
    public static ItemStack fromMinecraftSlot(final bfz entity, final LivingEntity.EquipmentSpot spot) {
        return fromMinecraft(entity.c(toMinecraft(spot)));
    }
    
    public static ItemStack fromMinecraft(final cfz itemStack) {
        return (ItemStack)itemStack;
    }
    
    public static cfz toMinecraft(final ItemStack itemStack) {
    ...
    public static bfo toMinecraft(final LivingEntity.EquipmentSpot spot) {
        return switch (spot) {
            default -> throw new MatchException(null, null);
            case HEAD -> bfo.f;
            case CHEST -> bfo.e;
    ...
    public static ModelTransformType fromMinecraft(final cfw context) {
    ...
    public static void exportScreenshotToFile(final ehk image, final File file) throws IOException {
    ...
    public static PlayerModel obtainPlayerModel(final Player player) {
        final fow dispatcher = enn.N().an();
        final fox entityRenderer = dispatcher.a((bfj)player);
        if (entityRenderer instanceof final fty playerRenderer) {
            return (PlayerModel)playerRenderer.a();
        }
        throw new IllegalStateException("Renderer for the player could not be found");
    }
    
    public static TextDrawMode fromMinecraft(final eov.a displayMode) {
    ...
    public static eov.a toMinecraft(final TextDrawMode textDrawMode) {
        return switch (textDrawMode) {
            default -> throw new MatchException(null, null);
            case NORMAL -> eov.a.a;
            case SEE_THROUGH -> eov.a.b;
            case POLYGON_OFFSET -> eov.a.c;
        };
    }
    
    public static aom fromText(final String text, final Style style) {
        final qm language = qm.a();
