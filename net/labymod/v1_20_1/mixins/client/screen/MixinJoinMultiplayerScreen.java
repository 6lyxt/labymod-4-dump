...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final eox param0, final eov param1, final sw param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final ffd serverData, final InsertInfo ci) {
