...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final fyp server, final epi button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final fyp server, final epi button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
