...
public class MixinClientLevel
{
    ...
    private void labyMod$addEntity(final int entityId, final bfj entity, final InsertInfo ci) {
    ...
    private void labyMod$removeEntity(final bfj entity, final bfj.c param0) {
        entity.b(param0);
