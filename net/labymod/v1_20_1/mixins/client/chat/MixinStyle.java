...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract ts a(@Nullable final tb p0);
    ...
    @Shadow
    public abstract ts a(@Nullable final su p0);
    
    @Shadow
    public abstract ts a(@Nullable final tu p0);
    ...
    @Shadow
    public abstract ts a(@Nullable final Boolean p0);
    
    @Shadow
    public abstract ts b(@Nullable final Boolean p0);
    
    @Shadow
    public abstract ts c(@Nullable final Boolean p0);
    
    @Shadow
    public abstract ts d(@Nullable final Boolean p0);
    
    @Shadow
    public abstract ts e(@Nullable final Boolean p0);
    
    @Shadow
    public abstract acq shadow$k();
    
    @Shadow
    public abstract ts a(@Nullable final acq p0);
    
    @Shadow
    public abstract ts a(@Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((tb)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((su)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final acq resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, ts> setter) {
