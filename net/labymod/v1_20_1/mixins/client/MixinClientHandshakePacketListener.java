...
public class MixinClientHandshakePacketListener
{
    ...
    public sw labyMod$fireServerKickEvent(final sw reason) {
        ...
        return (sw)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.LOGIN)).reason());
    }
}
