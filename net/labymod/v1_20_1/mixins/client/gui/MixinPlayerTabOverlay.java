...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final eox graphics, final int screenWidth, final efg scoreboard, final efd objective, final InsertInfo ci) {
