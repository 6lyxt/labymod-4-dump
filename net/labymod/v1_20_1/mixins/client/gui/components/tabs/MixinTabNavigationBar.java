...
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends eqr implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor
{
    ...
    private final Map<eqz, VersionedTab> versionedTabs;
    @Shadow
    @Final
    ...
    public MixinTabNavigationBar() {
        ...
        this.versionedTabs = new HashMap<eqz, VersionedTab>();
    }
    ...
    public VersionedTab versionedTabOf(final eqz tab) {
        return this.versionedTabs.computeIfAbsent(tab, VersionedTab::new);
    }
    
    @Insert(method = { "render" }, at = @At("HEAD"), cancellable = true)
    public void render(final eox graphics, final int mouseX, final int mouseY, final float partialTicks, final InsertInfo ci) {
        final eqz tab = this.h.a();
