...
public abstract class MixinAbstractSelectionListScrollbar
{
    ...
    private int labyMod$render(final epc instance) {
        ...
        final int x = this.c();
        final Bounds scrollBar = new PositionedBounds((float)x, (float)this.f, (float)(x + 6), (float)this.g);
        final float scrollBarHeight = scrollBar.getHeight();
        final int contentHeight = this.a() - this.k;
