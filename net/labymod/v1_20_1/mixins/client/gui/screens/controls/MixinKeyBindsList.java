...
public class MixinKeyBindsList
{
    ...
    private enl[] labyMod$addCustomKeybindings(final enr instance) {
        final List<enl> keyMappings = new ArrayList<enl>(Arrays.asList(instance.X));
        ...
        return keyMappings.toArray(new enl[0]);
    }
}
