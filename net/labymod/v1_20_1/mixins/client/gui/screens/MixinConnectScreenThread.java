...
public class MixinConnectScreenThread
{
    ...
    private Optional<ffz> labyMod$resolveAddress(final fgc resolver, final fga address) {
    ...
    public sw labyMod$fireServerKickEvent(final sw reason) {
        ...
        return (sw)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN)).reason());
    }
}
