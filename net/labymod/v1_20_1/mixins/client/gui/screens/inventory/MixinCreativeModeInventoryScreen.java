...
package net.labymod.v1_20_1.mixins.client.gui.screens.inventory;
...
@Mixin({ ewd.class })
public abstract class MixinCreativeModeInventoryScreen extends ewg<ewd.b>
{
    ...
    public MixinCreativeModeInventoryScreen(final ewd.b pickerMenu, final byn inventory, final sw component) {
        super((cbf)pickerMenu, inventory, component);
    }
    ...
    @Redirect(method = { "renderBg" }, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/gui/screens/inventory/InventoryScreen;renderEntityInInventoryFollowsMouse(Lnet/minecraft/client/gui/GuiGraphics;IIIFFLnet/minecraft/world/entity/LivingEntity;)V"))
    private void labyMod$setEntityToOldPosition(final eox graphics, final int x, final int y, final int scale, final float mouseX, final float mouseY, final bfz entity) {
        if (this.labyMod$oldCreativeLayoutTexture) {
            ewo.a(graphics, x - this.labyMod$entityXShift, y - this.labyMod$entityYShift, scale, mouseX - this.labyMod$entityXShift, mouseY - this.labyMod$entityYShift, entity);
            return;
        }
        ewo.a(graphics, x, y, scale, mouseX, mouseY, entity);
    }
    ...
    private void labyMod$setOldCreativeTexture(final eox graphics, final acq location, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5, final int $$6) {
        if (!this.labyMod$oldCreativeLayoutTexture) {
        ...
        if (resourceLocation != null) {
            graphics.a((acq)resourceLocation.getMinecraftLocation(), $$1, $$2, $$3, $$4, $$5, $$6);
        }
    }
    ...
    private void labyMod$onSelectTab(final cef tab, final CallbackInfo ci) {
        this.labyMod$modifySlots();
    }
    
    private void labyMod$modifySlots() {
        if (this.labyMod$oldCreativeLayoutTexture) {
            for (final ccx slot : ((ewd.b)this.C()).i) {
    ...
    @NotNull
    private ccx getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final InventorySlotData legacySlot, @NotNull final ccx slot) {
