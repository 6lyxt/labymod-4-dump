...
@Mixin({ ewo.class })
public abstract class MixinInventoryScreen extends ewg<cce>
{
    private InventorySlotRegistry labyMod$inventorySlotRegistry;
    private boolean labyMod$oldSurvivalLayoutTexture;
    
    public MixinInventoryScreen(final cce param0, final byn param1, final sw param2) {
        super((cbf)param0, param1, param2);
    }
    ...
    private void labyMod$init(final InsertInfo info) {
        ...
        for (final ccx slot : ((cce)this.C()).i) {
    ...
    private void labyMod$setOldSurvivalLayoutTexture(final eox graphics, acq location, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5, final int $$6) {
    ...
    @NotNull
    private ccx getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final ccx slot) {
