...
package net.labymod.v1_20_1.mixins.client.renderer.shader;
...
import net.labymod.v1_20_1.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final ehz shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (fki)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final ehz shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (fki)this);
    }
