...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final fjt renderer, final bfz livingEntity, final cfz itemStack, final cfw type, final boolean leftHand, final eij poseStack, final fjx bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final bfz livingEntity, final cfz itemStack, final cfw type, final boolean leftHand, final int combinedLight) {
