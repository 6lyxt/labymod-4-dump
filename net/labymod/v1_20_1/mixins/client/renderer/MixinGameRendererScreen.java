...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final euq instance, final eox graphics, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
