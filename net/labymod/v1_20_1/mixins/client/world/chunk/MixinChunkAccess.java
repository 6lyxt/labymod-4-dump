...
public abstract class MixinChunkAccess implements Chunk
{
    ...
    @Shadow
    public abstract dhk a(final dhk.a p0);
    
    @Shadow
    public abstract dej b(final int p0);
    ...
    public Heightmap heightmap(final HeightmapType type) {
        ...
        return (Heightmap)this.a(dhk.a.b);
    }
    ...
    public BlockState getBlockState(final int x, final int y, final int z) {
        final int index = ((ddx)this).e(y);
        if (index < 0 || index >= this.m.length) {
            return (BlockState)cpo.a.n();
        }
        final dej section = this.m[index];
        if (section == null) {
            return (BlockState)cpo.a.n();
        }
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (final Map.Entry<gu, czn> entry : this.k.entrySet()) {
    ...
    public int getHeightBasedOnSection(final int startY) {
        final dej[] sections = this.d();
        if (sections.length == 0) {
            return 0;
        }
        final int bottomY = this.C_();
        ...
        for (int index = startSectionIndex; index < sections.length; ++index) {
            final dej section = sections[index];
            if (section != null) {
                if (!section.c()) {
