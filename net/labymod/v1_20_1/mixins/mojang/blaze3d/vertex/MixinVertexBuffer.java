...
package net.labymod.v1_20_1.mixins.mojang.blaze3d.vertex;
...
public class MixinVertexBuffer
{
    ...
    private void labyMod$applyShaderInstance(final fki shaderInstance) {
    ...
    private void labyMod$clearShaderInstance(final fki shaderInstance) {
        final DefaultShaderProgramApplier program_APPLIER = MixinVertexBuffer.PROGRAM_APPLIER;
        Objects.requireNonNull(shaderInstance);
