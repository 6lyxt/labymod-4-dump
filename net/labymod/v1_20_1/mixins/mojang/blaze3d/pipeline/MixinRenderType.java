...
@Mixin({ fkf.class })
public abstract class MixinRenderType extends fke implements Blaze3DRenderType
{
    @Shadow
    public abstract void a(final eie p0, final eir p1);
    ...
    public void draw(final BufferConsumer consumer, final int cameraX, final int cameraY, final int cameraZ) {
        if (consumer instanceof final eie bufferBuilder) {
            this.a(bufferBuilder, eir.a((float)cameraX, (float)cameraY, (float)cameraZ));
            return;
        }
