...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<akg>> cir) {
        final List<akg> selectedPacks = (List<akg>)cir.getReturnValue();
