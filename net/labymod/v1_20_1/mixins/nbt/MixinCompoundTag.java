...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    ...
    @Shadow
    public abstract rk a(final String p0, final rk p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract rk shadow$c(final String p0);
    ...
    @Shadow
    public abstract qr shadow$p(final String p0);
    
    @Shadow
    public abstract qx c(final String p0, final int p1);
