...
public abstract class MixinListTag implements NBTTagList
{
    ...
    @Shadow
    public abstract boolean b(final int p0, final rk p1);
    
    @Shadow
    public abstract boolean a(final int p0, final rk p1);
    
    @Shadow
    public abstract void c(final int p0, final rk p1);
    
    @Shadow
    public abstract rk shadow$c(final int p0);
