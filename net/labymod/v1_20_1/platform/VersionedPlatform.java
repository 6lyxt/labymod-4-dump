...
import net.labymod.v1_20_1.client.render.vertex.VersionedVertexFormat;
...
public class VersionedPlatform extends Platform
{
    public void onInitialization() {
        this.setMinecraft((Minecraft)enn.N());
    ...
    private void registerVertexFormats() {
        this.register(VertexFormatType.POSITION_COLOR, this.createFormat(eih.n, fjq::q));
        this.register(VertexFormatType.POSITION_TEXTURE_COLOR, this.createFormat(eih.s, fjq::t));
        this.register(VertexFormatType.POSITION_COLOR_NORMAL, this.createFormat(eih.o, fjq::aq));
        this.register(VertexFormatType.ENTITY, this.createFormat(eih.k, fjq::M));
        this.register(VertexFormatType.POSITION_COLOR_TEXTURE_LIGHTMAP, this.createFormat(eih.t, fjq::w));
    }
    ...
    @NotNull
    private OldVertexFormat createFormat(final eio format, final Supplier<fki> shaderSupplier) {
