...
import net.labymod.v1_18_2.client.render.vertex.VersionedVertexFormat;
...
public class VersionedPlatform extends Platform
{
    public void onInitialization() {
        this.setMinecraft((Minecraft)dyr.D());
    ...
    private void registerVertexFormats() {
        this.register(VertexFormatType.POSITION_COLOR, this.createFormat(dtk.n, eql::q));
        this.register(VertexFormatType.POSITION_TEXTURE_COLOR, this.createFormat(dtk.s, eql::t));
        this.register(VertexFormatType.POSITION_COLOR_NORMAL, this.createFormat(dtk.o, eql::ap));
        this.register(VertexFormatType.ENTITY, this.createFormat(dtk.k, eql::v));
        this.register(VertexFormatType.POSITION_COLOR_TEXTURE_LIGHTMAP, this.createFormat(dtk.t, eql::y));
    }
    ...
    @NotNull
    private OldVertexFormat createFormat(final dtr format, final Supplier<erd> shaderSupplier) {
