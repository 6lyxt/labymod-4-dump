...
public class MixinBlockEntityUpdateEvent
{
    ...
    private void labyMod$fireTileEntityPreLoadEvent(final ok tag, final InsertInfo ci) {
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final cav level, final gj pos, final cov state, final InsertInfo ci) {
        final cmr blockEntity = level.c_(pos);
