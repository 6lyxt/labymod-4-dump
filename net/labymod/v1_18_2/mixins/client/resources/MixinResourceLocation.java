...
public abstract class MixinResourceLocation implements ResourceLocation
{
    ...
    public InputStream openStream() throws IOException {
        ...
        return dyr.D().N().getResource((yt)this.getMinecraftLocation()).b();
    }
    
    @Override
    public boolean exists() {
        return ResourcesUtil.hasResource(this.getMinecraftLocation()) || dyr.D().N().a((yt)this.getMinecraftLocation());
    }
