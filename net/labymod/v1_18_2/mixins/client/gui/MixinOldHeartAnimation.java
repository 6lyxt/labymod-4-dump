...
public class MixinOldHeartAnimation
{
    ...
    private void labyMod$applyOldHeartAnimation(final dzq instance, final dtm poseStack, final int i0, final int i1, int i2, final int i3, final int i4, final int i5, final Operation<Void> original) {
