...
public class MixinKeyBindsList
{
    ...
    private dyo[] labyMod$addCustomKeybindings(final dyv instance) {
        final List<dyo> keyMappings = new ArrayList<dyo>(Arrays.asList(instance.aT));
        ...
        return keyMappings.toArray(new dyo[0]);
    }
}
