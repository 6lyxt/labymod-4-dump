...
@Mixin({ efh.class })
public abstract class MixinCreativeModeInventoryScreen extends efj<efh.b>
{
    ...
    public MixinCreativeModeInventoryScreen(final efh.b pickerMenu, final boi inventory, final qk component) {
        super((bqp)pickerMenu, inventory, component);
    }
    ...
    private void labyMod$setEntityToOldPosition(final int x, final int y, final int scale, final float mouseX, final float mouseY, final axy entity) {
    ...
    private void labyMod$setOldCreativeTexture(final int slot, final yt location) {
        if (!this.labyMod$oldCreativeLayoutTexture) {
    ...
    private void labyMod$onSelectTab(final btm tab, final CallbackInfo ci) {
        this.labyMod$modifySlots();
    }
    
    private void labyMod$modifySlots() {
        if (this.labyMod$oldCreativeLayoutTexture) {
            for (final bsg slot : ((efh.b)this.v()).i) {
    ...
    @NotNull
    private bsg getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final InventorySlotData legacySlot, @NotNull final bsg slot) {
