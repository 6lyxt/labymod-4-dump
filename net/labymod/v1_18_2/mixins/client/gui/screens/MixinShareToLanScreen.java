...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final eae button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final eae button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
