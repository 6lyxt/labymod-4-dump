...
public abstract class MixinLocalPlayer extends MixinAbstractLocalPlayer implements ClientPlayer
{
    ...
    @Shadow
    public abstract void a(final awg p0);
    ...
    public boolean isHandActive() {
        return this.labyMod$getClientPlayer().eM();
    }
    
    @Override
    public boolean isUsingBow() {
        return this.labyMod$getClientPlayer().eO().c() == buy.mg;
    }
    ...
    public void swingArm(final LivingEntity.Hand hand, final boolean cancelPacket) {
        final awg interactionHand = (hand == LivingEntity.Hand.MAIN_HAND) ? awg.a : awg.b;
    ...
    private void labyMod$cancelHandSwingPacket(final awg hand, final InsertInfo ci) {
