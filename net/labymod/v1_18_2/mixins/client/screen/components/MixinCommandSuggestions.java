...
package net.labymod.v1_18_2.mixins.client.screen.components;
...
public class MixinCommandSuggestions implements CommandSuggestionsAccessor
{
    ...
    private void labyMod$modifyBackgroundPosition(final dtm stack, final int left, final int top, final int right, final int bottom, final int color) {
        dzr.a(stack, left, (this.bottomY != -1) ? (this.bottomY - 12) : top, right, (this.bottomY != -1) ? (this.bottomY - 12 + (bottom - top)) : bottom, color);
    }
    ...
    private int labyMod$modifyTextPosition(final dzp font, final dtm stack, final aiz text, final float x, final float y, final int color) {
