...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final edw instance, final dtm poseStack, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
