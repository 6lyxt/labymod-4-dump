...
public abstract class MixinTextureManager implements GameTextureManager
{
    ...
    @Shadow
    public abstract void a(final yt p0, final fam p1);
    ...
    public void registerAndRelease(final ResourceLocation location, final Object texture) {
        if (texture instanceof final fam textureObject) {
            final fam currentTexture = this.c.get(location);
            this.a((yt)location, textureObject);
    ...
    public void labyMod$deleteTexture(final yt location, final InsertInfo callback) {
