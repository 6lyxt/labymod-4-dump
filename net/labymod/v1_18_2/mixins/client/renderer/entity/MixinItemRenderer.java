...
{
    @Shadow
    public abstract void a(final dzp p0, final buw p1, final int p2, final int p3);
    
    @Shadow
    public abstract void c(final buw p0, final int p1, final int p2);
    ...
    public void renderItemStack(final Stack stack, final ItemStack itemStack, final int x, final int y, final boolean decorate, final float alpha) {
        final buw minecraftItemStack = MinecraftUtil.toMinecraft(itemStack);
        final dtm minecraftModelViewStack = RenderSystem.getModelViewStack();
        ...
        if (decorate) {
            this.a(dyr.D().h, minecraftItemStack, x, y);
        }
        modelViewStack.pop();
        RenderSystem.applyModelViewMatrix();
    }
