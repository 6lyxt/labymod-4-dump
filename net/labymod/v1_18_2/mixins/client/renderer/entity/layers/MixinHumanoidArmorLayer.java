...
public class MixinHumanoidArmorLayer
{
    ...
    private void labyMod$getLivingEntity(final dtm poseStack, final eqs bufferSource, final int packedLight, final axy entity, final float param4, final float param5, final float param6, final float param7, final float param8, final float param9, final InsertInfo info) {
        this.labyMod$overlayCoords = ewk.c(entity, 0.0f);
    }
    ...
    private void labyMod$enableOverlayTexture(final ejv model, final dtm stack, final dtq consumer, final int packedLight, final int overlayTexture, final float red, final float green, final float blue, final float alpha) {
