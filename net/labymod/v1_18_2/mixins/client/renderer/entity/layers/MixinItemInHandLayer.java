...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final eqo renderer, final axy livingEntity, final buw itemStack, final ery.b type, final boolean leftHand, final dtm poseStack, final eqs bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final axy livingEntity, final buw itemStack, final ery.b type, final boolean leftHand, final int combinedLight) {
