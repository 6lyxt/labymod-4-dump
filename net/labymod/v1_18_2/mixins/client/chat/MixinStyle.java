...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract qu a(@Nullable final qo p0);
    ...
    @Shadow
    public abstract qu a(@Nullable final qi p0);
    
    @Shadow
    public abstract qu a(@Nullable final qw p0);
    ...
    @Shadow
    public abstract qu a(@Nullable final Boolean p0);
    
    @Shadow
    public abstract qu b(@Nullable final Boolean p0);
    
    @Shadow
    public abstract qu c(@Nullable final Boolean p0);
    
    @Shadow
    public abstract qu d(@Nullable final Boolean p0);
    
    @Shadow
    public abstract qu e(@Nullable final Boolean p0);
    
    @Shadow
    public abstract yt shadow$k();
    
    @Shadow
    public abstract qu a(@Nullable final yt p0);
    
    @Shadow
    public abstract qu a(@Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((qo)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((qi)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final yt resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, qu> setter) {
