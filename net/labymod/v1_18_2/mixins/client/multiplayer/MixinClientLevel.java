...
public class MixinClientLevel
{
    ...
    private void labyMod$addEntity(final int entityId, final axk entity, final InsertInfo ci) {
    ...
    private void labyMod$removeEntity(final axk entity, final axk.c param0) {
        entity.b(param0);
