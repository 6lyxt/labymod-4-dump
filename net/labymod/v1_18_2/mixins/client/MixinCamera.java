...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final dpo position = this.b();
        this.labymod$cameraPosition.set((float)position.a(go.a.a), (float)position.a(go.a.b), (float)position.a(go.a.c));
    ...
    public DoubleVector3 position() {
        final dpo position = this.b();
        this.labyMod$position.set(position.a(go.a.a), position.a(go.a.b), position.a(go.a.c));
