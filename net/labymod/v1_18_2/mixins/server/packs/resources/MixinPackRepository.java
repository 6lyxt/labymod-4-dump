...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<afl>> cir) {
        final List<afl> selectedPacks = (List<afl>)cir.getReturnValue();
