...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    ...
    @Shadow
    public abstract pd a(final String p0, final pd p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract pd shadow$c(final String p0);
    ...
    @Shadow
    public abstract ok shadow$p(final String p0);
    
    @Shadow
    public abstract oq c(final String p0, final int p1);
