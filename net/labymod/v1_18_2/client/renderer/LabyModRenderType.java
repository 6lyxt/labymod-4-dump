...
public class LabyModRenderType extends era
{
    private final RenderPhase phase;
    
    public LabyModRenderType(final RenderPhase phase) {
        final String name = phase.getName();
        final dtr dtr = phase.getVertexFormat().getMojangVertexFormat();
        final dtr.b mode = getMode(phase.getMode());
        ...
        Objects.requireNonNull(phase);
        super(name, dtr, mode, bufferSize, affectsCrumbling, sortOnUpload, runnable, phase::clear);
        this.phase = phase;
    }
    ...
    public static dtr.b getMode(final int mode) {
        return switch (mode) {
            case 0,  4,  7 -> dtr.b.h;
            case 1 -> dtr.b.a;
            case 3 -> dtr.b.d;
