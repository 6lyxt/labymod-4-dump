...
public class VersionedShopItemLayer extends ezo<ept, ekm<ept>>
{
    ...
    public VersionedShopItemLayer(final exe<ept, ekm<ept>> layerParent) {
        super((exe)layerParent);
        this.playerModel = (ekm<ept>)layerParent.a();
    }
    
    public void render(@NotNull final dtm poseStack, @NotNull final eqs bufferSource, final int packedLight, @NotNull final ept player, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch) {
