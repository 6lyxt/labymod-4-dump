...
{
    public static void bindAttributeLocation(final dtr vertexFormat, final ShaderProgram program) {
        final ImmutableList<dts> elements = (ImmutableList<dts>)vertexFormat.c();
        for (int index = 0; index < elements.size(); ++index) {
            final dts element = (dts)elements.get(index);
