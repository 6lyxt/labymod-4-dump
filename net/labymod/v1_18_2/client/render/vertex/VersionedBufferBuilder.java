...
import net.labymod.v1_18_2.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (dtr)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final eqs multiBufferSource) {
    ...
    public boolean building() {
        ...
        final dtq consumer = this.consumer;
        if (consumer instanceof final dth bufferBuilder) {
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (dtr)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public dth getBufferBuilder() {
