...
public class VersionedGameImageTexture extends fau implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((yt)location.getMinecraftLocation());
    ...
    public void a(final aga resourceManager) {
        this.prepareImage();
    }
