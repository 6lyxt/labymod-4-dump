...
public class CustomLoadingOverlay extends edj
{
    ...
    public CustomLoadingOverlay(final dyr minecraft, final afx reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final dtm stack, final int mouseX, final int mouseY, final float tickDelta) {
        final dsr window = this.minecraft.aC();
        ...
        this.loadingRenderer.render(apiStack, 0.0f, 0.0f, (float)width, (float)height, tickDelta);
        if (this.reload.c()) {
