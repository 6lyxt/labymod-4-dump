...
public final class MinecraftUtil
{
    ...
    public static ItemStack fromMinecraftSlot(final axy entity, final LivingEntity.EquipmentSpot spot) {
        return fromMinecraft(entity.b(toMinecraft(spot)));
    }
    
    public static ItemStack fromMinecraft(final buw itemStack) {
        return (ItemStack)itemStack;
    }
    
    public static buw toMinecraft(final ItemStack itemStack) {
        return (buw)itemStack;
    }
    
    public static Direction fromMinecraft(final go direction) {
    ...
    public static go toMinecraft(@NotNull final Direction direction) {
        return switch (direction) {
            default -> throw new MatchException(null, null);
            case DOWN -> go.a;
            case UP -> go.b;
    ...
    public static axp toMinecraft(final LivingEntity.EquipmentSpot spot) {
        return switch (spot) {
            default -> throw new MatchException(null, null);
            case HEAD -> axp.f;
            case CHEST -> axp.e;
    ...
    public static ModelTransformType fromMinecraft(final ery.b context) {
    ...
    public static void exportScreenshotToFile(final dsn image, final File file) throws IOException {
    ...
    public static PlayerModel obtainPlayerModel(final Player player) {
        final evi dispatcher = dyr.D().ab();
        final evj entityRenderer = dispatcher.a((axk)player);
        if (entityRenderer instanceof final faf playerRenderer) {
            return (PlayerModel)playerRenderer.a();
        }
        throw new IllegalStateException("Renderer for the player could not be found");
    }
    
    public static TextDrawMode fromMinecraft(final dzp.a displayMode) {
    ...
    public static dzp.a toMinecraft(final TextDrawMode textDrawMode) {
        return switch (textDrawMode) {
            default -> throw new MatchException(null, null);
            case NORMAL -> dzp.a.a;
            case SEE_THROUGH -> dzp.a.b;
            case POLYGON_OFFSET -> dzp.a.c;
        };
    }
    
    public static aiz fromText(final String text, final Style style) {
        final of language = of.a();
