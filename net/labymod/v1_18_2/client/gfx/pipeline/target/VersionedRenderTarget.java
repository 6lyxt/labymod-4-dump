...
package net.labymod.v1_18_2.client.gfx.pipeline.target;
...
{
    private final drz renderTarget;
    
    public VersionedRenderTarget(final drz renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final drz renderTarget2 = this.renderTarget;
        ...
        final drz renderTarget3 = this.renderTarget;
