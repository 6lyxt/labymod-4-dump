...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    ...
    @Shadow
    public abstract vu a(final String p0, final vu p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract vu shadow$c(final String p0);
    ...
    @Shadow
    public abstract ux shadow$p(final String p0);
    
    @Shadow
    public abstract vd c(final String p0, final int p1);
