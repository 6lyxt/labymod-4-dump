...
public abstract class MixinResourceLocation implements ResourceLocation
{
    ...
    public InputStream openStream() throws IOException {
        ...
        return fmg.Q().ac().getResource((alz)this.getMinecraftLocation()).orElseThrow(IOException::new).d();
    }
    
    @Override
    public boolean exists() {
        return ResourcesUtil.hasResource(this.getMinecraftLocation()) || fmg.Q().ac().getResource((alz)this.getMinecraftLocation()).isPresent();
    }
