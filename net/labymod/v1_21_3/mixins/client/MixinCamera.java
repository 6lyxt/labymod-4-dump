...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final fby position = this.b();
        this.labymod$cameraPosition.set((float)position.a(jm.a.a), (float)position.a(jm.a.b), (float)position.a(jm.a.c));
    ...
    public DoubleVector3 position() {
        final fby position = this.b();
        this.labyMod$position.set(position.a(jm.a.a), position.a(jm.a.b), position.a(jm.a.c));
