...
public class MixinConnectScreenThread
{
    ...
    private Optional<ghb> labyMod$resolveAddress(final ghe resolver, final ghc address) {
    ...
    public xv labyMod$fireServerKickEvent(final xv reason) {
        ...
        return (xv)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN)).reason());
    }
}
