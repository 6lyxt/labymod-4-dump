...
public abstract class MixinAbstractSelectionListScrollbar extends fnx
{
    ...
    public MixinAbstractSelectionListScrollbar(final int $$0, final int $$1, final int $$2, final int $$3, final xv $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(final foa instance) {
        ...
        final int contentHeight = this.l() - this.f;
