...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract ys a(@Nullable final yb p0);
    ...
    @Shadow
    public abstract ys a(@org.jetbrains.annotations.Nullable final xt p0);
    
    @Shadow
    public abstract ys a(@org.jetbrains.annotations.Nullable final yu p0);
    ...
    @Shadow
    public abstract ys a(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract ys b(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract ys c(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract ys d(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract ys e(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract alz shadow$k();
    
    @Shadow
    public abstract ys a(@org.jetbrains.annotations.Nullable final alz p0);
    
    @Shadow
    public abstract ys a(@org.jetbrains.annotations.Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((yb)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((xt)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final alz resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, ys> setter) {
