...
package net.labymod.v1_21_3.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_21_3.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final bvr<? extends cku> type, final dhi level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final ckr part : this.ck) {
