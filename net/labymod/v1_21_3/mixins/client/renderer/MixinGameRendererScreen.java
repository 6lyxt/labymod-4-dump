...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final fty instance, final fns graphics, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
