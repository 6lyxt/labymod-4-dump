...
{
    @Nullable
    private fmj.g labyMod$wrappedIntRangeBase;
    @Shadow
    @Final
    private fmj.k<T> e;
    ...
    private fmj.g labyMod$createWrappedIntRangeBase() {
        ...
        if (fmj.g.class.isAssignableFrom(cls)) {
            return (fmj.g)new WrappedIntRangeBase((fmj.g)this.e);
        }
        return null;
    }
}
