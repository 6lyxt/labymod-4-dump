...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final hfw server, final fof button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final hfw server, final fof button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
