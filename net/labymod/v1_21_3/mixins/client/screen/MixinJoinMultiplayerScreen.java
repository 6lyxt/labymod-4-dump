...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final fns param0, final fnq param1, final xv param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final gfz serverData, final InsertInfo ci) {
