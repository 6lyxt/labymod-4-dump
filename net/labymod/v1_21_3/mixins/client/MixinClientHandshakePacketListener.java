...
public class MixinClientHandshakePacketListener
{
    ...
    public wr labyMod$fireServerKickEvent(final wr details) {
        ...
        final xv newReason = (xv)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(details.a()), ServerKickEvent.Context.LOGIN)).reason());
        return new wr(newReason, details.b(), details.c());
    }
}
