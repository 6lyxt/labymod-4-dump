...
public class MixinConnection
{
    ...
    public xv labyMod$modifyReason(final xv component) {
        ...
        return (xv)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY)).reason());
    }
}
