...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<avd>> cir) {
        final List<avd> selectedPacks = (List<avd>)cir.getReturnValue();
