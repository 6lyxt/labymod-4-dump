...
public class SliderConverter extends AbstractMinecraftWidgetConverter<fob, SliderWidget>
{
    ...
    @Override
    public SliderWidget createDefault(final fob source) {
    ...
    @Override
    public void update(final fob source, final SliderWidget destination) {
    ...
    @Override
    public String getWidgetId(final fob source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.z());
    }
    
    @Override
    public List<String> getWidgetIds(final fob source) {
