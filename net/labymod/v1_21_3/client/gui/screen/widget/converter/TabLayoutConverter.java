...
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<fql, AbstractWidget<?>>
{
    ...
    @Override
    public void update(final fql source, final AbstractWidget<?> destination) {
        final TabNavigationBarAccessor accessor = (TabNavigationBarAccessor)source;
        final fqk tabManager = accessor.getTabManager();
