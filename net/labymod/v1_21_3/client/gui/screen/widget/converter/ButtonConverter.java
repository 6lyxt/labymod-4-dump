...
public class ButtonConverter extends AbstractMinecraftWidgetConverter<fnw, ButtonWidget>
{
    ...
    @Override
    public ButtonWidget createDefault(final fnw source) {
        final ButtonWidget destination = ButtonWidget.component((source instanceof fpl.b) ? null : this.mapComponent(source.z()), null, Pressable.NOOP);
    ...
    @Override
    public void update(final fnw source, final ButtonWidget destination) {
    ...
    @Override
    public String getWidgetId(final fnw source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.z());
    }
    
    @Override
    public List<String> getWidgetIds(final fnw source) {
    ...
    {
        @Override
        public ButtonWidget map(final fnw source) {
            if (source instanceof final fos imageButton) {
    ...
    class LockIconButtonMapper implements Mapper<fnw, ButtonWidget>
    {
        ...
        @Override
        public ButtonWidget map(final fnw source) {
            if (source instanceof final fow lockIconButton) {
