...
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<foo, TextFieldWidget>
{
    ...
    @Override
    public TextFieldWidget createDefault(final foo source) {
    ...
    @Override
    public void update(final foo source, final TextFieldWidget destination) {
