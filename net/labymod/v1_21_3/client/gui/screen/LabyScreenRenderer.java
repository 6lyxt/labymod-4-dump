...
public class LabyScreenRenderer extends fty implements FileDropHandler, LabyScreenAccessor
{
    ...
    public void a(@NotNull final fns graphics, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(final fns graphics, final int mouseX, final int mouseY, final float tickDelta) {
        final Stack stack = ((VanillaStackAccessor)graphics.c()).stack();
    ...
    public void a(@NotNull final fmg mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
