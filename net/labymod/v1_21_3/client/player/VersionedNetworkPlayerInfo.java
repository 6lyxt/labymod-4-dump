...
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo
{
    ...
    public VersionedNetworkPlayerInfo(final gfw wrapped) {
    ...
    public Component displayName() {
        final xv displayName = this.wrapped.i();
        if (displayName == null) {
    ...
    private xv decorateComponent(@NotNull final gfw info, final yj mutableComponent) {
        return (xv)((info.e() == dhf.d) ? mutableComponent.a(n.u) : mutableComponent);
    }
