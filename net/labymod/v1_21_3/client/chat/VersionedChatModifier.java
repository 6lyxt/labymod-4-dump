...
public class VersionedChatModifier implements InternalChatModifier
{
    ...
    public void deleteMessage(final ChatMessage message) {
        final VersionedChatComponent accessor = (VersionedChatComponent)fmg.Q().m.d();
    ...
    public void editMessage(final ChatMessage message, final Component component) {
        ...
        final flz prevMessage = accessor.getMessages().get(index);
        final xv mapped = (xv)new VersionedChatMessageComponent(message, (xv)this.componentMapper.toMinecraftComponent(component));
        accessor.getMessages().set(index, new flz(prevMessage.b(), mapped, prevMessage.d(), prevMessage.e()));
        final Predicate<flz.a> predicate = this.formattedFilter(message);
        int first = -1;
    ...
    private Predicate<flz> messageFilter(final ChatMessage message) {
    ...
    private Predicate<flz.a> formattedFilter(final ChatMessage message) {
