...
package net.labymod.v1_21_3.client.overlay;
...
public class CustomLoadingOverlay extends fto
{
    private final fmg minecraft;
    private final avr reload;
    private final Consumer<Optional<Throwable>> onFinish;
    private final AbstractBootLogoRenderer loadingRenderer;
    private final DynamicBackgroundController caveRenderer;
    
    public CustomLoadingOverlay(final fmg minecraft, final avr reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final fns gui, final int mouseX, final int mouseY, final float partialTicks) {
        final ffv window = this.minecraft.aO();
