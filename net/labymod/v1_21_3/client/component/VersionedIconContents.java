...
public class VersionedIconContents implements xw
{
    ...
    private static final xw.a<VersionedIconContents> TYPE;
    private Icon icon;
    private int width;
    private int height;
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final ya.a<T> consumer) {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final ya.b<T> consumer, @NotNull final ys style) {
    ...
    static {
        ...
        TYPE = new xw.a((MapCodec)VersionedIconContents.CODEC, "icon");
    }
}
