...
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, xw> implements TextComponent
{
    ...
    public VersionedTextComponent(final yj holder, final boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    public String getText() {
        ...
        if (contents instanceof final zc.a literal) {
            return literal.b();
        }
    ...
    public TextComponent text(final String text) {
        if (this.empty) {
            ((MutableComponentAccessor)this.holder).setContents((xw)new zc.a(text));
            this.empty = false;
            return this;
        }
