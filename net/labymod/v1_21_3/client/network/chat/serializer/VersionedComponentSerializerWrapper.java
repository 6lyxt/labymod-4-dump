...
{
    private final xv.b serializerAdapter;
    
    public VersionedComponentSerializerWrapper() {
        this.serializerAdapter = new xv.b((js.a)ke.b);
    }
    ...
    public JsonElement serialize(final Component src, final Type typeOfSrc, final JsonSerializationContext context) {
        final yj holder = ((VersionedBaseComponent)src).getHolder();
        return this.serializerAdapter.a((xv)holder, typeOfSrc, context);
    }
}
