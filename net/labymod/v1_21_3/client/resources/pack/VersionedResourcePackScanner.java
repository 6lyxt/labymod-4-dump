...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner
{
    ...
    private boolean isExternalPack(final aug pack) {
    ...
    private IncompatibleResourcePack scanPack(final aug pack) {
    ...
    private void scanPack(final aug pack, final String baseDirectory, final aug.a output) {
        pack.a(aui.a, "minecraft", baseDirectory, output);
    }
    
    private Collection<String> collectIgnoredFiles(final aug pack) {
        final Set<String> ignoredFiles = new HashSet<String>();
        for (final String namespace : pack.a(aui.a)) {
            final avn<InputStream> resource = (avn<InputStream>)pack.a(aui.a, alz.a(namespace, "labymod/ignored_files.json"));
            if (resource == null) {
                continue;
            }
