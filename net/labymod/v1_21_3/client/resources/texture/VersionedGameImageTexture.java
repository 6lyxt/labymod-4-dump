...
public class VersionedGameImageTexture extends hbe implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((alz)location.getMinecraftLocation());
    ...
    public void a(final avv resourceManager) {
        this.prepareImage();
    }
