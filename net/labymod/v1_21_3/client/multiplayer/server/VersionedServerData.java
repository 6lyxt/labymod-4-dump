...
public class VersionedServerData extends gfz
{
    ...
    public void a(@NotNull final gfz.a packStatus) {
        super.a(packStatus);
    ...
    public static gfz.a of(final ServerResourcePackStatus resourcePackStatus) {
        return switch (resourcePackStatus) {
            case ENABLED -> gfz.a.a;
            case DISABLED -> gfz.a.b;
            default -> gfz.a.c;
        };
    }
    
    public static ServerResourcePackStatus of(final gfz.a resourceMode) {
