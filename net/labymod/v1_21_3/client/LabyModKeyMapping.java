...
public class LabyModKeyMapping extends fme
{
    private static final Function<Hotkey, fme> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? ffn.b.c : ffn.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static fme create(final Hotkey hotkey) {
    ...
    public ffn.a i() {
        ...
        final ffn.b type = (key instanceof MouseButton) ? ffn.b.c : ffn.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final ffn.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == ffn.b.a || key.a() == ffn.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
