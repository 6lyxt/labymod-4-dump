...
public class WatchableActivePotionMap implements WatchableMap<jq<bun>, bup>
{
    ...
    public WatchableActivePotionMap(final Map<jq<bun>, PotionEffect> activePotions) {
        this.activePotions = activePotions;
    }
    
    @Override
    public void onPut(final jq<bun> key, final bup value) {
    ...
    @Override
    public void onRemove(final jq<bun> key) {
        this.activePotions.remove(key);
    }
    
    @Override
    public void onRemove(final jq<bun> key, final bup value) {
