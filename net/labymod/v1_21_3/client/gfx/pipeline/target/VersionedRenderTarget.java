...
package net.labymod.v1_21_3.client.gfx.pipeline.target;
...
{
    private final ffc renderTarget;
    
    public VersionedRenderTarget(final ffc renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final ffc renderTarget2 = this.renderTarget;
        Objects.requireNonNull(renderTarget2);
        attachments.add(ColorRenderTargetAttachment.create(index, renderTarget2::g));
        final List<RenderTargetAttachment> attachments2 = this.attachments;
        final ffc renderTarget3 = this.renderTarget;
        Objects.requireNonNull(renderTarget3);
        attachments2.add(new CustomDepthRenderTargetAttachment(renderTarget3::h));
    }
