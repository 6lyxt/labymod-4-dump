...
import net.labymod.v1_21_3.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, glv> RENDER_TYPE_FUNCTION;
    private final fgu tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private fgw consumer;
    private fgn bufferBuilder;
    @Deprecated
    private gll.a bufferSource;
    private RenderPhase renderPhase;
    private glv renderType;
    private OldVertexFormat currentFormat;
    private fgr meshData;
    
    public VersionedBufferBuilder() {
        this.tesselator = fgu.b();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final fgn builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder = this.tesselator.a(LabyModRenderType.getMode(mode), (fgx)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final gll multiBufferSource) {
    ...
    public void uploadToBuffer() {
        ...
        final fgr meshData = this.bufferBuilder.a();
        if (meshData == null) {
            return;
        }
    ...
    public boolean building() {
        ...
        final fgw consumer = this.consumer;
        if (consumer instanceof final fgn bufferBuilder) {
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder = this.tesselator.a(LabyModRenderType.getMode(phase.getMode()), (fgx)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public fgn getBufferBuilder() {
        return this.bufferBuilder;
    }
    
    public fgr renderedBuffer() {
