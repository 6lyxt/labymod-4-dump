...
public abstract class MixinResourceLocation implements ResourceLocation
{
    ...
    public InputStream openStream() throws IOException {
        ...
        return ffh.Q().ab().getResource((alf)this.getMinecraftLocation()).orElseThrow(IOException::new).d();
    }
    
    @Override
    public boolean exists() {
        return ResourcesUtil.hasResource(this.getMinecraftLocation()) || ffh.Q().ab().getResource((alf)this.getMinecraftLocation()).isPresent();
    }
