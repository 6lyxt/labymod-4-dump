...
public abstract class MixinMobEffectInstance implements PotionEffect
{
    ...
    public String getTranslationKey() {
        final Component component = Laby.labyAPI().minecraft().componentMapper().fromMinecraftComponent(((bsc)this.g.a()).e());
    ...
    @Override
    public Icon getIcon() {
        final gpb sprite = this.labyMod$cacheIcon();
        if (sprite == null) {
            return null;
        }
    ...
    public void renderIcon(final Stack stack, final int x, final int y, final int width, final int height) {
        ...
        ((GuiGraphicsAccessor)this.labyMod$graphics).setPose((faa)poseStackObject);
    ...
    private gpb labyMod$cacheIcon() {
        ...
        return this.labyMod$iconSprite = ffh.Q().aF().a((ji)this.g);
    }
}
