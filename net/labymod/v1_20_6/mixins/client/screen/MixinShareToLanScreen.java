...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final gtg server, final fhg button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final gtg server, final fhg button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
