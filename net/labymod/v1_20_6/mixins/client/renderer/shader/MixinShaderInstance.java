...
package net.labymod.v1_20_6.mixins.client.renderer.shader;
...
import net.labymod.v1_20_6.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final ezq shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (gee)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final ezq shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (gee)this);
    }
