...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final fnf instance, final fgt graphics, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
