...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final gdm renderer, final btr livingEntity, final cur itemStack, final cuo type, final boolean leftHand, final faa poseStack, final gdq bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final btr livingEntity, final cur itemStack, final cuo type, final boolean leftHand, final int combinedLight) {
