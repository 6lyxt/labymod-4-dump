...
import net.labymod.v1_20_6.client.gui.WrappedIntRangeBase;
import net.labymod.api.util.StringUtil;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Shadow;
import org.jetbrains.annotations.Nullable;
import org.spongepowered.asm.mixin.Mixin;
import net.labymod.v1_20_6.mixins.client.gui.components.MixinAbstractSliderButton;

@Mixin({ ffk.i.class })
public abstract class MixinOptionInstanceSliderButton<T> extends MixinAbstractSliderButton
{
    @Nullable
    private ffk.g labyMod$wrappedIntRangeBase;
    @Shadow
    @Final
    private ffk.k<T> e;
    ...
    private ffk.g labyMod$createWrappedIntRangeBase() {
        ...
        if (ffk.g.class.isAssignableFrom(cls)) {
            return (ffk.g)new WrappedIntRangeBase((ffk.g)this.e);
        }
        return null;
    }
}
