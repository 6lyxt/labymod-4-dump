...
public abstract class MixinMouseHandler implements MouseHandlerAccessor
{
    ...
    private void redirectPlayerRotation(final gcs player, final double x, final double y) {
    ...
    public void grabMouseNative() {
        eyv.a(this.a.aO().i(), 212995, this.a.aO().m() / 2.0, this.a.aO().n() / 2.0);
    }
    
    @Override
    public void ungrabMouseNative() {
        eyv.a(this.a.aO().i(), 212993, this.a.aO().m() / 2.0, this.a.aO().n() / 2.0);
    }
    
    @Redirect(method = { "onScroll" }, at = @At(value = "FIELD", ordinal = 5, target = "Lnet/minecraft/client/MouseHandler;accumulatedScrollY:D"))
    private double labyMod$fireHotbarSlotChangeEvent(final ffi instance) {
        final double delta = this.q;
        if (delta == 0.0) {
            return 0.0;
        }
        final gcs player = this.a.s;
