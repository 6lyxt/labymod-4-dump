...
package net.labymod.v1_20_6.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_20_6.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final btc<? extends cid> type, final dca level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final cib part : this.ck) {
