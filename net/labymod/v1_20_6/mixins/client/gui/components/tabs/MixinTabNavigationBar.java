...
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fja implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor
{
    ...
    private final Map<fji, VersionedTab> versionedTabs;
    @Shadow
    @Final
    ...
    public MixinTabNavigationBar() {
        ...
        this.versionedTabs = new HashMap<fji, VersionedTab>();
    }
    ...
    public VersionedTab versionedTabOf(final fji tab) {
