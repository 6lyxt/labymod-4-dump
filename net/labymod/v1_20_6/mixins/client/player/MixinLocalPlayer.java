...
public abstract class MixinLocalPlayer extends MixinAbstractLocalPlayer implements ClientPlayer
{
    ...
    @Shadow
    public abstract void a(final bqv p0);
    ...
    public boolean isUsingBow() {
        return this.labyMod$getClientPlayer().fx().g() == cuu.ou;
    }
    ...
    public void swingArm(final LivingEntity.Hand hand, final boolean cancelPacket) {
        final bqv interactionHand = (hand == LivingEntity.Hand.MAIN_HAND) ? bqv.a : bqv.b;
    ...
    private void labyMod$cancelHandSwingPacket(final bqv hand, final InsertInfo ci) {
    ...
    private gcs labyMod$getClientPlayer() {
        return (gcs)this;
    }
}
