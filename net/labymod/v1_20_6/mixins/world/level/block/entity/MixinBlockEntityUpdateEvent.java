...
public class MixinBlockEntityUpdateEvent
{
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final dca level, final iz pos, final dse state, final InsertInfo ci) {
        final dpj blockEntity = level.c_(pos);
