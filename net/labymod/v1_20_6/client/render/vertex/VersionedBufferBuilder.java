...
import net.labymod.v1_20_6.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, gdy> RENDER_TYPE_FUNCTION;
    private final fac tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private fae consumer;
    private ezv bufferBuilder;
    @Deprecated
    private gdq.a bufferSource;
    private RenderPhase renderPhase;
    private gdy renderType;
    private OldVertexFormat currentFormat;
    private ezv.b renderedBuffer;
    
    public VersionedBufferBuilder() {
        this.tesselator = fac.b();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final ezv builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (faf)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final gdq multiBufferSource) {
    ...
    public void uploadToBuffer() {
        ...
        this.renderType.a(this.bufferBuilder, fai.a);
    }
    ...
    public boolean building() {
        ...
        final fae consumer = this.consumer;
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (faf)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public ezv getBufferBuilder() {
        return this.bufferBuilder;
    }
    
    public ezv.b renderedBuffer() {
