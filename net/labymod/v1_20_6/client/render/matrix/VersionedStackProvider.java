...
{
    public VersionedStackProvider(final faa poseStack) {
    ...
    public void rotate(final float angle, final float x, final float y, final float z) {
        ...
        ((faa)this.stack).a((Quaternionf)VersionedStackProvider.MAPPER.toQuaternion(VersionedStackProvider.ROTATION_VECTOR.rotationDegrees(angle)));
    }
    
    @Override
    public void rotateRadians(final float radians, final float x, final float y, final float z) {
        VersionedStackProvider.ROTATION_VECTOR.set(x, y, z);
        ((faa)this.stack).a((Quaternionf)VersionedStackProvider.MAPPER.toQuaternion(VersionedStackProvider.ROTATION_VECTOR.rotation(radians)));
    }
    ...
    public void multiply(final FloatMatrix4 matrix) {
        ((faa)this.stack).a((Matrix4f)VersionedStackProvider.MAPPER.toMatrix4f(matrix));
    }
