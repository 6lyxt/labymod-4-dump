...
{
    public static ezb read(final ByteBuffer buffer) throws IOException {
        return ezb.a(buffer);
    }
    
    public static ezb read(final InputStream inputStream) throws IOException {
        return ezb.a(inputStream);
    }
    
    public static ezb asNativeImage(final BufferedImage image) {
        return asNativeImage(image, NativeImageUtils::processImage);
    }
    
    public static ezb asNativeImage(final BufferedImage image, final BufferedImageProcessor processor) {
        final ezb result = new ezb(image.getWidth(), image.getHeight(), true);
    ...
    public static void fillSubImage(final ezb source, final ezb destination, final int parentX, final int parentY, final int width, final int height) {
    ...
    public static BufferedImage asBufferedImage(final ezb image) {
