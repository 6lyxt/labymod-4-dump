...
public class LabyScreenRenderer extends fnf implements FileDropHandler, LabyScreenAccessor
{
    ...
    public void a(@NotNull final fgt graphics, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(final fgt graphics, final int mouseX, final int mouseY, final float tickDelta) {
        final Stack stack = ((VanillaStackAccessor)graphics.c()).stack();
    ...
    public void a(@NotNull final ffh mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
