...
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<fjk, AbstractWidget<?>>
{
    ...
    @Override
    public void update(final fjk source, final AbstractWidget<?> destination) {
        final TabNavigationBarAccessor accessor = (TabNavigationBarAccessor)source;
        final fjj tabManager = accessor.getTabManager();
