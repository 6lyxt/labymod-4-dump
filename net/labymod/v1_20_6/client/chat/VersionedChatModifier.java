...
public class VersionedChatModifier implements InternalChatModifier
{
    ...
    public void deleteMessage(final ChatMessage message) {
        final VersionedChatComponent accessor = (VersionedChatComponent)ffh.Q().l.d();
    ...
    public void editMessage(final ChatMessage message, final Component component) {
        ...
        final ffb prevMessage = accessor.getMessages().get(index);
        final xp mapped = (xp)new VersionedChatMessageComponent(message, (xp)this.componentMapper.toMinecraftComponent(component));
        accessor.getMessages().set(index, new ffb(prevMessage.b(), mapped, prevMessage.d(), prevMessage.e()));
        final Predicate<ffb.a> predicate = this.formattedFilter(message);
        int first = -1;
    ...
    private Predicate<ffb> messageFilter(final ChatMessage message) {
    ...
    private Predicate<ffb.a> formattedFilter(final ChatMessage message) {
