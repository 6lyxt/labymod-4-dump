...
public class VersionedScoreComponent extends VersionedBaseComponent<ScoreComponent, xq> implements ScoreComponent
{
    ...
    public Component value() {
        ...
        if (level != null) {
            final ewx scoreboard = level.M();
            final ewp objective = scoreboard.a(this.getObjective());
            if (objective != null) {
                final String name = this.getName();
                final eww scoreHolder = eww.c(name);
                final ewt scoreInfo = scoreboard.d(scoreHolder, objective);
                if (scoreInfo != null) {
