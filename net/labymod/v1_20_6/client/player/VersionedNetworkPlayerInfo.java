...
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo
{
    ...
    public VersionedNetworkPlayerInfo(final fyi wrapped) {
    ...
    private xp decorateComponent(@NotNull final fyi info, final yd mutableComponent) {
        return (xp)((info.e() == dbx.d) ? mutableComponent.a(n.u) : mutableComponent);
    }
