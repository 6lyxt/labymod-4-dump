...
public class LabyModRenderType extends gdy
{
    private final RenderPhase phase;
    
    public LabyModRenderType(final RenderPhase phase) {
        final String name = phase.getName();
        final faf faf = phase.getVertexFormat().getMojangVertexFormat();
        final faf.b mode = getMode(phase.getMode());
        ...
        Objects.requireNonNull(phase);
        super(name, faf, mode, bufferSize, affectsCrumbling, sortOnUpload, runnable, phase::clear);
        this.phase = phase;
    }
    ...
    public static faf.b getMode(final int mode) {
        return switch (mode) {
            case 0,  4,  7 -> faf.b.h;
            case 1 -> faf.b.a;
            case 3 -> faf.b.d;
