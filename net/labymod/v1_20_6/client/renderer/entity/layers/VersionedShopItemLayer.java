...
package net.labymod.v1_20_6.client.renderer.entity.layers;
...
public class VersionedShopItemLayer extends gnl<gcp, fvh<gcp>>
{
    private final fvh<gcp> playerModel;
    
    public VersionedShopItemLayer(final gkv<gcp, fvh<gcp>> layerParent) {
        super((gkv)layerParent);
        this.playerModel = (fvh<gcp>)layerParent.a();
    }
    
    public void render(@NotNull final faa poseStack, @NotNull final gdq bufferSource, final int packedLight, @NotNull final gcp player, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch) {
