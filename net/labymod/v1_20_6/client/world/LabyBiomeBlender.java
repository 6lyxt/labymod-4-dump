...
public class LabyBiomeBlender implements dbd
{
    ...
    public LabyBiomeBlender setLevel(final dca level) {
        this.level = level;
        return this;
    }
    ...
    @Nullable
    public dpj c_(@NotNull final iz blockPos) {
        return this.level.c_(blockPos);
    }
    
    @NotNull
    public dse a_(@NotNull final iz blockPos) {
        return this.level.a_(blockPos);
    }
    
    @NotNull
    public enx b_(@NotNull final iz blockPos) {
    ...
    public int a(@NotNull final iz blockPos, @NotNull final dbl resolver) {
    ...
    private int processZAxis(final int x, final int y, final int z, final iz.a currentPos, final dbl resolver, int total, final int[] rgb, final int xIndex) {
    ...
    private int blendColors(final iz.a currentPos, final dbl resolver, int total, final int[] rgb) {
        final ji<dcz> holder = (ji<dcz>)this.level.t((iz)currentPos);
        final dcz biome = (holder == null) ? null : ((dcz)holder.a());
        if (biome != null) {
