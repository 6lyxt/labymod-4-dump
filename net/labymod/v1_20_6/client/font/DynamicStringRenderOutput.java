...
public class DynamicStringRenderOutput extends fgr.b
{
    public DynamicStringRenderOutput(final fgr font, final gdq bufferSource, final float x, final float y, final int color, final boolean shadow, final Matrix4f modelViewMatrix, final fgr.a displayMode, final int packedLightCoords) {
