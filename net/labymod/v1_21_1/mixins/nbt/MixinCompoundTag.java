...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    ...
    @Shadow
    public abstract uy a(final String p0, final uy p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract uy shadow$c(final String p0);
    ...
    @Shadow
    public abstract ub shadow$p(final String p0);
    
    @Shadow
    public abstract uh c(final String p0, final int p1);
