...
package net.labymod.v1_21_1.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_21_1.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final bsx<? extends cia> type, final dcw level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final chy part : this.co) {
