...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final fhz param0, final fhx param1, final wz param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final fzt serverData, final InsertInfo ci) {
