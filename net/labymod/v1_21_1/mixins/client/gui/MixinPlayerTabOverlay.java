...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final fhz graphics, final int screenWidth, final eyg scoreboard, final exy objective, final InsertInfo ci) {
