...
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fkg implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor
{
    ...
    private final Map<fko, VersionedTab> versionedTabs;
    @Shadow
    @Final
    ...
    public MixinTabNavigationBar() {
        ...
        this.versionedTabs = new HashMap<fko, VersionedTab>();
    }
    ...
    public VersionedTab versionedTabOf(final fko tab) {
        return this.versionedTabs.computeIfAbsent(tab, VersionedTab::new);
    }
    
    @Insert(method = { "render" }, at = @At("HEAD"), cancellable = true)
    public void render(final fhz graphics, final int mouseX, final int mouseY, final float partialTicks, final InsertInfo ci) {
        final fko tab = this.h.a();
