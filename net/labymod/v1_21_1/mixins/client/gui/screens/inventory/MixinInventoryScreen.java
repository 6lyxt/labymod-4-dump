...
public abstract class MixinInventoryScreen extends fpl<cqw>
{
    ...
    public MixinInventoryScreen(final cqw param0, final cmw param1, final wz param2) {
        super((cpu)param0, param1, param2);
    }
    ...
    private void labyMod$init(final InsertInfo info) {
        ...
        for (final crq slot : ((cqw)this.D()).i) {
    ...
    private void labyMod$setOldSurvivalLayoutTexture(final fhz graphics, akr location, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5, final int $$6) {
