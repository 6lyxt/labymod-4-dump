...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final fod instance, final fhz graphics, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
