...
package net.labymod.v1_21_1.mixins.client.renderer.shader;
...
import net.labymod.v1_21_1.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final fay shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (gfn)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final fay shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (gfn)this);
    }
