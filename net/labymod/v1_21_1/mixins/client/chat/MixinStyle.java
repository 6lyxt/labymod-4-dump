...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract xw a(@Nullable final xf p0);
    ...
    @Shadow
    public abstract xw a(@org.jetbrains.annotations.Nullable final wx p0);
    
    @Shadow
    public abstract xw a(@org.jetbrains.annotations.Nullable final xy p0);
    ...
    @Shadow
    public abstract xw a(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract xw b(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract xw c(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract xw d(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract xw e(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract akr shadow$k();
    
    @Shadow
    public abstract xw a(@org.jetbrains.annotations.Nullable final akr p0);
    
    @Shadow
    public abstract xw a(@org.jetbrains.annotations.Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((xf)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((wx)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final akr resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, xw> setter) {
