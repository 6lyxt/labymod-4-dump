...
public class VersionedChatModifier implements InternalChatModifier
{
    ...
    public void deleteMessage(final ChatMessage message) {
        final VersionedChatComponent accessor = (VersionedChatComponent)fgo.Q().l.d();
    ...
    public void editMessage(final ChatMessage message, final Component component) {
        ...
        final fgi prevMessage = accessor.getMessages().get(index);
        final wz mapped = (wz)new VersionedChatMessageComponent(message, (wz)this.componentMapper.toMinecraftComponent(component));
        accessor.getMessages().set(index, new fgi(prevMessage.b(), mapped, prevMessage.d(), prevMessage.e()));
        final Predicate<fgi.a> predicate = this.formattedFilter(message);
        int first = -1;
    ...
    private Predicate<fgi> messageFilter(final ChatMessage message) {
    ...
    private Predicate<fgi.a> formattedFilter(final ChatMessage message) {
