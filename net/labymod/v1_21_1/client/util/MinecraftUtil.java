...
public final class MinecraftUtil
{
    ...
    private static final fbi VIEW_MATRIX_STACK;
    ...
    public static Stack obtainStackFromGraphics(final fhz graphics) {
        return ((VanillaStackAccessor)graphics.c()).stack();
    }
    
    public static ItemStack fromMinecraftSlot(final btn entity, final LivingEntity.EquipmentSpot spot) {
    ...
    public static Direction fromMinecraft(final ji direction) {
    ...
    public static ji toMinecraft(@NotNull final Direction direction) {
        return switch (direction) {
            default -> throw new MatchException(null, null);
            case DOWN -> ji.a;
            case UP -> ji.b;
    ...
    public static bsy toMinecraft(final LivingEntity.EquipmentSpot spot) {
        return switch (spot) {
            default -> throw new MatchException(null, null);
            case HEAD -> bsy.f;
            case CHEST -> bsy.e;
    ...
    public static ServerType fromMinecraft(final fzt data) {
        if (data.e()) {
    ...
    public static fzt.c toMinecraft(final ServerType type) {
        return switch (type) {
            default -> throw new MatchException(null, null);
            case LAN -> fzt.c.a;
            case REALM -> fzt.c.b;
            case THIRD_PARTY -> fzt.c.c;
        };
    }
    
    public static ServerType fromMinecraft(final fzt.c type) {
        return switch (type) {
            default -> throw new MatchException(null, null);
    ...
    public static void exportScreenshotToFile(final faj image, final File file) throws IOException {
    ...
    public static PlayerModel obtainPlayerModel(final Player player) {
        final gkh dispatcher = fgo.Q().ap();
        final gki entityRenderer = dispatcher.a((bsr)player);
        if (entityRenderer instanceof final gpo playerRenderer) {
            return (PlayerModel)playerRenderer.a();
        }
        throw new IllegalStateException("Renderer for the player could not be found");
    }
    
    public static TextDrawMode fromMinecraft(final fhx.a displayMode) {
    ...
    public static fhx.a toMinecraft(final TextDrawMode textDrawMode) {
        return switch (textDrawMode) {
            default -> throw new MatchException(null, null);
            case NORMAL -> fhx.a.a;
            case SEE_THROUGH -> fhx.a.b;
            case POLYGON_OFFSET -> fhx.a.c;
        };
    }
    
    public static CookieStorage fromMinecraft(final fzy state) {
        return (state == null) ? null : new VersionedCookieStorage(state);
    }
    
    public static fzy toMinecraft(final CookieStorage storage) {
        final Map<ResourceLocation, byte[]> apiCookies = storage.cookies();
        final Map<akr, byte[]> cookies = new HashMap<akr, byte[]>(apiCookies.size());
        ...
        return new fzy((Map)cookies);
    }
    
    public static aya fromText(final String text, final Style style) {
        final tw language = tw.a();
    ...
    public static class LevelRenderContext
    {
        ...
        public void setPoseStack(final fbi poseStack) {
