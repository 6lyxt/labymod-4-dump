...
public class VersionedGameImageTexture extends gqe implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((akr)location.getMinecraftLocation());
    ...
    public void a(final aue resourceManager) {
        this.prepareImage();
    }
