...
package net.labymod.v1_21_1.client.gfx.pipeline.target;
...
{
    private final ezv renderTarget;
    
    public VersionedRenderTarget(final ezv renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final ezv renderTarget2 = this.renderTarget;
        ...
        final ezv renderTarget3 = this.renderTarget;
