...
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.ShaderProgramStateStorage;
import net.labymod.api.thirdparty.optifine.OptiFine;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.TextureStateStorage;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.FogStateStorage;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.StencilStateStorage;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.ColorLogicStateStorage;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.PolygonOffsetStateStorage;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.ScissorStateStorage;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.CullStateStorage;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.DepthStateStorage;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.ColorMaskStateStorage;
import net.labymod.core.client.gfx.pipeline.state.StateStorage;
import com.mojang.blaze3d.platform.GlStateManager;
import net.labymod.v1_21_1.generated.client.gfx.pipeline.state.BlendStateStorage;
...
public final class VersionedBlaze3DGlStatePipeline extends AbstractBlaze3DGlStatePipeline implements Blaze3DGlStatePipeline
{
    ...
    public void clear(final AttributeMask... bits) {
        ...
        GlStateManager._clear(mask, fgo.a);
    }
