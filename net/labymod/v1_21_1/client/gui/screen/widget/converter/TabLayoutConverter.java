...
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<fkq, AbstractWidget<?>>
{
    ...
    @Override
    public void update(final fkq source, final AbstractWidget<?> destination) {
        final TabNavigationBarAccessor accessor = (TabNavigationBarAccessor)source;
        final fkp tabManager = accessor.getTabManager();
