...
public class VersionedIconContents implements xa
{
    ...
    private static final xa.a<VersionedIconContents> TYPE;
    private Icon icon;
    private int width;
    private int height;
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final xe.a<T> consumer) {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final xe.b<T> consumer, @NotNull final xw style) {
    ...
    static {
        ...
        TYPE = new xa.a((MapCodec)VersionedIconContents.CODEC, "icon");
    }
}
