...
public class VersionedScoreComponent extends VersionedBaseComponent<ScoreComponent, xa> implements ScoreComponent
{
    public VersionedScoreComponent(final xn holder) {
        super(holder);
    }
    ...
    public String getName() {
        ...
        if (contents instanceof final yh score) {
            return score.b();
        }
    ...
    public Component value() {
        ...
        if (level != null) {
            final eyg scoreboard = level.M();
            final exy objective = scoreboard.a(this.getObjective());
            if (objective != null) {
                final String name = this.getName();
                final eyf scoreHolder = eyf.c(name);
                final eyc scoreInfo = scoreboard.d(scoreHolder, objective);
                if (scoreInfo != null) {
                    return (Component)scoreInfo.a(objective.a((yp)ys.b));
                }
            }
        }
