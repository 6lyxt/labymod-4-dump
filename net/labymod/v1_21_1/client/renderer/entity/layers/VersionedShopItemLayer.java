...
public class VersionedShopItemLayer extends gov<gdy, fwp<gdy>>
{
    ...
    public VersionedShopItemLayer(final gmf<gdy, fwp<gdy>> layerParent) {
        super((gmf)layerParent);
        this.playerModel = (fwp<gdy>)layerParent.a();
    }
    
    public void render(@NotNull final fbi poseStack, @NotNull final gez bufferSource, final int packedLight, @NotNull final gdy player, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch) {
