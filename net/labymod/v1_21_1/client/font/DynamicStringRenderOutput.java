...
public class DynamicStringRenderOutput extends fhx.b
{
    public DynamicStringRenderOutput(final fhx font, final gez bufferSource, final float x, final float y, final int color, final boolean shadow, final Matrix4f modelViewMatrix, final fhx.a displayMode, final int packedLightCoords) {
