...
public class VersionedGameImageTexture extends ejy implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((vk)location.getMinecraftLocation());
    ...
    private void prepareImage() {
        if (this.gameImage != null && this.image == null) {
            this.image = ((NativeGameImage)this.gameImage).getNativeImage();
            this.uploadImage();
            return;
        }
        if (this.image == null) {
    ...
    private void _upload() {
        ...
        dex.a(this.b(), 0, this.image.a(), this.image.b());
        this.image.a(0, 0, 0, false);
    }
    
    public void a(final ach resourceManager) {
        this.prepareImage();
    }
