...
{
    private static final Function<Hotkey, djw> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? deo.b.c : deo.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static djw create(final Hotkey hotkey) {
    ...
    public deo.a h() {
        ...
        final deo.b type = (key instanceof MouseButton) ? deo.b.c : deo.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final deo.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == deo.b.a || key.a() == deo.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
