...
package net.labymod.v1_16_5.client.font.text;
...
public class VersionedStringFormatter implements StringFormatter
{
    ...
    public VisualCharSequence getVisualOrder(final String text, final Style style) {
        final afa formattedText = MinecraftUtil.fromText(text, style);
        final VisualCharSequence visualCharSequence = new VisualCharSequence(consumer -> formattedText.accept((position, textStyle, codePoint) -> consumer.acceptGlyph(position, (Style)textStyle, codePoint)));
        visualCharSequence.setFormattedCharSequence(formattedText);
        return visualCharSequence;
    }
