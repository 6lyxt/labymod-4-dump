...
import net.labymod.v1_16_5.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (dfr)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final eag multiBufferSource) {
                if (multiBufferSource instanceof final eag.a a) {
                    this.bufferSource = a;
                }
    ...
    public boolean building() {
        ...
        if (this.consumer instanceof final dfh bufferBuilder) {
    ...
    private void endLastBatch() {
        ...
        ((BufferSourceAccessor)this.bufferSource).endLastBatch();
    }
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (dfr)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public dfh getBufferBuilder() {
