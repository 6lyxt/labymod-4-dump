...
public class VersionedScreenWrapper implements ScreenWrapper
{
    ...
    public VersionedScreenWrapper(final dot screen) {
        if (screen == null) {
    ...
    public void render(final Stack stack, final MutableMouse mouse, final float partialTicks) {
        this.screen.a((dfm)stack.getProvider().getPoseStack(), mouse.getX(), mouse.getY(), partialTicks);
    }
    ...
    public void render(final ScreenContext context) {
        ...
        final dfm poseStack = (dfm)context.stack().getProvider().getPoseStack();
