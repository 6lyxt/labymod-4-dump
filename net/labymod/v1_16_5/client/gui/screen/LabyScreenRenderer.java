...
public class LabyScreenRenderer extends dot implements FileDropHandler, LabyScreenAccessor
{
    ...
    public void a(@NotNull final dfm poseStack, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void a(final dfm poseStack) {
        final Stack stack = ((VanillaStackAccessor)poseStack).stack();
    ...
    public void a(@NotNull final djz mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
