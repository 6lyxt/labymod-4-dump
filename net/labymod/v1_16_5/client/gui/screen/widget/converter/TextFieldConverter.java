...
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<dlq, TextFieldWidget>
{
    ...
    @Override
    public TextFieldWidget createDefault(final dlq source) {
        ...
        destination.maximalLength(source.q());
        destination.setActive(source.o);
        destination.setCursorIndex(source.n());
    ...
    @Override
    public void update(final dlq source, final TextFieldWidget destination) {
