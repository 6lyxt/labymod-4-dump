...
public final class MojangServices
{
    ...
    public static SocialInteractionsService createSocialInteractions(final MinecraftSessionService service, final dkm user) {
    ...
    public static SocialInteractionsService createSocialInteractions(final YggdrasilAuthenticationService service, final dkm user) {
        try {
