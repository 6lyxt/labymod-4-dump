...
public final class BlendStateStorage implements StateStorage<dem.b>
{
    ...
    @Override
    public void store(final dem.b state) {
    ...
    public void restore() {
        ...
        dem.b(this.sourceRGB, this.destinationRGB, this.sourceAlpha, this.destinationAlpha);
    }
