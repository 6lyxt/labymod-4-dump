...
public abstract class MixinListTag implements NBTTagList
{
    ...
    @Shadow
    public abstract boolean b(final int p0, final mt p1);
    
    @Shadow
    public abstract boolean a(final int p0, final mt p1);
    
    @Shadow
    public abstract void c(final int p0, final mt p1);
    
    @Shadow
    public abstract mt shadow$c(final int p0);
    ...
    public NBTTagType contentType() {
        return (this.h != 0 || this.isEmpty()) ? NBTTagType.getById(this.h) : null;
    }
}
