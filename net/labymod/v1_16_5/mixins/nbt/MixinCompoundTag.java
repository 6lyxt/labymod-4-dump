...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    ...
    @Shadow
    public abstract mt a(final String p0, final mt p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract mt shadow$c(final String p0);
    
    @Shadow
    public abstract boolean e(final String p0);
    
    @Shadow
    public abstract boolean c(final String p0, final int p1);
    ...
    @Shadow
    public abstract void b(final String p0, final int p1);
    ...
    @Shadow
    public abstract md shadow$p(final String p0);
    
    @Shadow
    public abstract mj d(final String p0, final int p1);
    ...
    public Map<String, NBTTag<?>> value() {
        return (Map<String, NBTTag<?>>)this.i;
    }
    ...
    public <I, T extends NBTTag<I>> NBTTagList<I, T> getList(@NotNull final String key, @NotNull final NBTTagType contentType) {
        return (NBTTagList)this.d(key, contentType.getId());
    }
