...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<abu>> cir) {
        final List<abu> selectedPacks = (List<abu>)cir.getReturnValue();
