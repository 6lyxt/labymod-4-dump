...
public abstract class MixinAbstractSelectionList
{
    ...
    public void labyMod$renderBackground(final dfm stack, final int param1, final int param2, final float param3, final InsertInfo ci) {
    ...
    public void labyMod$renderTopAndBottom(final dfm stack, final int param1, final int param2, final float param3, final InsertInfo ci) {
        final Theme theme = Laby.labyAPI().themeService().currentTheme();
        if (!theme.metadata().getBoolean("hide_default_background")) {
    ...
    public void labyMod$renderList(final dlf instance, final dfm stack, final int left, final int top, final int mouseX, final int mouseY, final float partialTicks, final Operation<Void> original) {
