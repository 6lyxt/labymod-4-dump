...
public abstract class MixinAbstractWidget<K extends AbstractWidget<?>> implements ConvertableMinecraftWidget<K>, AbstractWidgetAccessor
{
    ...
    public void render(final dfm stack, final int mouseX, final int mouseY, final float partialTicks, final InsertInfo ci) {
    ...
    private void labyMod$playCustomDownSound(final enu soundManager, final CallbackInfo ci) {
        final K widget = this.labyMod$watcher.getWidget();
