...
public class MixinKeyBindsList
{
    ...
    private djw[] labyMod$addCustomKeybindings(final dkd instance) {
        final List<djw> keyMappings = new ArrayList<djw>(Arrays.asList(instance.aF));
        ...
        return keyMappings.toArray(new djw[0]);
    }
}
