...
public abstract class MixinInventoryScreen extends dqe<biz>
{
    ...
    public MixinInventoryScreen(final biz param0, final bfv param1, final nr param2) {
        super((bic)param0, param1, param2);
    }
    ...
    private void labyMod$init(final InsertInfo info) {
        ...
        for (final bjr slot : ((biz)this.h()).a) {
    ...
    private void labyMod$setOldSurvivalLayoutTexture(final ekd instance, final vk location) {
    ...
    @NotNull
    private bjr getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final bjr slot) {
