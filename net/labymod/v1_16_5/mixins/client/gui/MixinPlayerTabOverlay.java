...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final dfm poseStack, final int screenWidth, final ddn scoreboard, final ddk objective, final InsertInfo ci) {
