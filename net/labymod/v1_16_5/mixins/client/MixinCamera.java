...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final dcn position = this.b();
        this.labymod$cameraPosition.set((float)position.a(gc.a.a), (float)position.a(gc.a.b), (float)position.a(gc.a.c));
    ...
    public DoubleVector3 position() {
        final dcn position = this.b();
        this.labyMod$position.set(position.a(gc.a.a), position.a(gc.a.b), position.a(gc.a.c));
    ...
    public Quaternion rotation() {
        ...
        this.labymod$rotation.multiply(FloatVector3.YP.rotationDegrees(-this.j));
        this.labymod$rotation.multiply(FloatVector3.XP.rotationDegrees(this.i));
