...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final dfm param0, final dku param1, final nr param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final dwz serverData, final InsertInfo ci) {
