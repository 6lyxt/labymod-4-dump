...
public class MixinHumanoidArmorLayer
{
    ...
    private void labyMod$getLivingEntity(final dfm poseStack, final eag bufferSource, final int packedLight, final aqm entity, final float param4, final float param5, final float param6, final float param7, final float param8, final float param9, final InsertInfo info) {
    ...
    private void labyMod$enableOverlayTexture(final dum model, final dfm stack, final dfq consumer, final int packedLight, final int overlayTexture, final float red, final float green, final float blue, final float alpha) {
