...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final dot instance, final dfm poseStack, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
