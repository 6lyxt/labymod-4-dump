...
public class VersionedChatExecutor extends DefaultChatExecutor
{
    ...
    public void chat(final String message, final boolean addToHistory) {
        ((GuiScreenAccessor)this.dummy).setMinecraft(bib.z());
    ...
    public void showTitle(@NotNull final Title title) {
        ...
        if (titleComponent != null) {
            final hh component = (hh)this.componentMapper.toMinecraftComponent(titleComponent);
        ...
        if (subTitleComponent != null) {
            final hh component2 = (hh)this.componentMapper.toMinecraftComponent(subTitleComponent);
    ...
    private void _displayClientMessage(final Component message, final boolean actionBar) {
        if (actionBar) {
            ...
            final biq ingameGui = bib.z().q;
            final hh component = (hh)this.componentMapper.toMinecraftComponent(message);
