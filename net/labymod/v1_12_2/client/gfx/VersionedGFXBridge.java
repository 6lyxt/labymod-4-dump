...
import net.labymod.v1_12_2.client.gfx.pipeline.blaze3d.buffer.VersionedBlaze3DBufferSource;
...
public class VersionedGFXBridge extends LWJGL3GFXBridge
{
    ...
    public void bindResourceLocation(final ResourceLocation location, final boolean blur, final boolean mipmap) {
        ...
        final nf minecraftLocation = location.getMinecraftLocation();
        cds texture = textureManager.b(minecraftLocation);
        if (texture == null) {
