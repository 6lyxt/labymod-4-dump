...
public class VersionedStandardBlaze3DRenderTypes implements StandardBlaze3DRenderTypes
{
    ...
    static {
        ...
        ENTITY_TRANSLUCENT = VersionedStandardBlaze3DRenderTypes.MEMOIZE_STORAGE.memoize(location -> {
            new(net.labymod.v1_12_2.client.gfx.pipeline.blaze3d.program.VersionedBlaze3DRenderType.class)();
            new VersionedRenderProgram("labymod:entity_translucent", DrawingMode.QUADS, cdy.l, Lists.newArrayList(RenderParameters.createTextureParameter(location, false, false), RenderParameters.LEQUAL_DEPTH_TEST, RenderParameters.WRITE_DEPTH, RenderParameters.WRITE_RGBA, RenderParameters.TRANSLUCENT_TRANSPARENCY_BLENDING, RenderParameters.NO_CULL));
            final VersionedRenderProgram renderProgram;
            new VersionedBlaze3DRenderType(renderProgram);
            return;
        });
        LEGACY_SNOXH_EYES = VersionedStandardBlaze3DRenderTypes.MEMOIZE_STORAGE.memoize(location -> {
            new VersionedBlaze3DRenderType(new VersionedRenderProgram("labymod:legacy_snoxh_eyes", DrawingMode.QUADS, cdy.l, VersionedStandardBlaze3DRenderTypes.DEFAULT_PARAMETERS.apply(location)));
            return;
        });
    }
}
