...
public class VersionedBlockColorProvider implements BlockColorProvider
{
    ...
    public int getColor(final BlockState state) {
        final nf blockId = (nf)aow.h.b((Object)state.block());
    ...
    public int getColorMultiplier(final BlockState state) {
        ...
        return blockColors.a(((VersionedBlockState)state).getState(), (amu)level, this.toBlockPos(state.position()));
    }
    ...
    private et toBlockPos(final IntVector3 vec) {
