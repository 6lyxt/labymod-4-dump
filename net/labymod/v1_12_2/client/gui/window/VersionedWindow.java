...
package net.labymod.v1_12_2.client.gui.window;
...
public class VersionedWindow extends DefaultAbstractWindow
{
    ...
    public void resetBounds() {
        final bit window = this.getScaledResolution();
    ...
    private bit getScaledResolution() {
        ...
        if (updateScaledResolution) {
            this.scaledResolution = new bit(minecraft);
        }
    ...
    public ScreenWrapper currentScreen() {
        ...
        if (screen != this.currentScreen) {
            ...
            final boolean previousScreen = !(screen instanceof bkq);
    ...
    public Object mostInnerScreen() throws TooManyIterationsException {
        return this.getMostInnerScreen(bib.z().m);
    }
