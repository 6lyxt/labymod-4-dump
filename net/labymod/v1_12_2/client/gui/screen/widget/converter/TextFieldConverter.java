...
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<bje, TextFieldWidget>
{
    ...
    @Override
    public TextFieldWidget createDefault(final bje source) {
    ...
    @Override
    public void update(final bje source, final TextFieldWidget destination) {
    ...
    public void updateText(final bje mc, final AbstractWidget<?> widget) {
    ...
    public void updateText(final bje mc, final TextFieldWidget widget) {
    ...
    @Override
    public String getWidgetId(final bje source) {
