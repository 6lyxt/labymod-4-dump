...
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo
{
    ...
    public VersionedNetworkPlayerInfo(final bsc wrapped) {
    ...
    public Component displayName() {
        final hh displayName = this.wrapped.l();
        if (displayName != null) {
    ...
    @Contract("_, _ -> new")
    @NotNull
    private hh formatPlayerName(final bhm team, final String username) {
        return (hh)((team == null) ? new ho(username) : new ho(team.d(username)));
    }
