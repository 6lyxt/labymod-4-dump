...
public abstract class MixinRendererLivingEntity
{
    ...
    public boolean labyMod$alwaysRedirectNameTagRendering(final vp entity) {
    ...
    private void labyMod$showOwnName(final vp entity, final InsertInfoReturnable<Boolean> cir) {
        if (entity == bib.z().h) {
