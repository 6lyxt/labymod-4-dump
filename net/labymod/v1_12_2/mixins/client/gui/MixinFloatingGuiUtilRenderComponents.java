...
{
    @Shadow
    public static String a(final String lvt_0_1_, final boolean lvt_1_1_) {
        return null;
    }
    
    @Insert(method = { "splitText" }, at = @At("HEAD"), cancellable = true)
    private static void labyMod$splitTextFloat(final hh rawText, final int maxWidth, final bip renderer, final boolean removeLeadingSpaces, final boolean p_splitText_4_, final InsertInfoReturnable<List<hh>> callback) {
