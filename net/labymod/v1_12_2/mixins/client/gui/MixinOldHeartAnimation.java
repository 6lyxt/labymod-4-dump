...
public class MixinOldHeartAnimation
{
    ...
    private void labyMod$oldHeartBackground(final biq instance, final int x, final int y, final int u, final int v, final int uWidth, final int vHeight, final Operation<Void> original) {
    ...
    private void labyMod$oldFullHeartFlash(final biq instance, final int x, final int y, final int u, final int v, final int uWidth, final int vHeight, final Operation<Void> original) {
        this.labyMod$applyOldHeartAnimation(instance, x, y, u, v, uWidth, vHeight, original);
    }
    ...
    private void labyMod$oldHalfHeartFlash(final biq instance, final int x, final int y, final int u, final int v, final int uWidth, final int vHeight, final Operation<Void> original) {
        this.labyMod$applyOldHeartAnimation(instance, x, y, u, v, uWidth, vHeight, original);
    }
    
    private void labyMod$applyOldHeartAnimation(final biq instance, final int x, final int y, int u, final int v, final int uWidth, final int vHeight, final Operation<Void> original) {
