...
public class MixinGuiShareToLan implements CompletableGuiShareToLan
{
    ...
    @Insert(method = { "actionPerformed" }, at = @At(value = "INVOKE", target = "Lnet/minecraft/util/text/TextComponentTranslation;<init>(Ljava/lang/String;[Ljava/lang/Object;)V"))
    private void labyMod$handleLanWorldOpenSuccess(final bja button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
            this.labyMod$finishHandler.accept(true);
        }
    }
    
    @Insert(method = { "actionPerformed" }, at = @At(value = "INVOKE", target = "Lnet/minecraft/util/text/TextComponentString;<init>(Ljava/lang/String;)V"))
    private void labyMod$handleLanWorldOpenFail(final bja button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
