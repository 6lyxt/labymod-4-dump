...
public abstract class MixinNBTTagCompound implements NBTTagCompound
{
    ...
    @Shadow
    public abstract void a(final String p0, final gn p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract gn c(final String p0);
    ...
    @Shadow
    public abstract fy p(final String p0);
    
    @Shadow
    public abstract ge c(final String p0, final int p1);
    ...
    public Map<String, NBTTag<?>> value() {
        return (Map<String, NBTTag<?>>)this.d;
    }
    ...
    public long[] labyMod$getLongArray(@NotNull final String key) {
        try {
            return this.b(key, NBTTagType.LONG_ARRAY.getId()) ? this.d.get(key).getLongArray() : new long[0];
        }
        catch (final ClassCastException e) {
            throw new f(this.a(key, NBTTagType.LONG_ARRAY.getId(), e));
        }
    }
    ...
    public NBTTagCompound labyMod$getCompound(@NotNull final String key) {
        return (NBTTagCompound)this.p(key);
    }
