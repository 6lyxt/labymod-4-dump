...
package net.labymod.v1_20_5.mixins.mojang.vertex;

import java.util.Collection;
import net.labymod.v1_20_5.client.render.vertex.VertexFormatUtil;
...
public abstract class MixinVertexFormat implements OldVertexFormat
{
    ...
    public void setupAttributeLocation(final ShaderProgram program) {
        VertexFormatUtil.bindAttributeLocation((fae)this, program);
    }
