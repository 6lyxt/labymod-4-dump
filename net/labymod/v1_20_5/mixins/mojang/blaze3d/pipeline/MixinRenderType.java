...
package net.labymod.v1_20_5.mixins.mojang.blaze3d.pipeline;
...
@Mixin({ gdx.class })
public abstract class MixinRenderType extends gdw implements Blaze3DRenderType
{
    @Shadow
    public abstract void a(final ezu p0, final fah p1);
    ...
    public void draw(final BufferConsumer consumer, final int cameraX, final int cameraY, final int cameraZ) {
        if (consumer instanceof final ezu bufferBuilder) {
            this.a(bufferBuilder, fah.a((float)cameraX, (float)cameraY, (float)cameraZ));
            return;
        }
