...
package net.labymod.v1_20_5.mixins.mojang.blaze3d.vertex;
...
public class MixinVertexBuffer
{
    ...
    private void labyMod$applyShaderInstance(final ged shaderInstance) {
    ...
    private void labyMod$clearShaderInstance(final ged shaderInstance) {
        final DefaultShaderProgramApplier program_APPLIER = MixinVertexBuffer.PROGRAM_APPLIER;
        Objects.requireNonNull(shaderInstance);
