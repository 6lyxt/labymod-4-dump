...
import net.labymod.v1_20_5.client.resources.pack.ModifiedRepositorySource;
...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<atx>> cir) {
        final List<atx> selectedPacks = (List<atx>)cir.getReturnValue();
