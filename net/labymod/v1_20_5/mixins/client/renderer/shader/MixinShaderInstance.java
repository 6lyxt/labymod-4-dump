...
package net.labymod.v1_20_5.mixins.client.renderer.shader;
...
import net.labymod.v1_20_5.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final ezp shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (ged)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final ezp shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (ged)this);
    }
