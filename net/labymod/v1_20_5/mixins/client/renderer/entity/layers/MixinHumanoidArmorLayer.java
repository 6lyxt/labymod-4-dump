...
public class MixinHumanoidArmorLayer
{
    ...
    private void labyMod$getLivingEntity(final ezz poseStack, final gdp bufferSource, final int packedLight, final btq entity, final float param4, final float param5, final float param6, final float param7, final float param8, final float param9, final InsertInfo info) {
        this.labyMod$overlayCoords = gjz.c(entity, 0.0f);
    }
    ...
    private void labyMod$enableOverlayTexture(final fuo model, final ezz stack, final fad consumer, final int packedLight, final int overlayTexture, final float red, final float green, final float blue, final float alpha) {
