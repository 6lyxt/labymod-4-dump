...
public abstract class MixinItemRenderer implements ItemStackRenderer
{
    ...
    @Shadow
    public abstract void a(final cuq p0, final cun p1, final boolean p2, final ezz p3, final gdp p4, final int p5, final int p6, final grb p7);
    ...
    public void renderItemStack(final Stack stack, final ItemStack itemStack, final int x, final int y, final boolean decorate, final float alpha) {
        if (this.labyMod$graphics == null) {
            this.labyMod$graphics = new fgs(ffg.Q(), ffg.Q().aQ().c());
        }
        ...
        if (decorate) {
            this.labyMod$graphics.a(ffg.Q().h, minecraftItemStack, x, y);
        }
    }
}
