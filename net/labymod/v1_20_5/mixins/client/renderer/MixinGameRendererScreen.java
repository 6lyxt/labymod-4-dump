...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final fne instance, final fgs graphics, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
