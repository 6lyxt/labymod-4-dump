...
public class MixinClientLevel
{
    ...
    private void labyMod$addEntity(final bsv entity, final InsertInfo ci) {
        Laby.fireEvent(new EntitySpawnEvent(entity.al(), (Entity)entity));
    }
    ...
    private void labyMod$removeEntity(final bsv entity, final bsv.c param0) {
        entity.b(param0);
