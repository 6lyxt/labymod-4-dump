...
package net.labymod.v1_20_5.mixins.client.world.chunk;
...
public abstract class MixinChunkAccess implements Chunk
{
    ...
    @Shadow
    @Final
    protected Map<iz, dpi> k;
    
    @Shadow
    public abstract dxv a(final dxv.a p0);
    
    @Shadow
    public abstract duk b(final int p0);
    
    @Shadow
    public abstract duk[] d();
    ...
    public Heightmap heightmap(final HeightmapType type) {
        ...
        return (Heightmap)this.a(dxv.a.b);
    }
    ...
    public BlockState getBlockState(final int x, final int y, final int z) {
        final int index = ((dtz)this).e(y);
        if (index < 0 || index >= this.m.length) {
            return (BlockState)dfc.a.o();
        }
        final duk section = this.m[index];
        if (section == null) {
            return (BlockState)dfc.a.o();
        }
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (final Map.Entry<iz, dpi> entry : this.k.entrySet()) {
    ...
    public int getHeightBasedOnSection(final int startY) {
        ...
        for (int index = startSectionIndex; index < sections.length; ++index) {
            final duk section = sections[index];
            if (section != null) {
                if (!section.c()) {
