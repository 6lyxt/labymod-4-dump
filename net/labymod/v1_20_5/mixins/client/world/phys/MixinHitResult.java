...
package net.labymod.v1_20_5.mixins.client.world.phys;
...
public abstract class MixinHitResult implements HitResult
{
    ...
    private void labyMod$createApiVector(final evs vector, final InsertInfo info) {
    ...
    protected HitType labyMod$getHitType(final evq.a type) {
        switch (type) {
            case a: {
                return HitType.MISS;
            }
