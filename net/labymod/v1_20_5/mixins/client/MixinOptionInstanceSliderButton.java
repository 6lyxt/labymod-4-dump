...
import net.labymod.v1_20_5.client.gui.WrappedIntRangeBase;
import net.labymod.api.util.StringUtil;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Shadow;
import org.jetbrains.annotations.Nullable;
import org.spongepowered.asm.mixin.Mixin;
import net.labymod.v1_20_5.mixins.client.gui.components.MixinAbstractSliderButton;

@Mixin({ ffj.i.class })
public abstract class MixinOptionInstanceSliderButton<T> extends MixinAbstractSliderButton
{
    @Nullable
    private ffj.g labyMod$wrappedIntRangeBase;
    @Shadow
    @Final
    private ffj.k<T> e;
    ...
    private ffj.g labyMod$createWrappedIntRangeBase() {
        ...
        if (ffj.g.class.isAssignableFrom(cls)) {
            return (ffj.g)new WrappedIntRangeBase((ffj.g)this.e);
        }
        return null;
    }
}
