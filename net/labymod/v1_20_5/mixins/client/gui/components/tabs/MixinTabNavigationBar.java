...
package net.labymod.v1_20_5.mixins.client.gui.components.tabs;
...
@Mixin({ fjj.class })
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fiz implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor
{
    private final WidgetWatcher<T> watcher;
    private final Map<fjh, VersionedTab> versionedTabs;
    @Shadow
    @Final
    private ImmutableList<fjh> i;
    @Shadow
    @Final
    private fji h;
    private fjh labyMod$currentTab;
    
    public MixinTabNavigationBar() {
        this.watcher = new WidgetWatcher<T>();
        this.versionedTabs = new HashMap<fjh, VersionedTab>();
    }
    
    public ImmutableList<fjh> getTabs() {
        return this.i;
    }
    
    public fji getTabManager() {
        return this.h;
    }
    ...
    public VersionedTab versionedTabOf(final fjh tab) {
