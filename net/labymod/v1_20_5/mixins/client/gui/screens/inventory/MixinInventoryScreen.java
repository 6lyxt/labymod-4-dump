...
@Mixin({ fpd.class })
public abstract class MixinInventoryScreen extends fov<cqw>
{
    private InventorySlotRegistry labyMod$inventorySlotRegistry;
    private boolean labyMod$oldSurvivalLayoutTexture;
    
    public MixinInventoryScreen(final cqw param0, final cmx param1, final xp param2) {
        super((cpv)param0, param1, param2);
    }
    ...
    private void labyMod$init(final InsertInfo info) {
        ...
        for (final crq slot : ((cqw)this.F()).i) {
    ...
    private void labyMod$setOldSurvivalLayoutTexture(final fgs graphics, alf location, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5, final int $$6) {
    ...
    @NotNull
    private crq getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final crq slot) {
