...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final fgs param0, final fgq param1, final xp param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final fyk serverData, final InsertInfo ci) {
