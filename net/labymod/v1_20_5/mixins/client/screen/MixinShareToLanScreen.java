...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final gtf server, final fhf button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final gtf server, final fhf button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
