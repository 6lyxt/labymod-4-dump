...
package net.labymod.v1_20_5.mixins.client.screen.components;
...
public class MixinCommandSuggestions implements CommandSuggestionsAccessor
{
    ...
    private void labyMod$modifyBackgroundPosition(final fgs graphics, final int left, final int top, final int right, final int bottom, final int color) {
    ...
    private int labyMod$modifyTextPosition(final fgs graphics, final fgq font, final ayl text, final int x, final int y, final int color) {
