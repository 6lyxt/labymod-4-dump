...
package net.labymod.v1_20_5.mixins.client.entity.decoration;
...
import net.labymod.v1_20_5.mixins.client.entity.MixinEntity;
...
{
    @Shadow
    public abstract cuq shadow$E();
    
    @Intrinsic
    @Nullable
    public ItemStack itemFrame$getItem() {
        return (ItemStack)this.shadow$E();
    }
}
