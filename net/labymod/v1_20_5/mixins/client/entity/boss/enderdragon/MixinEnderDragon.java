...
package net.labymod.v1_20_5.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_20_5.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final btb<? extends cic> type, final dbz level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final cia part : this.ck) {
