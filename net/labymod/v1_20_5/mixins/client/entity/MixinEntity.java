...
public abstract class MixinEntity implements Entity
{
    ...
    public boolean isInvisibleFor(final Player player) {
        return this.labyMod$getEntity().d((cmy)player);
    }
    ...
    @Shadow
    public abstract evs shadow$dn();
    
    @Shadow
    public abstract bsy a(final buc p0);
    
    @Shadow
    public abstract btb<?> ak();
    ...
    public boolean canEnterEntityPose(final EntityPose pose) {
        ...
        return minecraftPose != null && this.r.a((bsv)this, this.a((buc)minecraftPose).a(this.shadow$dn()).h(1.0E-7));
    }
    ...
    private void labyMod$setBoundingBox(final evn aabb, final InsertInfo info) {
