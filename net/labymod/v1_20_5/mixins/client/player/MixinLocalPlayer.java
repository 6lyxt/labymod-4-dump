...
public abstract class MixinLocalPlayer extends MixinAbstractLocalPlayer implements ClientPlayer
{
    ...
    @Shadow
    public abstract void a(final bqu p0);
    
    @Override
    public boolean isAbilitiesFlying() {
        return this.labyMod$getClientPlayer().gd().b;
    }
    ...
    public boolean isHandActive() {
        return this.labyMod$getClientPlayer().fv();
    }
    
    @Override
    public boolean isUsingBow() {
        return this.labyMod$getClientPlayer().fx().g() == cut.ou;
    }
    ...
    public void swingArm(final LivingEntity.Hand hand, final boolean cancelPacket) {
        final bqu interactionHand = (hand == LivingEntity.Hand.MAIN_HAND) ? bqu.a : bqu.b;
    ...
    public Inventory inventory() {
        return (Inventory)this.labyMod$getClientPlayer().gc();
    }
    ...
    public float getForwardMovingSpeed() {
        return this.labyMod$getClientPlayer().cA.b;
    }
    ...
    private void labyMod$cancelHandSwingPacket(final bqu hand, final InsertInfo ci) {
    ...
    private gcr labyMod$getClientPlayer() {
        return (gcr)this;
    }
}
