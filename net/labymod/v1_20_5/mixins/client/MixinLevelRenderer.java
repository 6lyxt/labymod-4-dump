...
import net.labymod.v1_20_5.client.renderer.OverlayRenderType;
...
public class MixinLevelRenderer implements WorldRenderer
{
    ...
    public void labyMod$renderCustomOutline(final gdn instance, final ezz poseStack, final fad vertexConsumer, final bsv entity, final double x, final double y, final double z, final iz blockPos, final dsd blockState) {
        ...
        final ewl voxelShape = blockState.a((dbf)this.u, blockPos, evx.a(entity));
        ...
        if (event.getOverlayColor() != null) {
            final fad boxVertex = this.t.c().getBuffer((gdx)OverlayRenderType.INSTANCE);
    ...
    private ewi.a drawLines(final fad vertexConsumer, final ezz.a pose, final double x, final double y, final double z, final Color color) {
    ...
    private void labyMod$beforeEntityRenderPass(final float $$0, final long $$1, final boolean $$2, final fer $$3, final gdi $$4, final gdo $$5, final Matrix4f $$6, final Matrix4f $$7, final CallbackInfo ci) {
    ...
    private void labyMod$afterEntityRenderPass(final float $$0, final long $$1, final boolean $$2, final fer $$3, final gdi $$4, final gdo $$5, final Matrix4f $$6, final Matrix4f $$7, final CallbackInfo ci) {
        Laby.fireEvent(new EntityRenderPassEvent(EntityRenderPassEvent.Phase.AFTER));
    }
    
    private ewi.a drawBoxes(final fad vertexConsumer, final ezz.a pose, final double x, final double y, final double z, final Color color) {
        final float red = color.getRed() / 255.0f;
        final float green = color.getGreen() / 255.0f;
        final float blue = color.getBlue() / 255.0f;
        final float alpha = color.getAlpha() / 255.0f;
    ...
    private fad vertex(final fad vertexConsumer, final Matrix4f matrix, final double x, final double y, final double z) {
