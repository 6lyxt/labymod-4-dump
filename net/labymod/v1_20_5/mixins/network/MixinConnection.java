...
package net.labymod.v1_20_5.mixins.network;
...
public class MixinConnection
{
    ...
    public xp labyMod$modifyReason(final xp component) {
        ...
        return (xp)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY)).reason());
    }
}
