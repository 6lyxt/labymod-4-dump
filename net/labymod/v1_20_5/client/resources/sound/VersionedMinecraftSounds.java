...
package net.labymod.v1_20_5.client.resources.sound;
...
public class VersionedMinecraftSounds implements MinecraftSounds
{
    ...
    public void playChatFilterSound() {
        ffg.Q().aj().a((gso)gsj.a((ji)awa.rV, 1.0f));
    }
    
    @Override
    public void playSound(final ResourceLocation location, final float volume, final float pitch) {
        this.playSound(gsj.a(new avz((alf)location.getMinecraftLocation(), 16.0f, false), pitch, volume));
    }
    
    @Override
    public void playSound(final ResourceLocation location, final float volume, final float pitch, final FloatVector3 position) {
        this.playSound(new gsj((alf)location.getMinecraftLocation(), awb.a, volume, pitch, gso.t(), false, 0, gso.a.a, (double)position.getX(), (double)position.getY(), (double)position.getZ(), true));
    }
    
    @Override
    public void playSound(final ResourceLocation location, final float volume, final float pitch, final DoubleVector3 position) {
        this.playSound(new gsj((alf)location.getMinecraftLocation(), awb.a, volume, pitch, gso.t(), false, 0, gso.a.a, position.getX(), position.getY(), position.getZ(), true));
    }
    
    private void playSound(final gsj sound) {
        sound.a(ffg.Q().aj());
        ffg.Q().aj().a((gso)sound);
    }
}
