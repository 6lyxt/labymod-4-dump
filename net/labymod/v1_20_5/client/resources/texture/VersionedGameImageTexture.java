...
public class VersionedGameImageTexture extends got implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((alf)location.getMinecraftLocation());
    ...
    public void a(final aup resourceManager) {
        this.prepareImage();
    }
