...
package net.labymod.v1_20_5.client.world.lighting;
...
public class VersionedLightingLayerMapper implements LightingLayerMapper
{
    ...
    public LightType fromMinecraft(final Object value) {
        if (value instanceof final dci lightLayer) {
        ...
        throw new IllegalArgumentException(value.getClass().getName() + " is not an instance of " + dci.class.getName());
    }
