...
public class LabyScreenRenderer extends fne implements FileDropHandler, LabyScreenAccessor
{
    ...
    public void a(@NotNull final fgs graphics, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(final fgs graphics, final int mouseX, final int mouseY, final float tickDelta) {
        final Stack stack = ((VanillaStackAccessor)graphics.c()).stack();
    ...
    public void a(@NotNull final ffg mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
