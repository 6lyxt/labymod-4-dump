...
public class ButtonConverter extends AbstractMinecraftWidgetConverter<fgw, ButtonWidget>
{
    ...
    @Override
    public ButtonWidget createDefault(final fgw source) {
        final ButtonWidget destination = ButtonWidget.component((source instanceof fik.b) ? null : this.mapComponent(source.y()), null, Pressable.NOOP);
    ...
    @Override
    public void update(final fgw source, final ButtonWidget destination) {
    ...
    @Override
    public String getWidgetId(final fgw source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.y());
    }
    
    @Override
    public List<String> getWidgetIds(final fgw source) {
        return this.componentMapper.getTranslationKeysOfComponent(source.y());
    }
    
    class ImageButtonMapper implements Mapper<fgw, ButtonWidget>
    {
        @Override
        public ButtonWidget map(final fgw source) {
            if (source instanceof final fhr imageButton) {
    ...
    class LockIconButtonMapper implements Mapper<fgw, ButtonWidget>
    {
        ...
        @Override
        public ButtonWidget map(final fgw source) {
            if (source instanceof final fhv lockIconButton) {
