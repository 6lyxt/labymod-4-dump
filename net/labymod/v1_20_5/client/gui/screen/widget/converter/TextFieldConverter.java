...
import net.labymod.v1_20_5.client.gui.EditBoxAccessor;
import net.labymod.api.client.gui.screen.widget.converter.MinecraftWidgetType;
import net.labymod.api.client.gui.screen.widget.widgets.input.TextFieldWidget;
import net.labymod.api.client.gui.screen.widget.converter.AbstractMinecraftWidgetConverter;

public class TextFieldConverter extends AbstractMinecraftWidgetConverter<fho, TextFieldWidget>
{
    ...
    @Override
    public TextFieldWidget createDefault(final fho source) {
    ...
    @Override
    public void update(final fho source, final TextFieldWidget destination) {
