...
package net.labymod.v1_20_5.client.font.component;
...
public class VersionedComponentMapper implements ComponentMapper
{
    ...
    public String getTranslationKeyOfComponent(final Object minecraftComponent) {
        if (minecraftComponent instanceof final xp component) {
            final xq contents = component.b();
            if (contents instanceof final za za) {
                return za.b();
            }
        }
        return null;
