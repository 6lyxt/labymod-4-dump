...
public class DynamicStringRenderOutput extends fgq.b
{
    public DynamicStringRenderOutput(final fgq font, final gdp bufferSource, final float x, final float y, final int color, final boolean shadow, final Matrix4f modelViewMatrix, final fgq.a displayMode, final int packedLightCoords) {
