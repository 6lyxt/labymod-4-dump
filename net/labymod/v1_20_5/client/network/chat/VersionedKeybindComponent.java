...
import net.labymod.v1_20_5.client.network.chat.contents.KeybindContentsAccessor;
...
{
    public VersionedKeybindComponent(final yd holder) {
        super(holder);
    }
    ...
    public String getKeybind() {
        ...
        if (contents instanceof final yt keybind) {
            return keybind.b();
        }
