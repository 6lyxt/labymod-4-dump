...
package net.labymod.v1_20_5.client.gfx.pipeline.target;
...
{
    private final eyl renderTarget;
    
    public VersionedRenderTarget(final eyl renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final eyl renderTarget2 = this.renderTarget;
        ...
        final eyl renderTarget3 = this.renderTarget;
