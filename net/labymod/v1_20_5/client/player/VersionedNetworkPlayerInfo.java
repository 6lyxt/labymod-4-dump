...
package net.labymod.v1_20_5.client.player;
...
{
    private final fyh wrapped;
    private final Component usernameComponent;
    private Metadata metadata;
    
    public VersionedNetworkPlayerInfo(final fyh wrapped) {
    ...
    public Component displayName() {
        final xp displayName = this.wrapped.i();
        if (displayName == null) {
    ...
    public fyh getWrapped() {
        return this.wrapped;
    }
    
    private xp decorateComponent(@NotNull final fyh info, final yd mutableComponent) {
        return (xp)((info.e() == dbw.d) ? mutableComponent.a(n.u) : mutableComponent);
    }
