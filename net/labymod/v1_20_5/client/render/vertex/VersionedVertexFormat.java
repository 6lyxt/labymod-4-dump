...
{
    private static final Supplier<ged> NULLABLE_SUPPLIER;
    private final fae vertexFormat;
    private final Supplier<ged> shaderSupplier;
    private final Collection<String> attributeNames;
    
    public VersionedVertexFormat(final fae format) {
        this(format, VersionedVertexFormat.NULLABLE_SUPPLIER);
    }
    
    public VersionedVertexFormat(final fae vertexFormat, final Supplier<ged> shaderSupplier) {
