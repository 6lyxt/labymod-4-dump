...
import net.labymod.v1_20_5.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, gdx> RENDER_TYPE_FUNCTION;
    private final fab tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private fad consumer;
    private ezu bufferBuilder;
    @Deprecated
    private gdp.a bufferSource;
    private RenderPhase renderPhase;
    private gdx renderType;
    private OldVertexFormat currentFormat;
    private ezu.b renderedBuffer;
    
    public VersionedBufferBuilder() {
        this.tesselator = fab.b();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final ezu builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (fae)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final gdp multiBufferSource) {
    ...
    public void uploadToBuffer() {
        ...
        this.renderType.a(this.bufferBuilder, fah.a);
    }
    ...
    public boolean building() {
        ...
        final fad consumer = this.consumer;
        if (consumer instanceof final ezu bufferBuilder) {
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (fae)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public ezu getBufferBuilder() {
        return this.bufferBuilder;
    }
    
    public ezu.b renderedBuffer() {
