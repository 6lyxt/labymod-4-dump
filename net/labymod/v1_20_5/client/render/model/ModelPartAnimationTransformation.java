...
package net.labymod.v1_20_5.client.render.model;
...
{
    public ModelPartAnimationTransformation(final fxb modelPart, final Transformation modelPartTransform) {
    ...
    {
        private final fxb modelPart;
        private final FloatVector3 modelPartTranslation;
        
        public ModelPartPositionVector(final fxb modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final fxb modelPart) {
            this.modelPart = modelPart;
        }
