...
package net.labymod.v1_20_5.client.overlay;
...
public class CustomLoadingOverlay extends fmq
{
    private final ffg minecraft;
    ...
    public CustomLoadingOverlay(final ffg minecraft, final aul reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final fgs gui, final int mouseX, final int mouseY, final float partialTicks) {
        final ezd window = this.minecraft.aO();
