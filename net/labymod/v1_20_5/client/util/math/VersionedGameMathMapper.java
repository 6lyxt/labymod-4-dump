...
package net.labymod.v1_20_5.client.util.math;
...
public class VersionedGameMathMapper implements GameMathMapper
{
    ...
    public AxisAlignedBoundingBox fromAABB(final Object aabb) {
        if (aabb instanceof final evn gameAABB) {
    ...
    public <T> T toAABB(final AxisAlignedBoundingBox aabb) {
        return (T)new evn(aabb.getMinX(), aabb.getMinY(), aabb.getMinZ(), aabb.getMaxX(), aabb.getMaxY(), aabb.getMaxZ());
    }
