...
public class WatchablePlayerInfoSet implements WatchableSet<fyh>
{
    ...
    @Override
    public void onAdd(final fyh playerInfo) {
    ...
    @Override
    public void onRemove(final fyh playerInfo) {
        final NetworkPlayerInfo networkPlayerInfo = this.findNetworkPlayerInfo(playerInfo);
        if (networkPlayerInfo == null) {
            return;
        }
    ...
    private NetworkPlayerInfo findNetworkPlayerInfo(final fyh info) {
