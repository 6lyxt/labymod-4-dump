...
public class VersionedIconContents implements xq
{
    ...
    private static final xq.a<VersionedIconContents> TYPE;
    private Icon icon;
    private int width;
    private int height;
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final xu.a<T> consumer) {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final xu.b<T> consumer, @NotNull final ym style) {
    ...
    static {
        ...
        TYPE = new xq.a((MapCodec)VersionedIconContents.CODEC, "icon");
    }
}
