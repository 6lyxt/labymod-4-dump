...
package net.labymod.v1_20_2.generated;
...
import net.labymod.v1_20_2.client.gui.background.VersionedPanoramaRenderer;
import net.labymod.v1_20_2.client.session.user.VersionedUserFactory;
import net.labymod.v1_20_2.client.multiplayer.server.VersionedClientNetworkPacketListener;
import net.labymod.v1_20_2.client.chat.VersionedChatModifier;
import net.labymod.v1_20_2.client.resources.texture.VersionedRefreshableTextureFactory;
import net.labymod.v1_20_2.nbt.VersionedNBTFactory;
import net.labymod.v1_20_2.client.gfx.VersionedGFXBridge;
import net.labymod.core.client.gfx.DevelopmentGFXBridge;
import net.labymod.v1_20_2.client.gfx.pipeline.blaze3d.program.VersionedStandardBlaze3DRenderTypes;
import net.labymod.v1_20_2.client.gfx.pipeline.texture.atlas.VersionedMinecraftAtlases;
import net.labymod.v1_20_2.client.gfx.pipeline.VersionedBlaze3DGlStatePipeline;
import net.labymod.v1_20_2.client.gfx.pipeline.VersionedBlaze3DShaderUniformPipeline;
import net.labymod.v1_20_2.client.gfx.texture.VersionedLightmapTexture;
import net.labymod.v1_20_2.client.gui.screen.key.mapper.VersionedKeyMapper;
import net.labymod.v1_20_2.client.gui.screen.VersionedScreenWrapperFactory;
import net.labymod.v1_20_2.client.render.gl.VersionedGlStateBridge;
import net.labymod.v1_20_2.client.render.gl.VersionedGlInformation;
import net.labymod.v1_20_2.client.renderer.VersionedPlayerHeartRenderer;
import net.labymod.api.reference.DynamicReference;
import net.labymod.v1_20_2.client.font.component.VersionedComponentMapper;
import net.labymod.core.client.render.font.text.msdf.MSDFGlyphProvider;
import net.labymod.v1_20_2.client.font.text.VersionedStringFormatter;
import net.labymod.v1_20_2.client.font.text.vanilla.VanillaTextRenderer;
...
import net.labymod.v1_20_2.client.render.matrix.VersionedStackProviderFactory;
import net.labymod.v1_20_2.client.render.system.shards.layering.VersionedViewOffsetZLayer;
import net.labymod.v1_20_2.client.render.system.shards.output.ItemEntityOutputRender;
import net.labymod.v1_20_2.client.render.VersionedRenderConstants;
import net.labymod.v1_20_2.client.render.VersionedRenderPipeline;
import net.labymod.v1_20_2.client.crash.VersionedGameCrashReportFactory;
import net.labymod.v1_20_2.client.particle.VersionedParticleController;
import net.labymod.v1_20_2.client.session.VersionedSessionAccessor;
import net.labymod.v1_20_2.client.session.VersionedMinecraftAuthenticator;
import net.labymod.v1_20_2.client.entity.VersionedEntityPoseMapper;
import net.labymod.v1_20_2.client.world.item.VersionedItemStackFactory;
import net.labymod.v1_20_2.client.world.lighting.VersionedLightingLayerMapper;
import net.labymod.v1_20_2.client.world.VersionedBossBarRegistry;
import net.labymod.v1_20_2.client.world.VersionedClientWorld;
import net.labymod.v1_20_2.client.world.phys.hit.VersionedHitResultController;
import net.labymod.v1_20_2.client.world.block.VersionedBlockColorProvider;
import net.labymod.v1_20_2.client.chat.VersionedChatExecutor;
...
import net.labymod.v1_20_2.client.resources.pack.VersionedResourcePackRepository;
import net.labymod.v1_20_2.client.resources.pack.VersionedResourcePackScanner;
import net.labymod.v1_20_2.client.resources.texture.NativeGameImageProvider;
import net.labymod.v1_20_2.client.resources.texture.VersionedTextureRepository;
import net.labymod.v1_20_2.client.resources.texture.VersionedGameImageTextureFactory;
import net.labymod.v1_20_2.client.resources.sound.VersionedMinecraftSounds;
import net.labymod.v1_20_2.client.resources.VersionedResourceLocationFactory;
import net.labymod.v1_20_2.server.VersionedServerAddressResolver;
import net.labymod.v1_20_2.client.multiplayer.server.VersionedServerController;
import net.labymod.v1_20_2.client.util.VersionedSystemInfo;
import net.labymod.v1_20_2.client.component.VersionedComponentService;
import net.labymod.v1_20_2.server.VersionedIntegratedServer;
import net.labymod.v1_20_2.mojang.texture.VersionedMojangTextureService;
import net.labymod.v1_20_2.client.util.math.VersionedGameMathMapper;
import net.labymod.api.reference.SingletonReference;
import net.labymod.v1_20_2.client.render.item.VersionedAnimationTypeMapper;
