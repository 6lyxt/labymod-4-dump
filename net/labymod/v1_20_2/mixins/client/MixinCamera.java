...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final ehn position = this.b();
        this.labymod$cameraPosition.set((float)position.a(ha.a.a), (float)position.a(ha.a.b), (float)position.a(ha.a.c));
    ...
    public DoubleVector3 position() {
        final ehn position = this.b();
        this.labyMod$position.set(position.a(ha.a.a), position.a(ha.a.b), position.a(ha.a.c));
