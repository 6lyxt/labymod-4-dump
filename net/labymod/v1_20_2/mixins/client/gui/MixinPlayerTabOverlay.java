...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final esf graphics, final int screenWidth, final eim scoreboard, final eij objective, final InsertInfo ci) {
