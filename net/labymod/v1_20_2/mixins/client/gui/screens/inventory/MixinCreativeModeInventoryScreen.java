...
package net.labymod.v1_20_2.mixins.client.gui.screens.inventory;

import net.labymod.v1_20_2.client.world.inventory.SlotAccessor;
...
@Mixin({ ezw.class })
public abstract class MixinCreativeModeInventoryScreen extends ezz<ezw.b>
{
    ...
    public MixinCreativeModeInventoryScreen(final ezw.b pickerMenu, final cbt inventory, final tl component) {
        super((cel)pickerMenu, inventory, component);
    }
    ...
    private void labyMod$setEntityToOldPosition(final esf graphics, final int x, final int y, final int width, final int height, final int scale, final float modelHeight, final float mouseX, final float mouseY, final bjg entity) {
        if (this.labyMod$oldCreativeLayoutTexture) {
            fah.a(graphics, x - this.labyMod$entityXShift, y - this.labyMod$entityYShift, width, height, scale, modelHeight, mouseX - this.labyMod$entityXShift, mouseY - this.labyMod$entityYShift, entity);
            return;
        }
        fah.a(graphics, x, y, width, height, scale, modelHeight, mouseX, mouseY, entity);
    }
    ...
    private void labyMod$setOldCreativeTexture(final esf graphics, final aew location, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5, final int $$6) {
        if (!this.labyMod$oldCreativeLayoutTexture) {
        ...
        if (resourceLocation != null) {
            graphics.a((aew)resourceLocation.getMinecraftLocation(), $$1, $$2, $$3, $$4, $$5, $$6);
        }
    }
    ...
    private void labyMod$onSelectTab(final chl tab, final CallbackInfo ci) {
        this.labyMod$modifySlots();
    }
    
    private void labyMod$modifySlots() {
        if (this.labyMod$oldCreativeLayoutTexture) {
            for (final cgd slot : ((ezw.b)this.E()).i) {
    ...
    @NotNull
    private cgd getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final InventorySlotData legacySlot, @NotNull final cgd slot) {
