...
@Mixin({ fah.class })
public abstract class MixinInventoryScreen extends ezz<cfk>
{
    private InventorySlotRegistry labyMod$inventorySlotRegistry;
    private boolean labyMod$oldSurvivalLayoutTexture;
    
    public MixinInventoryScreen(final cfk param0, final cbt param1, final tl param2) {
        super((cel)param0, param1, param2);
    }
    ...
    private void labyMod$init(final InsertInfo info) {
        ...
        for (final cgd slot : ((cfk)this.E()).i) {
    ...
    private void labyMod$setOldSurvivalLayoutTexture(final esf graphics, aew location, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5, final int $$6) {
    ...
    @NotNull
    private cgd getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final cgd slot) {
