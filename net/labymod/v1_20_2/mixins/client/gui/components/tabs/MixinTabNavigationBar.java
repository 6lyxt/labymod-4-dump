...
package net.labymod.v1_20_2.mixins.client.gui.components.tabs;
...
@Mixin({ eus.class })
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends eui implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor
{
    private final WidgetWatcher<T> watcher;
    private final Map<euq, VersionedTab> versionedTabs;
    @Shadow
    @Final
    private ImmutableList<euq> i;
    @Shadow
    @Final
    private eur h;
    private euq labyMod$currentTab;
    
    public MixinTabNavigationBar() {
        this.watcher = new WidgetWatcher<T>();
        this.versionedTabs = new HashMap<euq, VersionedTab>();
    }
    
    public ImmutableList<euq> getTabs() {
        return this.i;
    }
    
    public eur getTabManager() {
        return this.h;
    }
    ...
    public VersionedTab versionedTabOf(final euq tab) {
