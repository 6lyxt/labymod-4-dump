...
package net.labymod.v1_20_2.mixins.client.screen.components;
...
public class MixinCommandSuggestions implements CommandSuggestionsAccessor
{
    ...
    private void labyMod$modifyBackgroundPosition(final esf graphics, final int left, final int top, final int right, final int bottom, final int color) {
    ...
    private int labyMod$modifyTextPosition(final esf graphics, final esd font, final arj text, final int x, final int y, final int color) {
