...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final gdd server, final esq button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final gdd server, final esq button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
