...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final esf param0, final esd param1, final tl param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final fjh serverData, final InsertInfo ci) {
