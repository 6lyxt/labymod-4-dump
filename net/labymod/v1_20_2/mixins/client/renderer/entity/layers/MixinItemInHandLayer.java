...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final foa renderer, final bjg livingEntity, final cjf itemStack, final cjc type, final boolean leftHand, final elp poseStack, final foe bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final bjg livingEntity, final cjf itemStack, final cjc type, final boolean leftHand, final int combinedLight) {
