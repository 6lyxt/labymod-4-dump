...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final eyk instance, final esf graphics, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
