...
package net.labymod.v1_20_2.mixins.client.renderer.shader;
...
import net.labymod.v1_20_2.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final elf shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (fos)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final elf shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (fos)this);
    }
