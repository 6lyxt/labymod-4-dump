...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    @Nullable
    public abstract tq shadow$i();
    
    @Shadow
    public abstract uh a(@Nullable final tq p0);
    
    @Shadow
    @Nullable
    public abstract tj shadow$h();
    
    @Shadow
    public abstract uh a(@Nullable final tj p0);
    
    @Shadow
    public abstract uh a(@Nullable final uj p0);
    
    @Shadow
    @Nullable
    public abstract uj shadow$a();
    ...
    @Shadow
    public abstract uh a(@Nullable final Boolean p0);
    
    @Shadow
    public abstract uh b(@Nullable final Boolean p0);
    
    @Shadow
    public abstract uh c(@Nullable final Boolean p0);
    
    @Shadow
    public abstract uh d(@Nullable final Boolean p0);
    
    @Shadow
    public abstract uh e(@Nullable final Boolean p0);
    
    @Shadow
    public abstract aew shadow$k();
    
    @Shadow
    public abstract uh a(@Nullable final aew p0);
    
    @Shadow
    public abstract uh a(@Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((tq)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((tj)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final aew resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, uh> setter) {
