...
public class MixinClientLevel
{
    ...
    private void labyMod$addEntity(final biq entity, final InsertInfo ci) {
        Laby.fireEvent(new EntitySpawnEvent(entity.ah(), (Entity)entity));
    }
    ...
    private void labyMod$removeEntity(final biq entity, final biq.c param0) {
        entity.b(param0);
