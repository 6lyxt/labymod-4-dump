...
package net.labymod.v1_20_2.mixins.client.entity.item;
...
import net.labymod.v1_20_2.mixins.client.entity.MixinEntity;
...
public abstract class MixinPrimedTnt extends MixinEntity implements PrimedTnt
{
    ...
    public LivingEntity primedTnt$getOwner() {
        final bjg livingEntity = this.shadow$q();
