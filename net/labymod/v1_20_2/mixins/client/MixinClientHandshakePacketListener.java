...
public class MixinClientHandshakePacketListener
{
    ...
    public tl labyMod$fireServerKickEvent(final tl reason) {
        ...
        return (tl)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.LOGIN)).reason());
    }
}
