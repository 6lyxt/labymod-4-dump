...
import net.labymod.v1_20_2.client.gui.WrappedIntRangeBase;
import net.labymod.api.util.StringUtil;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Shadow;
import org.jetbrains.annotations.Nullable;
import org.spongepowered.asm.mixin.Mixin;
import net.labymod.v1_20_2.mixins.client.gui.components.MixinAbstractSliderButton;

@Mixin({ eqy.i.class })
public abstract class MixinOptionInstanceSliderButton<T> extends MixinAbstractSliderButton
{
    @Nullable
    private eqy.g labyMod$wrappedIntRangeBase;
    @Shadow
    @Final
    private eqy.k<T> e;
    ...
    private eqy.g labyMod$createWrappedIntRangeBase() {
        ...
        if (eqy.g.class.isAssignableFrom(cls)) {
            return (eqy.g)new WrappedIntRangeBase((eqy.g)this.e);
        }
        return null;
    }
}
