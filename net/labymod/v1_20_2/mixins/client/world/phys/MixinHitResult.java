...
package net.labymod.v1_20_2.mixins.client.world.phys;
...
public abstract class MixinHitResult implements HitResult
{
    ...
    private void labyMod$createApiVector(final ehn vector, final InsertInfo info) {
    ...
    protected HitType labyMod$getHitType(final ehl.a type) {
        switch (type) {
            case a: {
                return HitType.MISS;
            }
