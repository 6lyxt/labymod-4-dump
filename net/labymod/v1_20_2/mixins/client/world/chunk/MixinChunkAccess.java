...
package net.labymod.v1_20_2.mixins.client.world.chunk;
...
public abstract class MixinChunkAccess implements Chunk
{
    ...
    @Shadow
    @Final
    protected Map<gw, dcv> k;
    
    @Shadow
    public abstract dks a(final dks.a p0);
    
    @Shadow
    public abstract dhr b(final int p0);
    
    @Shadow
    public abstract dhr[] d();
    ...
    public Heightmap heightmap(final HeightmapType type) {
        ...
        return (Heightmap)this.a(dks.a.b);
    }
    ...
    public BlockState getBlockState(final int x, final int y, final int z) {
        final int index = ((dhf)this).e(y);
        if (index < 0 || index >= this.m.length) {
            return (BlockState)csw.a.n();
        }
        final dhr section = this.m[index];
        if (section == null) {
            return (BlockState)csw.a.n();
        }
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (final Map.Entry<gw, dcv> entry : this.k.entrySet()) {
    ...
    public int getHeightBasedOnSection(final int startY) {
        final dhr[] sections = this.d();
        if (sections.length == 0) {
            return 0;
        }
        final int bottomY = this.H_();
        ...
        for (int index = startSectionIndex; index < sections.length; ++index) {
            final dhr section = sections[index];
            if (section != null) {
                if (!section.c()) {
