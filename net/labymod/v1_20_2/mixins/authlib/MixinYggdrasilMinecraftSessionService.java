...
package net.labymod.v1_20_2.mixins.authlib;
...
import net.labymod.api.client.session.exceptions.ForcedUsernameChangeException;
...
{
    @Overwrite
    public void joinServer(final UUID profileId, final String authenticationToken, final String serverId) throws com.mojang.authlib.exceptions.AuthenticationException {
        try {
            ...
            if (cause instanceof ForcedUsernameChangeException) {
                throw new com.mojang.authlib.exceptions.ForcedUsernameChangeException();
            }
