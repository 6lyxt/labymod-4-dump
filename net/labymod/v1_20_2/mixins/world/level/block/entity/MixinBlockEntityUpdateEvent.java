...
public class MixinBlockEntityUpdateEvent
{
    ...
    private void labyMod$fireTileEntityPreLoadEvent(final qw tag, final InsertInfo ci) {
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final cpv level, final gw pos, final dfj state, final InsertInfo ci) {
        final dcv blockEntity = level.c_(pos);
