...
import net.labymod.v1_20_2.client.resources.pack.ModifiedPackResources;
...
public class MixinMultiPackResourceManager implements SilentReloadableResourceManager
{
    ...
    public void loadSilent(final ResourcePack resourcePack) {
        ...
        (this.c = new ArrayList<amh>(this.c)).add((amh)pack);
        final ami packType = ami.a;
        for (final String namespace : pack.a(packType)) {
            this.b.computeIfAbsent(namespace, s -> new ank(packType, s)).a((amh)pack);
        }
    }
}
