...
import net.labymod.v1_20_2.client.resources.pack.ModifiedRepositorySource;
...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<anb>> cir) {
        final List<anb> selectedPacks = (List<anb>)cir.getReturnValue();
