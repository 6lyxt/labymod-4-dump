...
package net.labymod.v1_20_2.mixins.server.network;
...
public class MixinServerGamePacketListenerImpl
{
    ...
    private void labyMod$fireDisconnectEventPre(final tl reason, final InsertInfo ci) {
        final GameProfile profile = (GameProfile)this.e.fQ();
        Laby.fireEvent(new IntegratedServerPlayerDisconnectEvent(Phase.PRE, profile));
    }
    
    @Insert(method = { "onDisconnect" }, at = @At("TAIL"))
    private void labyMod$fireDisconnectEventPost(final tl reason, final InsertInfo ci) {
        final GameProfile profile = (GameProfile)this.e.fQ();
