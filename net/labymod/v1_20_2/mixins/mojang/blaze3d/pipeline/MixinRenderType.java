...
package net.labymod.v1_20_2.mixins.mojang.blaze3d.pipeline;
...
@Mixin({ fom.class })
public abstract class MixinRenderType extends fol implements Blaze3DRenderType
{
    @Shadow
    public abstract void a(final elk p0, final elx p1);
    ...
    public void draw(final BufferConsumer consumer, final int cameraX, final int cameraY, final int cameraZ) {
        if (consumer instanceof final elk bufferBuilder) {
            this.a(bufferBuilder, elx.a((float)cameraX, (float)cameraY, (float)cameraZ));
            return;
        }
