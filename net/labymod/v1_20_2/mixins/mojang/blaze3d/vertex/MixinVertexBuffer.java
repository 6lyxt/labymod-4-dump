...
package net.labymod.v1_20_2.mixins.mojang.blaze3d.vertex;
...
public class MixinVertexBuffer
{
    ...
    private void labyMod$applyShaderInstance(final fos shaderInstance) {
    ...
    private void labyMod$clearShaderInstance(final fos shaderInstance) {
        final DefaultShaderProgramApplier program_APPLIER = MixinVertexBuffer.PROGRAM_APPLIER;
        Objects.requireNonNull(shaderInstance);
