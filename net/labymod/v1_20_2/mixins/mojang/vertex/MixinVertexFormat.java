...
package net.labymod.v1_20_2.mixins.mojang.vertex;

import java.util.Collection;
import net.labymod.v1_20_2.client.render.vertex.VertexFormatUtil;
...
public abstract class MixinVertexFormat implements OldVertexFormat
{
    ...
    public void setupAttributeLocation(final ShaderProgram program) {
        VertexFormatUtil.bindAttributeLocation((elu)this, program);
    }
