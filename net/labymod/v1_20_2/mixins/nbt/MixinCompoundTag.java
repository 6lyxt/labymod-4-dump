...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    @Final
    @Shadow
    private Map<String, rq> x;
    
    @Shadow
    public abstract rq a(final String p0, final rq p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract rq shadow$c(final String p0);
    ...
    @Shadow
    public abstract qw shadow$p(final String p0);
    
    @Shadow
    public abstract rc c(final String p0, final int p1);
