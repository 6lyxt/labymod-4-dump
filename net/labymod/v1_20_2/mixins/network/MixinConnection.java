...
package net.labymod.v1_20_2.mixins.network;
...
public class MixinConnection
{
    ...
    public tl labyMod$modifyReason(final tl component) {
        ...
        return (tl)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY)).reason());
    }
}
