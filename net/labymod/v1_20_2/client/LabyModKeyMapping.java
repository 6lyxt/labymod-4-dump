...
package net.labymod.v1_20_2.client;
...
public class LabyModKeyMapping extends eqt
{
    private static final Function<Hotkey, eqt> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? ekk.b.c : ekk.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static eqt create(final Hotkey hotkey) {
    ...
    public ekk.a i() {
        ...
        final ekk.b type = (key instanceof MouseButton) ? ekk.b.c : ekk.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final ekk.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == ekk.b.a || key.a() == ekk.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
