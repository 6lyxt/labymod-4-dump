...
package net.labymod.v1_20_2.client.render.model;
...
{
    public ModelPartAnimationTransformation(final fic modelPart, final Transformation modelPartTransform) {
    ...
    {
        private final fic modelPart;
        private final FloatVector3 modelPartTranslation;
        
        public ModelPartPositionVector(final fic modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final fic modelPart) {
            this.modelPart = modelPart;
        }
