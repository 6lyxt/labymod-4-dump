...
package net.labymod.v1_20_2.client.render.system.shards.layering;
...
public class VersionedViewOffsetZLayer implements ViewOffsetZLayer
{
    ...
    @Override
    public void setup() {
        final elp stack = RenderSystem.getModelViewStack();
        stack.a();
        stack.b(0.99975586f, 0.99975586f, 0.99975586f);
