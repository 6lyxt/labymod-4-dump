...
import net.labymod.v1_20_2.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, fom> RENDER_TYPE_FUNCTION;
    private final elr tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private elt consumer;
    private elk bufferBuilder;
    @Deprecated
    private foe.a bufferSource;
    private RenderPhase renderPhase;
    private fom renderType;
    private OldVertexFormat currentFormat;
    private elk.b renderedBuffer;
    
    public VersionedBufferBuilder() {
        this.tesselator = elr.a();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final elk builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (elu)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final foe multiBufferSource) {
    ...
    public void uploadToBuffer() {
        ...
        this.renderType.a(this.bufferBuilder, elx.a);
    }
    ...
    public boolean building() {
        ...
        final elt consumer = this.consumer;
        if (consumer instanceof final elk bufferBuilder) {
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        ...
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (elu)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public elk getBufferBuilder() {
        return this.bufferBuilder;
    }
    
    public elk.b renderedBuffer() {
