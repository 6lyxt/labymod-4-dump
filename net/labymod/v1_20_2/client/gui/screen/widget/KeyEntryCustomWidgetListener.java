...
package net.labymod.v1_20_2.client.gui.screen.widget;
...
public class KeyEntryCustomWidgetListener implements euk
{
    ...
    public void b_(final boolean focused) {
    ...
    public boolean a_(final double mouseX, final double mouseY) {
