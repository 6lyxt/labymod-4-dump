...
package net.labymod.v1_20_2.client.gui;
...
record IntRangeBaseSliderableValueSet<R>(eqy.g base, IntFunction<? extends R> intFunction, ToIntFunction<? super R> mapperFunction) implements eqy.k<R> {
