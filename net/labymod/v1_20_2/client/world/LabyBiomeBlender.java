...
public class LabyBiomeBlender implements coy
{
    ...
    public LabyBiomeBlender setLevel(final cpv level) {
        this.level = level;
        return this;
    }
    ...
    @NotNull
    public eab x_() {
        return this.level.x_();
    }
    
    @Nullable
    public dcv c_(@NotNull final gw blockPos) {
        return this.level.c_(blockPos);
    }
    
    @NotNull
    public dfj a_(@NotNull final gw blockPos) {
        return this.level.a_(blockPos);
    }
    
    @NotNull
    public eam b_(@NotNull final gw blockPos) {
    ...
    public int a(@NotNull final gw blockPos, @NotNull final cpg resolver) {
        final int x = blockPos.u();
        final int y = blockPos.v();
        final int z = blockPos.w();
        final int[] rgb = new int[3];
        int total = 0;
        final gw.a currentPos = new gw.a();
    ...
    private int processZAxis(final int x, final int y, final int z, final gw.a currentPos, final cpg resolver, int total, final int[] rgb, final int xIndex) {
    ...
    private int blendColors(final gw.a currentPos, final cpg resolver, int total, final int[] rgb) {
        final he<cqt> holder = (he<cqt>)this.level.s((gw)currentPos);
        final cqt biome = (holder == null) ? null : ((cqt)holder.a());
        if (biome != null) {
