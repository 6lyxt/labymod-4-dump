...
public class VersionedSessionAccessor extends DefaultAbstractSessionAccessor<erk>
{
    ...
    @Override
    public erk toGameSession(final Session session) {
        return (erk)this.userFactory.createUser(session);
    }
    
    @Override
    public Session fromGameSession(final erk gameSession) {
        if (gameSession == null) {
            return null;
        }
