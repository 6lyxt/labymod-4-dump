...
package net.labymod.v1_20_2.client.util.math;
...
public class VersionedGameMathMapper implements GameMathMapper
{
    ...
    public AxisAlignedBoundingBox fromAABB(final Object aabb) {
        if (aabb instanceof final ehi gameAABB) {
    ...
    public <T> T toAABB(final AxisAlignedBoundingBox aabb) {
        return (T)new ehi(aabb.getMinX(), aabb.getMinY(), aabb.getMinZ(), aabb.getMaxX(), aabb.getMaxY(), aabb.getMaxZ());
    }
