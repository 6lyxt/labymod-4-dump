...
public class WatchablePlayerInfoSet implements WatchableSet<fjf>
{
    ...
    @Override
    public void onAdd(final fjf playerInfo) {
    ...
    @Override
    public void onRemove(final fjf playerInfo) {
        final NetworkPlayerInfo networkPlayerInfo = this.findNetworkPlayerInfo(playerInfo);
        if (networkPlayerInfo == null) {
            return;
        }
    ...
    private NetworkPlayerInfo findNetworkPlayerInfo(final fjf info) {
