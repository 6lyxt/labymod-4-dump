...
public class VersionedGameImageTexture extends fyx implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((aew)location.getMinecraftLocation());
    ...
    public void a(final ant resourceManager) {
        this.prepareImage();
    }
