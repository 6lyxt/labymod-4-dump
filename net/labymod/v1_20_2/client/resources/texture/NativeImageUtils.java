...
{
    public static ekq read(final ByteBuffer buffer) throws IOException {
        return ekq.a(buffer);
    }
    
    public static ekq read(final InputStream inputStream) throws IOException {
        return ekq.a(inputStream);
    }
    
    public static ekq asNativeImage(final BufferedImage image) {
        return asNativeImage(image, NativeImageUtils::processImage);
    }
    
    public static ekq asNativeImage(final BufferedImage image, final BufferedImageProcessor processor) {
        final ekq result = new ekq(image.getWidth(), image.getHeight(), true);
    ...
    public static void fillSubImage(final ekq source, final ekq destination, final int parentX, final int parentY, final int width, final int height) {
    ...
    public static BufferedImage asBufferedImage(final ekq image) {
