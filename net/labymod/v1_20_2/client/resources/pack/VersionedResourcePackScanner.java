...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner
{
    ...
    private boolean isExternalPack(final amh pack) {
        ...
        return pack instanceof amf || pack instanceof amj || pack instanceof amd;
    }
    
    private IncompatibleResourcePack scanPack(final amh pack) {
    ...
    private void scanPack(final amh pack, final String baseDirectory, final amh.a output) {
        pack.a(ami.a, "minecraft", baseDirectory, output);
    }
    
    private Collection<String> collectIgnoredFiles(final amh pack) {
        final Set<String> ignoredFiles = new HashSet<String>();
        for (final String namespace : pack.a(ami.a)) {
            final anl<InputStream> resource = (anl<InputStream>)pack.a(ami.a, new aew(namespace, "labymod/ignored_files.json"));
            if (resource == null) {
                continue;
            }
