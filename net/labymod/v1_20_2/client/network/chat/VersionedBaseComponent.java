...
{
    public final ty holder;
    
    public VersionedBaseComponent(final ty holder) {
        this.holder = holder;
    }
    ...
    @Override
    public T copy() {
        return (T)((MutableComponentAccessor)this.holder.e()).getLabyComponent();
    }
    
    @Override
    public T style(final Style style) {
        this.holder.b((uh)style);
        return (T)this;
    }
    
    @Override
    public T append(final Component component) {
        this.holder.b((tl)((VersionedBaseComponent)component).holder);
        return (T)this;
    }
    ...
    public T setChildren(final Collection<Component> children) {
        ...
        for (final Component child : children) {
            if (child instanceof VersionedBaseComponent) {
                ...
                this.holder.b((tl)versionedChild.holder);
            }
        }
        return (T)this;
    }
