...
package net.labymod.v1_20_2.client.network.chat;

import net.labymod.api.client.component.Component;
import java.util.Objects;
import net.labymod.api.client.component.ComponentService;
import net.labymod.v1_20_2.client.network.chat.contents.LiteralContentsAccessor;
import net.labymod.api.client.component.TextComponent;

public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, tm> implements TextComponent
{
    private static final String EMPTY = "";
    private boolean empty;
    
    public VersionedTextComponent(final ty holder, final boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    public String getText() {
        ...
        final tm contents = ((VersionedBaseComponent<T, tm>)this).getContents();
        if (contents instanceof final uq literal) {
            return literal.a();
        }
    ...
    public TextComponent text(final String text) {
        if (this.empty) {
            ((MutableComponentAccessor)this.holder).setContents((tm)new uq(text));
            this.empty = false;
            return this;
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof VersionedBaseComponent)) {
            return obj instanceof ty && this.holder.equals(obj);
        }
