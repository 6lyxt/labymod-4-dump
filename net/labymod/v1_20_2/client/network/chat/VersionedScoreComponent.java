...
public class VersionedScoreComponent extends VersionedBaseComponent<ScoreComponent, tm> implements ScoreComponent
{
    public VersionedScoreComponent(final ty holder) {
        super(holder);
    }
    ...
    public String getName() {
        ...
        if (contents instanceof final us score) {
            return score.a();
        }
    ...
    public Component value() {
        ...
        if (level != null) {
            final eim scoreboard = level.I();
            final eij objective = scoreboard.b(this.getObjective());
            if (objective != null) {
                final String name = this.getName();
                if (scoreboard.b(name, objective)) {
                    final eil score = scoreboard.c(name, objective);
