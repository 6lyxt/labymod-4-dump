...
import net.labymod.v1_20_2.client.network.chat.contents.TranslatableContentsAccessor;
...
{
    public VersionedTranslatableComponent(final ty holder) {
        super(holder);
    }
    
    @Override
    public TranslatableComponent plainCopy() {
        return (TranslatableComponent)((MutableComponentAccessor)tl.b(this.getKey())).getLabyComponent();
    }
