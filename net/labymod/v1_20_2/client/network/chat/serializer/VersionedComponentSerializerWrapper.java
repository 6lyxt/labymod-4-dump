...
package net.labymod.v1_20_2.client.network.chat.serializer;
...
{
    private final tl.a serializer;
    
    public VersionedComponentSerializerWrapper() {
        this.serializer = new tl.a();
    }
    ...
    public JsonElement serialize(final Component src, final Type typeOfSrc, final JsonSerializationContext context) {
        final ty holder = ((VersionedBaseComponent)src).getHolder();
        return this.serializer.a((tl)holder, typeOfSrc, context);
    }
}
