...
public class VersionedKeybindComponent extends VersionedBaseComponent<KeybindComponent, tm> implements KeybindComponent
{
    public VersionedKeybindComponent(final ty holder) {
        super(holder);
    }
    ...
    public String getKeybind() {
        ...
        if (contents instanceof final uo keybind) {
            return keybind.a();
        }
