...
public class VersionedIconContents implements tm
{
    private Icon icon;
    private int width;
    private int height;
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final tp.a<T> consumer) {
        return consumer.accept(this.placeholder);
    }
    
    @NotNull
    public <T> Optional<T> a(@NotNull final tp.b<T> consumer, @NotNull final uh style) {
