...
public class DynamicStringRenderOutput extends esd.b
{
    public DynamicStringRenderOutput(final esd font, final foe bufferSource, final float x, final float y, final int color, final boolean shadow, final Matrix4f modelViewMatrix, final esd.a displayMode, final int packedLightCoords) {
