...
package net.labymod.v1_20_2.client.renderer.entity.layers;
...
public class VersionedShopItemLayer extends fxp<fnd, fgi<fnd>>
{
    private final fgi<fnd> playerModel;
    
    public VersionedShopItemLayer(final fvc<fnd, fgi<fnd>> layerParent) {
        super((fvc)layerParent);
        this.playerModel = (fgi<fnd>)layerParent.a();
    }
    
    public void render(@NotNull final elp poseStack, @NotNull final foe bufferSource, final int packedLight, @NotNull final fnd player, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch) {
