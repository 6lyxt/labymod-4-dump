...
public class LabyModRenderType extends fom
{
    private final RenderPhase phase;
    
    public LabyModRenderType(final RenderPhase phase) {
        final String name = phase.getName();
        final elu elu = phase.getVertexFormat().getMojangVertexFormat();
        final elu.b mode = getMode(phase.getMode());
        ...
        Objects.requireNonNull(phase);
        super(name, elu, mode, bufferSize, affectsCrumbling, sortOnUpload, runnable, phase::clear);
        this.phase = phase;
    }
    ...
    public static elu.b getMode(final int mode) {
        return switch (mode) {
            case 0,  4,  7 -> elu.b.h;
            case 1 -> elu.b.a;
            case 3 -> elu.b.d;
