...
package net.labymod.v1_20_2.client.gfx.pipeline.target;
...
{
    private final ekb renderTarget;
    
    public VersionedRenderTarget(final ekb renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final ekb renderTarget2 = this.renderTarget;
        ...
        final ekb renderTarget3 = this.renderTarget;
