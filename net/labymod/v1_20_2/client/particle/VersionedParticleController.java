...
package net.labymod.v1_20_2.client.particle;
...
public class VersionedParticleController implements ParticleController
{
    ...
    public void crackBlock(final FloatVector3 blockPosition, final Direction direction) {
        final gw position = new gw(MathHelper.ceil(blockPosition.getX()), MathHelper.ceil(blockPosition.getY()), MathHelper.ceil(blockPosition.getZ()));
        eqv.O().g.a(position, this.getMinecraftDirection(direction));
    }
