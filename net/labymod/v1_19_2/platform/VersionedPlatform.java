...
import net.labymod.v1_19_2.client.render.vertex.VersionedVertexFormat;
...
public class VersionedPlatform extends Platform
{
    public void onInitialization() {
        this.setMinecraft((Minecraft)efu.I());
    ...
    private void registerVertexFormats() {
        this.register(VertexFormatType.POSITION_COLOR, this.createFormat(eao.n, ezl::q));
        this.register(VertexFormatType.POSITION_TEXTURE_COLOR, this.createFormat(eao.s, ezl::t));
        this.register(VertexFormatType.POSITION_COLOR_NORMAL, this.createFormat(eao.o, ezl::aq));
        this.register(VertexFormatType.ENTITY, this.createFormat(eao.k, ezl::v));
        this.register(VertexFormatType.POSITION_COLOR_TEXTURE_LIGHTMAP, this.createFormat(eao.t, ezl::y));
    }
    ...
    @NotNull
    private OldVertexFormat createFormat(final eav format, final Supplier<fad> shaderSupplier) {
