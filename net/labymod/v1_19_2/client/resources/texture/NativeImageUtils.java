...
{
    public static dzq read(final ByteBuffer buffer) throws IOException {
        return dzq.a(buffer);
    }
    
    public static dzq read(final InputStream inputStream) throws IOException {
        return dzq.a(inputStream);
    }
    
    public static dzq asNativeImage(final BufferedImage image) {
        return asNativeImage(image, NativeImageUtils::processImage);
    }
    
    public static dzq asNativeImage(final BufferedImage image, final BufferedImageProcessor processor) {
        final dzq result = new dzq(image.getWidth(), image.getHeight(), true);
    ...
    public static void fillSubImage(final dzq source, final dzq destination, final int parentX, final int parentY, final int width, final int height) {
    ...
    public static BufferedImage asBufferedImage(final dzq image) {
