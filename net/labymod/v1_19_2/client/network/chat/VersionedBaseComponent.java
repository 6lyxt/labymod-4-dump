...
{
    public final sb holder;
    
    public VersionedBaseComponent(final sb holder) {
        this.holder = holder;
    }
    ...
    public T style(final Style style) {
        this.holder.b((sj)style);
        return (T)this;
    }
    
    @Override
    public T append(final Component component) {
        this.holder.b((rq)((VersionedBaseComponent)component).holder);
        return (T)this;
    }
    ...
    public T setChildren(final Collection<Component> children) {
        ...
        for (final Component child : children) {
            if (child instanceof VersionedBaseComponent) {
                ...
                this.holder.b((rq)versionedChild.holder);
            }
        }
        return (T)this;
    }
