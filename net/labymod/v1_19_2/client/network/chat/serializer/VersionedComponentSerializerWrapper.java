...
package net.labymod.v1_19_2.client.network.chat.serializer;
...
{
    private final rq.a serializer;
    
    public VersionedComponentSerializerWrapper() {
        this.serializer = new rq.a();
    }
    ...
    public JsonElement serialize(final Component src, final Type typeOfSrc, final JsonSerializationContext context) {
        final sb holder = ((VersionedBaseComponent)src).getHolder();
        return this.serializer.a((rq)holder, typeOfSrc, context);
    }
}
