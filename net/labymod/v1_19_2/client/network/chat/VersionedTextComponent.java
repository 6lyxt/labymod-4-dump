...
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, rr> implements TextComponent
{
    private static final String EMPTY = "";
    private boolean empty;
    
    public VersionedTextComponent(final sb holder, final boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    public String getText() {
        ...
        if (contents instanceof final ss literal) {
            return literal.a();
        }
    ...
    public TextComponent text(final String text) {
        if (this.empty) {
            ((MutableComponentAccessor)this.holder).setContents((rr)new ss(text));
            this.empty = false;
            return this;
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof VersionedBaseComponent)) {
            return obj instanceof sb && this.holder.equals(obj);
        }
