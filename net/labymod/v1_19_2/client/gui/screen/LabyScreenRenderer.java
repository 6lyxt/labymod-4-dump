...
package net.labymod.v1_19_2.client.gui.screen;
...
public class LabyScreenRenderer extends elm implements FileDropHandler, LabyScreenAccessor
{
    private final VanillaLabyScreen screen;
    
    public LabyScreenRenderer(final LabyScreen screen) {
        super((rq)Laby.labyAPI().minecraft().componentMapper().toMinecraftComponent(Component.empty()));
    ...
    public void a(@NotNull final eaq poseStack, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void a(final eaq poseStack) {
        final Stack stack = ((VanillaStackAccessor)poseStack).stack();
        ...
        final VanillaLabyScreen screen = this.screen;
        Objects.requireNonNull(screen);
        if (screenContext2.runInContextWithState(stack2, mouse2, tickDelta2, screen::renderBackground)) {
            return;
        }
        super.a(poseStack);
    }
    
    public void a(@NotNull final efu mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
