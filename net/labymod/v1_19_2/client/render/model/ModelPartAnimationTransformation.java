...
package net.labymod.v1_19_2.client.render.model;
...
{
    public ModelPartAnimationTransformation(final eue modelPart, final Transformation modelPartTransform) {
    ...
    {
        private final eue modelPart;
        private final FloatVector3 modelPartTranslation;
        
        public ModelPartPositionVector(final eue modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final eue modelPart) {
            this.modelPart = modelPart;
        }
