...
{
    private static final Supplier<fad> NULLABLE_SUPPLIER;
    private final eav vertexFormat;
    private final Supplier<fad> shaderSupplier;
    private final Collection<String> attributeNames;
    
    public VersionedVertexFormat(final eav format) {
        this(format, VersionedVertexFormat.NULLABLE_SUPPLIER);
    }
    
    public VersionedVertexFormat(final eav vertexFormat, final Supplier<fad> shaderSupplier) {
