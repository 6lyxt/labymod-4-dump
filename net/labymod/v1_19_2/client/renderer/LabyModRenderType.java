...
public class LabyModRenderType extends faa
{
    private final RenderPhase phase;
    
    public LabyModRenderType(final RenderPhase phase) {
        final String name = phase.getName();
        final eav eav = phase.getVertexFormat().getMojangVertexFormat();
        final eav.b mode = getMode(phase.getMode());
        ...
        Objects.requireNonNull(phase);
        super(name, eav, mode, bufferSize, affectsCrumbling, sortOnUpload, runnable, phase::clear);
        this.phase = phase;
    }
    ...
    public static eav.b getMode(final int mode) {
        return switch (mode) {
            case 0,  4,  7 -> eav.b.h;
            case 1 -> eav.b.a;
            case 3 -> eav.b.d;
