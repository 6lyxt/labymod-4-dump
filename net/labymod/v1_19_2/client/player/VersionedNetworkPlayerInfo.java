...
package net.labymod.v1_19_2.client.player;
...
{
    private final euz wrapped;
    private final Component usernameComponent;
    private Metadata metadata;
    
    public VersionedNetworkPlayerInfo(final euz wrapped) {
    ...
    public Component displayName() {
        final rq displayName = this.wrapped.n();
        if (displayName == null) {
    ...
    public GameMode gameMode() {
        if (this.wrapped.d() == null) {
            return GameMode.UNKNOWN;
        }
        return switch (this.wrapped.d()) {
    ...
    public euz getWrapped() {
        return this.wrapped;
    }
    
    private rq decorateComponent(@NotNull final euz info, final sb mutableComponent) {
        return (rq)((info.d() == cgu.d) ? mutableComponent.a(p.u) : mutableComponent);
    }
