...
public class VersionedIconContents implements rr
{
    private Icon icon;
    private int width;
    private int height;
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final ru.a<T> consumer) {
        return consumer.accept(this.placeholder);
    }
    
    @NotNull
    public <T> Optional<T> a(@NotNull final ru.b<T> consumer, @NotNull final sj style) {
