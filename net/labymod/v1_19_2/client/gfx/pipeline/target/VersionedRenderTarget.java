...
package net.labymod.v1_19_2.client.gfx.pipeline.target;
...
{
    private final dzc renderTarget;
    
    public VersionedRenderTarget(final dzc renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final dzc renderTarget2 = this.renderTarget;
        ...
        final dzc renderTarget3 = this.renderTarget;
