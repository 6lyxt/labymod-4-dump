...
package net.labymod.v1_19_2.client.font.component;
...
public class VersionedComponentMapper implements ComponentMapper
{
    ...
    public String getTranslationKeyOfComponent(final Object minecraftComponent) {
        if (minecraftComponent instanceof final rq component) {
            final rr contents = component.b();
            if (contents instanceof final sx sx) {
                return sx.a();
            }
        }
        return null;
