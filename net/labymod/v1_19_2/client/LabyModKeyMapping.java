...
package net.labymod.v1_19_2.client;
...
public class LabyModKeyMapping extends efs
{
    private static final Function<Hotkey, efs> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? dzk.b.c : dzk.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static efs create(final Hotkey hotkey) {
    ...
    public dzk.a h() {
        ...
        final dzk.b type = (key instanceof MouseButton) ? dzk.b.c : dzk.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final dzk.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == dzk.b.a || key.a() == dzk.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
