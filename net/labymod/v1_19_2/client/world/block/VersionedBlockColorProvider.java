...
import net.labymod.v1_19_2.client.world.LabyBiomeBlender;
...
public class VersionedBlockColorProvider implements BlockColorProvider
{
    ...
    public int getColor(final BlockState state) {
        final abb blockId = hm.V.b((Object)state.block());
    ...
    public int getColorMultiplier(final BlockState state, final int minX, final int minZ, final int maxX, final int maxZ) {
        ...
        return blockColors.a((cvo)state, (cga)this.biomeBlender.setLevel((cgx)level).setArea(minX, minZ, maxX, maxZ), this.toBlockPos(state.position()), 0);
    }
    
    private gt toBlockPos(final IntVector3 vec) {
