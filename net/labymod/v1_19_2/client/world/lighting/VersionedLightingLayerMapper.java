...
package net.labymod.v1_19_2.client.world.lighting;
...
public class VersionedLightingLayerMapper implements LightingLayerMapper
{
    ...
    public LightType fromMinecraft(final Object value) {
        if (value instanceof final chg lightLayer) {
        ...
        throw new IllegalArgumentException(value.getClass().getName() + " is not an instance of " + chg.class.getName());
    }
