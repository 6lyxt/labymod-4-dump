...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    @Final
    @Shadow
    private Map<String, qc> x;
    
    @Shadow
    public abstract qc a(final String p0, final qc p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract qc shadow$c(final String p0);
    ...
    @Shadow
    public abstract pj shadow$p(final String p0);
    
    @Shadow
    public abstract pp c(final String p0, final int p1);
