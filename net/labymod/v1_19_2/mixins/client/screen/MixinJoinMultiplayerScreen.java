...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final eaq param0, final eha param1, final rq param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final evb serverData, final InsertInfo ci) {
