...
package net.labymod.v1_19_2.mixins.client.screen.packs;

import java.util.stream.Collector;
import java.util.stream.Collectors;
import net.labymod.v1_19_2.client.resources.pack.ModifiedPackResources;
...
public class MixinPackSelectionModel
{
    ...
    private List<ahw> getAvailablePacks() {
        return this.a.c().stream().filter(pack -> !(pack.d() instanceof ModifiedPackResources)).collect((Collector<? super Object, ?, List<ahw>>)Collectors.toList());
    }
}
