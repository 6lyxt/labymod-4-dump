...
{
    @Shadow
    public abstract void a(final eha p0, final cax p1, final int p2, final int p3);
    
    @Shadow
    public abstract void c(final cax p0, final int p1, final int p2);
    ...
    public void renderItemStack(final Stack stack, final ItemStack itemStack, final int x, final int y, final boolean decorate, final float alpha) {
        final cax minecraftItemStack = MinecraftUtil.toMinecraft(itemStack);
        final eaq minecraftModelViewStack = RenderSystem.getModelViewStack();
        ...
        if (decorate) {
            this.a(efu.I().h, minecraftItemStack, x, y);
        }
        modelViewStack.pop();
        RenderSystem.applyModelViewMatrix();
    }
