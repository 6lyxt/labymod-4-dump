...
public class MixinCapeLayer
{
    ...
    private eyt labyMod$player;
    private faa labyMod$renderType;
    ...
    private void labyMod$firePreCapeRenderEvent(final eaq poseStack, final ezs param1, final int param2, final eyt player, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
    ...
    private void labyMod$firePostCapeRenderEvent(final eaq poseStack, final ezs param1, final int param2, final eyt player, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
        this.labyMod$fireCapeRenderEvent(poseStack, player, Phase.POST);
    }
    
    @WrapOperation(method = { "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V" }, at = { @At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/RenderType;entitySolid(Lnet/minecraft/resources/ResourceLocation;)Lnet/minecraft/client/renderer/RenderType;") })
    private faa labyMod$attach(final abb location, final Operation<faa> original) {
        return this.labyMod$renderType = (faa)original.call(new Object[] { location });
    }
    
    @Insert(method = { "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/client/player/AbstractClientPlayer;FFFFFF)V" }, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/model/PlayerModel;renderCloak(Lcom/mojang/blaze3d/vertex/PoseStack;Lcom/mojang/blaze3d/vertex/VertexConsumer;II)V", shift = At.Shift.AFTER))
    private void labyMod$renderCapeParticles(final eaq param0, final ezs param1, final int param2, final eyt player, final float param4, final float param5, final float partialTicks, final float param7, final float param8, final float param9, final InsertInfo ci) {
    ...
    private boolean labyMod$fireCapeRenderEvent(final eaq poseStack, final eyt clientPlayer, final Phase phase) {
        final Player player = (Player)clientPlayer;
        final PlayerModel playerModel = (PlayerModel)((fis)this).c();
