...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final ezo renderer, final bcc livingEntity, final cax itemStack, final fay.b type, final boolean leftHand, final eaq poseStack, final ezs bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final bcc livingEntity, final cax itemStack, final fay.b type, final boolean leftHand, final int combinedLight) {
