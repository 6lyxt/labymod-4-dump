...
package net.labymod.v1_19_2.mixins.client.renderer.shader;
...
import net.labymod.v1_19_2.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final eag shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (fad)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final eag shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (fad)this);
    }
