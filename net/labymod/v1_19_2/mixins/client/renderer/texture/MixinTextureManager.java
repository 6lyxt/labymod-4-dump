...
package net.labymod.v1_19_2.mixins.client.renderer.texture;
...
public abstract class MixinTextureManager implements GameTextureManager
{
    ...
    @Final
    @Mutable
    private Map<abb, fjs> c;
    
    @Shadow
    public abstract void a(final abb p0, final fjs p1);
    ...
    public void registerAndRelease(final ResourceLocation location, final Object texture) {
        if (texture instanceof final fjs textureObject) {
            final fjs currentTexture = this.c.get(location);
            this.a((abb)location, textureObject);
    ...
    public void labyMod$deleteTexture(final abb location, final InsertInfo callback) {
