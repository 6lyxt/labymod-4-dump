...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    @Nullable
    public abstract rv shadow$i();
    
    @Shadow
    public abstract sj a(@Nullable final rv p0);
    
    @Shadow
    @Nullable
    public abstract ro shadow$h();
    
    @Shadow
    public abstract sj a(@Nullable final ro p0);
    
    @Shadow
    public abstract sj a(@Nullable final sl p0);
    
    @Shadow
    @Nullable
    public abstract sl shadow$a();
    ...
    @Shadow
    public abstract sj a(@Nullable final Boolean p0);
    
    @Shadow
    public abstract sj b(@Nullable final Boolean p0);
    
    @Shadow
    public abstract sj c(@Nullable final Boolean p0);
    
    @Shadow
    public abstract sj d(@Nullable final Boolean p0);
    
    @Shadow
    public abstract sj e(@Nullable final Boolean p0);
    
    @Shadow
    public abstract abb shadow$k();
    
    @Shadow
    public abstract sj a(@Nullable final abb p0);
    
    @Shadow
    public abstract sj a(@Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((rv)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((ro)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final abb resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, sj> setter) {
