...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final eaq poseStack, final int screenWidth, final dxo scoreboard, final dxl objective, final InsertInfo ci) {
