...
public abstract class MixinEditBox extends MixinAbstractWidget implements EditBoxAccessor
{
    ...
    @Override
    public void render(final eaq poseStack, final int mouseX, final int mouseY, final float partialTicks, final InsertInfo ci) {
        this.labyMod$poseStack = poseStack;
        this.getWatcher().update(this, ((ehn)this).k());
    ...
    private void labyMod$editBoxMouseClicked(final double mouseX, final double mouseY, final int button, final CallbackInfoReturnable<Boolean> cir) {
        ...
        final int x = ((ehx)this).m;
        final int y = ((ehx)this).n;
        final int width = ((ehx)this).j();
        final int height = ((ehx)this).h();
