...
public abstract class MixinAbstractWidget<K extends AbstractWidget<?>> implements ConvertableMinecraftWidget<K>, AbstractWidgetAccessor
{
    ...
    public void render(final eaq stack, final int mouseX, final int mouseY, final float partialTicks, final InsertInfo ci) {
    ...
    private void labyMod$playCustomDownSound(final fnz soundManager, final CallbackInfo ci) {
        final K widget = this.labyMod$watcher.getWidget();
