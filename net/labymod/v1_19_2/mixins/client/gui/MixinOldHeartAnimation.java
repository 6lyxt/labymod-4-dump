...
public class MixinOldHeartAnimation
{
    ...
    private void labyMod$applyOldHeartAnimation(final ehb instance, final eaq poseStack, final int i0, final int i1, int i2, final int i3, final int i4, final int i5, final Operation<Void> original) {
