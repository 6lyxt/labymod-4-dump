...
package net.labymod.v1_19_2.mixins.client.resources;
...
public abstract class MixinResourceLocation implements ResourceLocation
{
    ...
    public InputStream openStream() throws IOException {
        ...
        return efu.I().S().getResource((abb)this.getMinecraftLocation()).orElseThrow(IOException::new).b();
    }
    
    @Override
    public boolean exists() {
        return ResourcesUtil.hasResource(this.getMinecraftLocation()) || efu.I().S().getResource((abb)this.getMinecraftLocation()).isPresent();
    }
