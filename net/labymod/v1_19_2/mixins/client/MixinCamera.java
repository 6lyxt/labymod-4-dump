...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final dwq position = this.b();
        this.labymod$cameraPosition.set((float)position.a(gy.a.a), (float)position.a(gy.a.b), (float)position.a(gy.a.c));
    ...
    public DoubleVector3 position() {
        final dwq position = this.b();
        this.labyMod$position.set(position.a(gy.a.a), position.a(gy.a.b), position.a(gy.a.c));
