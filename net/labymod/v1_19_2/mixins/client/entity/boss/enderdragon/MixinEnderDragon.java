...
package net.labymod.v1_19_2.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_19_2.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final bbr<? extends bpp> type, final cgx level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final bpn part : this.cj) {
