...
package net.labymod.v1_19_2.mixins.client.world.phys;
...
public abstract class MixinHitResult implements HitResult
{
    ...
    private void labyMod$createApiVector(final dwq vector, final InsertInfo info) {
    ...
    protected HitType labyMod$getHitType(final dwo.a type) {
        switch (type) {
            case a: {
                return HitType.MISS;
            }
