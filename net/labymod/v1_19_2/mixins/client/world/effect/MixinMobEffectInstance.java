...
package net.labymod.v1_19_2.mixins.client.world.effect;
...
public abstract class MixinMobEffectInstance implements PotionEffect
{
    ...
    @Final
    private bbe b;
    private fke labyMod$iconSprite;
    ...
    @Override
    public Icon getIcon() {
        final fke sprite = this.labyMod$cacheIcon();
        if (sprite == null) {
            return null;
        }
        final abb location = sprite.m().g();
    ...
    public void renderIcon(final Stack stack, final int x, final int y, final int width, final int height) {
        ...
        ehc.a((eaq)poseStackObject, x, y, 0, width, height, sprite);
    }
    ...
    private fke labyMod$cacheIcon() {
        if (this.labyMod$iconSprite != null) {
            return this.labyMod$iconSprite;
        }
        final abb resourceLocation = hm.U.b((Object)this.b);
        if (resourceLocation == null) {
            return null;
        }
        return this.labyMod$iconSprite = efu.I().ay().a(this.b);
    }
}
