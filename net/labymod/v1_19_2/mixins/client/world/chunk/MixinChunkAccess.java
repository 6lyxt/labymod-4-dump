...
package net.labymod.v1_19_2.mixins.client.world.chunk;
...
public abstract class MixinChunkAccess implements Chunk
{
    ...
    @Shadow
    @Final
    protected Map<gt, cti> i;
    
    @Shadow
    public abstract dar a(final dar.a p0);
    
    @Shadow
    public abstract cxu b(final int p0);
    
    @Shadow
    public abstract cxu[] d();
    ...
    public Heightmap heightmap(final HeightmapType type) {
        ...
        return (Heightmap)this.a(dar.a.b);
    }
    ...
    public BlockState getBlockState(final int x, final int y, final int z) {
        final int index = ((cxj)this).e(y);
        if (index < 0 || index >= this.k.length) {
            return (BlockState)cju.a.m();
        }
        final cxu section = this.k[index];
        if (section == null) {
            return (BlockState)cju.a.m();
        }
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (final Map.Entry<gt, cti> entry : this.i.entrySet()) {
    ...
    public int getHeightBasedOnSection(final int startY) {
        ...
        for (int index = startSectionIndex; index < sections.length; ++index) {
            final cxu section = sections[index];
            if (section != null) {
                if (!section.c()) {
