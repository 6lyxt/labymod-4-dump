...
import net.labymod.v1_19_2.client.gui.WrappedIntRangeBase;
import net.labymod.api.util.StringUtil;
import org.spongepowered.asm.mixin.Final;
import org.spongepowered.asm.mixin.Shadow;
import org.jetbrains.annotations.Nullable;
import org.spongepowered.asm.mixin.Mixin;
import net.labymod.v1_19_2.mixins.client.gui.components.MixinAbstractSliderButton;

@Mixin({ efx.i.class })
public class MixinOptionInstanceSliderButton<T> extends MixinAbstractSliderButton
{
    @Nullable
    private efx.g labyMod$wrappedIntRangeBase;
    @Shadow
    @Final
    private efx.k<T> d;
    ...
    private efx.g labyMod$createWrappedIntRangeBase() {
        ...
        if (efx.g.class.isAssignableFrom(cls)) {
            return (efx.g)new WrappedIntRangeBase((efx.g)this.d);
        }
        return null;
    }
}
