...
public class MixinBlockEntityUpdateEvent
{
    ...
    private void labyMod$fireTileEntityPreLoadEvent(final pj tag, final InsertInfo ci) {
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final cgx level, final gt pos, final cvo state, final InsertInfo ci) {
        final cti blockEntity = level.c_(pos);
