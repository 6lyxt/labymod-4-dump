...
import net.labymod.v1_19_2.client.resources.pack.ModifiedRepositorySource;
...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selectedResources, final CallbackInfoReturnable<List<ahw>> cir) {
        final List<ahw> selectedPacks = (List<ahw>)cir.getReturnValue();
