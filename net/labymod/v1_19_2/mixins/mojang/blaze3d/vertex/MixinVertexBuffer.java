...
package net.labymod.v1_19_2.mixins.mojang.blaze3d.vertex;
...
public class MixinVertexBuffer
{
    ...
    private void labyMod$applyShaderInstance(final fad shaderInstance) {
    ...
    private void labyMod$clearShaderInstance(final fad shaderInstance) {
        final DefaultShaderProgramApplier program_APPLIER = MixinVertexBuffer.PROGRAM_APPLIER;
        Objects.requireNonNull(shaderInstance);
