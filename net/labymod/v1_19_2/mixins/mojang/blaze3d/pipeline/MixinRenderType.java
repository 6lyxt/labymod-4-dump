...
package net.labymod.v1_19_2.mixins.mojang.blaze3d.pipeline;
...
@Mixin({ faa.class })
public abstract class MixinRenderType extends ezz implements Blaze3DRenderType
{
    ...
    @Shadow
    public abstract void a(final eal p0, final int p1, final int p2, final int p3);
