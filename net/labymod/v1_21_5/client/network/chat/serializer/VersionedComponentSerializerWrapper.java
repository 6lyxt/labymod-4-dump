...
{
    private final xg.b serializerAdapter;
    
    public VersionedComponentSerializerWrapper() {
        this.serializerAdapter = new xg.b((ji.a)ju.b);
    }
    ...
    public JsonElement serialize(final Component src, final Type typeOfSrc, final JsonSerializationContext context) {
        final xu holder = ((VersionedBaseComponent)src).getHolder();
        return this.serializerAdapter.a((xg)holder, typeOfSrc, context);
    }
}
