...
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, xh> implements TextComponent
{
    ...
    public VersionedTextComponent(final xu holder, final boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    public String getText() {
        ...
        if (contents instanceof final yn.a literal) {
            return literal.b();
        }
    ...
    public TextComponent text(final String text) {
        if (this.empty) {
            ((MutableComponentAccessor)this.holder).setContents((xh)new yn.a(text));
            this.empty = false;
            return this;
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof VersionedBaseComponent)) {
            return obj instanceof xu && this.holder.equals(obj);
        }
