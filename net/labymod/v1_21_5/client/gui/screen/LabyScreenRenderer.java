...
public class LabyScreenRenderer extends fzq implements FileDropHandler, LabyScreenAccessor
{
    ...
    public void a(@NotNull final ftk graphics, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(final ftk graphics, final int mouseX, final int mouseY, final float tickDelta) {
        final Stack stack = ((VanillaStackAccessor)graphics.c()).stack();
    ...
    public void a(@NotNull final fqq mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
