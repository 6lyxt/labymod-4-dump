...
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<fwd, AbstractWidget<?>>
{
    ...
    @Override
    public void update(final fwd source, final AbstractWidget<?> destination) {
        final TabNavigationBarAccessor accessor = (TabNavigationBarAccessor)source;
        final fwc tabManager = accessor.getTabManager();
