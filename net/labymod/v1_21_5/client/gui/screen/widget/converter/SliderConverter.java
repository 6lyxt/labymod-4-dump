...
public class SliderConverter extends AbstractMinecraftWidgetConverter<ftt, SliderWidget>
{
    ...
    @Override
    public SliderWidget createDefault(final ftt source) {
    ...
    @Override
    public void update(final ftt source, final SliderWidget destination) {
    ...
    @Override
    public String getWidgetId(final ftt source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.B());
    }
    
    @Override
    public List<String> getWidgetIds(final ftt source) {
