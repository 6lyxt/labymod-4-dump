...
public class TextFieldConverter extends AbstractMinecraftWidgetConverter<fuh, TextFieldWidget>
{
    ...
    @Override
    public TextFieldWidget createDefault(final fuh source) {
    ...
    @Override
    public void update(final fuh source, final TextFieldWidget destination) {
