...
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.ShaderProgramStateStorage;
import net.labymod.api.thirdparty.optifine.OptiFine;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.TextureStateStorage;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.FogStateStorage;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.ColorLogicStateStorage;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.PolygonOffsetStateStorage;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.ScissorStateStorage;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.CullStateStorage;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.DepthStateStorage;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.ColorMaskStateStorage;
import net.labymod.core.client.gfx.pipeline.state.StateStorage;
import com.mojang.blaze3d.opengl.GlStateManager;
import net.labymod.v1_21_5.generated.client.gfx.pipeline.state.BlendStateStorage;
...
public final class VersionedBlaze3DGlStatePipeline extends AbstractBlaze3DGlStatePipeline implements Blaze3DGlStatePipeline
{
    ...
    private static final Stack MODE_VIEW_STACK;
    ...
    public VersionedBlaze3DGlStatePipeline() {
        ...
        final GlStateManager.i[] textures = GlStateManager.TEXTURES;
    ...
    public Stack getModelViewStack() {
        return VersionedBlaze3DGlStatePipeline.MODE_VIEW_STACK;
    }
    ...
    public void enableLightMap() {
        ...
        fqq.Q().j.l().d();
        final GpuTexture texture = RenderSystem.getShaderTexture(2);
        ShaderTextures.setShaderTexture(2, MinecraftUtil.getGpuTextureId(texture));
    ...
    public void blendFunc(final int sourceRGB, final int destinationRGB) {
        GL11.glBlendFunc(sourceRGB, destinationRGB);
    }
    ...
    @Override
    public void bindTexture(final TextureId id) {
        GlStateManager._bindTexture(id.getId());
        RenderSystem.setShaderTexture(this.getActiveTexture() - 33984, (GpuTexture)id.getData());
    }
    ...
    public void setupFlatLighting(final Runnable runnable) {
        final Vector3f diffuseLight0 = RenderSystem.shaderLightDirections[0];
        final Vector3f diffuseLight2 = RenderSystem.shaderLightDirections[1];
        try {
    ...
    static {
        DIFFUSE_LIGHT_0 = new Vector3f(0.0f, 0.0f, 0.2f).normalize();
        DIFFUSE_LIGHT_1 = new Vector3f(0.2f, 0.0f, 0.0f).normalize();
        MODE_VIEW_STACK = Stack.create(new JomlStackProvider(RenderSystem.getModelViewStack()));
    }
}
