...
{
    public ModelPartAnimationTransformation(final gkr modelPart, final Transformation modelPartTransform) {
    ...
    private static class ModelPartPositionVector extends FloatVector3
    {
        ...
        public ModelPartPositionVector(final gkr modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final gkr modelPart) {
            this.modelPart = modelPart;
        }
    ...
    private static class ModelPartScaleVector extends FloatVector3
    {
        ...
        public ModelPartScaleVector(final gkr modelPart) {
            this.modelPart = modelPart;
        }
