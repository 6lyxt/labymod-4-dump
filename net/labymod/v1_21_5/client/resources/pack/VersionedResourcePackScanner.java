...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner
{
    ...
    private boolean isExternalPack(final aua pack) {
    ...
    private IncompatibleResourcePack scanPack(final aua pack) {
    ...
    private void scanPack(final aua pack, final String baseDirectory, final aua.a output) {
        pack.a(auc.a, "minecraft", baseDirectory, output);
    }
    
    private Collection<String> collectIgnoredFiles(final aua pack) {
        final Set<String> ignoredFiles = new HashSet<String>();
        for (final String namespace : pack.a(auc.a)) {
            final avg<InputStream> resource = (avg<InputStream>)pack.a(auc.a, alr.a(namespace, "labymod/ignored_files.json"));
            if (resource == null) {
                continue;
            }
