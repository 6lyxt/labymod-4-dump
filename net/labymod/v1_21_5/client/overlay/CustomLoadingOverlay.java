...
public class CustomLoadingOverlay extends fzg
{
    ...
    public CustomLoadingOverlay(final fqq minecraft, final avk reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final ftk gui, final int mouseX, final int mouseY, final float partialTicks) {
        final fki window = this.minecraft.aO();
