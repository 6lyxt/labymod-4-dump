...
public class VersionedIconContents implements xh
{
    ...
    private static final xh.a<VersionedIconContents> TYPE;
    private Icon icon;
    private int width;
    private int height;
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final xl.a<T> consumer) {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final xl.b<T> consumer, @NotNull final yd style) {
    ...
    static {
        ...
        TYPE = new xh.a((MapCodec)VersionedIconContents.CODEC, "icon");
    }
}
