...
{
    private static final Function<Hotkey, fqo> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? fka.b.c : fka.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static fqo create(final Hotkey hotkey) {
    ...
    public fka.a i() {
        ...
        final fka.b type = (key instanceof MouseButton) ? fka.b.c : fka.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final fka.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == fka.b.a || key.a() == fka.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
