...
{
    private grb parameters;
    
    public FogStateStorage() {
        this.parameters = grb.a;
    }
    ...
    public FogStateStorage copy() {
        ...
        newObject.parameters = new grb(this.parameters.a(), this.parameters.b(), this.parameters.c(), this.parameters.d(), this.parameters.e(), this.parameters.f(), this.parameters.g());
        return newObject;
    }
