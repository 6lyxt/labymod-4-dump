...
public class MixinClientHandshakePacketListener
{
    ...
    public vx labyMod$fireServerKickEvent(final vx details) {
        ...
        final xg newReason = (xg)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(details.a()), ServerKickEvent.Context.LOGIN)).reason());
