...
package net.labymod.v1_21_5.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_21_5.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final bxn<? extends cng> type, final dkj level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final cnd part : this.bS) {
