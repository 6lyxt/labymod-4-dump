...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final fzq instance, final ftk graphics, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
