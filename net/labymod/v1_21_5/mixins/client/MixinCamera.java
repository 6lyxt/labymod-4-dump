...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final fgc position = this.b();
        this.labymod$cameraPosition.set((float)position.a(jc.a.a), (float)position.a(jc.a.b), (float)position.a(jc.a.c));
    ...
    public DoubleVector3 position() {
        final fgc position = this.b();
        this.labyMod$position.set(position.a(jc.a.a), position.a(jc.a.b), position.a(jc.a.c));
    ...
    public Quaternion rotation() {
        ...
        this.labymod$rotation.multiply(FloatVector3.YP.rotationDegrees(-this.o));
        this.labymod$rotation.multiply(FloatVector3.XP.rotationDegrees(this.n));
