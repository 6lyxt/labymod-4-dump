...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final ftk param0, final fti param1, final xg param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final gmd serverData, final InsertInfo ci) {
