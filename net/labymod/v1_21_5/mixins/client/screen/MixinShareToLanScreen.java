...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final hpb server, final fty button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final hpb server, final fty button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
