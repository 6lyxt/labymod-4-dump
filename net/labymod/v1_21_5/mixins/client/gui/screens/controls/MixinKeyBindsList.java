...
@Mixin({ gdc.class })
public abstract class MixinKeyBindsList extends fue<gdc.b>
{
    public MixinKeyBindsList(final fqq $$0, final int $$1, final int $$2, final int $$3, final int $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    
    @Redirect(method = { "<init>" }, at = @At(value = "FIELD", target = "Lnet/minecraft/client/Options;keyMappings:[Lnet/minecraft/client/KeyMapping;"))
    private fqo[] labyMod$addCustomKeybindings(final fqu instance) {
        final List<fqo> keyMappings = new ArrayList<fqo>(Arrays.asList(instance.V));
        ...
        return keyMappings.toArray(new fqo[0]);
    }
}
