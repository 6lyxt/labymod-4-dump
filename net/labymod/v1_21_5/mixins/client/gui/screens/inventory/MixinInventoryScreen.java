...
@Mixin({ gbg.class })
public abstract class MixinInventoryScreen extends gaf<cxe>
{
    private InventorySlotRegistry labyMod$inventorySlotRegistry;
    private boolean labyMod$oldSurvivalLayoutTexture;
    
    public MixinInventoryScreen(final cxe param0, final csh param1, final xg param2) {
        super((cwb)param0, param1, param2);
    }
    ...
    private void labyMod$init(final InsertInfo info) {
        ...
        for (final cxz slot : ((cxe)this.F()).k) {
    ...
    private void labyMod$setOldSurvivalLayoutTexture(final ftk graphics, final Function<alr, gry> renderTypeMapper, alr location, final int $$1, final int $$2, final float $$3, final float $$4, final int $$5, final int $$6, final int $$7, final int $$8) {
    ...
    @NotNull
    private cxz getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final cxz slot) {
