...
public abstract class MixinAbstractScrollArea extends ftw
{
    ...
    public MixinAbstractScrollArea(final int $$0, final int $$1, final int $$2, final int $$3, final xg $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private boolean labyMod$render(final ftr instance, final Operation<Boolean> original) {
