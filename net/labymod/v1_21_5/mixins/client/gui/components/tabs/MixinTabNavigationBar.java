...
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fvt implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor
{
    ...
    private final Map<fwb, VersionedTab> versionedTabs;
    @Shadow
    @Final
    ...
    public MixinTabNavigationBar() {
        ...
        this.versionedTabs = new HashMap<fwb, VersionedTab>();
    }
    ...
    public VersionedTab versionedTabOf(final fwb tab) {
