...
public interface MixinGuiEventListener
{
    ...
    @Overwrite
    default boolean a(final double mouseX, final double mouseY, final double scrollDeltaX, final double scrollDeltaY) {
        return this.handleConvertedWidget((converter, widget) -> this.minecraft().updateMouse(mouseX, mouseY, mouse -> converter.mouseScrolled(widget, mouse, scrollDeltaY)));
    }
    ...
    @Overwrite
    default boolean c(final int keyCode, final int param1, final int param2) {
        return this.handleConvertedWidget((converter, widget) -> {
