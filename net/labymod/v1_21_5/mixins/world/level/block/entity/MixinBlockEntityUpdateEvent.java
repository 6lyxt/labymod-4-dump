...
public class MixinBlockEntityUpdateEvent
{
    ...
    private void labyMod$fireTileEntityPreLoadEvent(final ua tag, final ji.a provider, final InsertInfo ci) {
        Laby.fireEvent(new BlockEntityPreLoadEvent((BlockEntity)this, CastUtil.cast(tag)));
    }
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final dkj level, final iw pos, final ebq state, final InsertInfo ci) {
        final dyo blockEntity = level.c_(pos);
