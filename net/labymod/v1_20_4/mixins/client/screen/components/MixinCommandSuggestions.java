...
public class MixinCommandSuggestions implements CommandSuggestionsAccessor
{
    ...
    private void labyMod$modifyBackgroundPosition(final ewu graphics, final int left, final int top, final int right, final int bottom, final int color) {
    ...
    private int labyMod$modifyTextPosition(final ewu graphics, final ews font, final aua text, final int x, final int y, final int color) {
