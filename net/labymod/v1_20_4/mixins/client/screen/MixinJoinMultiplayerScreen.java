...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final ewu param0, final ews param1, final vf param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final fod serverData, final InsertInfo ci) {
