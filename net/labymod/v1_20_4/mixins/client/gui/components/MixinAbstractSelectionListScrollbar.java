...
public abstract class MixinAbstractSelectionListScrollbar extends ewy
{
    ...
    public MixinAbstractSelectionListScrollbar(final int $$0, final int $$1, final int $$2, final int $$3, final vf $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    ...
    private int labyMod$render(final exb instance) {
        ...
        final int x = this.c();
        final Bounds scrollBar = new PositionedBounds((float)x, (float)this.C(), (float)(x + 6), (float)this.E());
        ...
        int scrolled = (int)this.o() * ((int)scrollBarHeight - scrollButtonHeight) / maxScroll;
        if (scrolled < 0) {
            scrolled = 0;
        }
