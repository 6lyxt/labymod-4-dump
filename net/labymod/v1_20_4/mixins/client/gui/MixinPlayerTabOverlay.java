...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final ewu graphics, final int screenWidth, final emx scoreboard, final emp objective, final InsertInfo ci) {
