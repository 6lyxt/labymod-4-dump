...
public class MixinConnectScreenThread
{
    ...
    private Optional<fpe> labyMod$resolveAddress(final fph resolver, final fpf address) {
    ...
    public vf labyMod$fireServerKickEvent(final vf reason) {
        ...
        return (vf)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN)).reason());
    }
}
