...
@Mixin({ fdu.class })
public abstract class MixinKeyBindsList extends exm<fdu.b>
{
    public MixinKeyBindsList(final evi $$0, final int $$1, final int $$2, final int $$3, final int $$4) {
        super($$0, $$1, $$2, $$3, $$4);
    }
    
    @Redirect(method = { "<init>" }, at = @At(value = "FIELD", target = "Lnet/minecraft/client/Options;keyMappings:[Lnet/minecraft/client/KeyMapping;"))
    private evg[] labyMod$addCustomKeybindings(final evm instance) {
        final List<evg> keyMappings = new ArrayList<evg>(Arrays.asList(instance.X));
        ...
        return keyMappings.toArray(new evg[0]);
    }
}
