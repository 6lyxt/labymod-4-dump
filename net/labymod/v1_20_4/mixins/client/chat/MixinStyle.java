...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract wc a(@Nullable final vl p0);
    ...
    @Shadow
    public abstract wc a(@Nullable final vd p0);
    
    @Shadow
    public abstract wc a(@Nullable final we p0);
    ...
    @Shadow
    public abstract wc a(@Nullable final Boolean p0);
    
    @Shadow
    public abstract wc b(@Nullable final Boolean p0);
    
    @Shadow
    public abstract wc c(@Nullable final Boolean p0);
    
    @Shadow
    public abstract wc d(@Nullable final Boolean p0);
    
    @Shadow
    public abstract wc e(@Nullable final Boolean p0);
    
    @Shadow
    public abstract ahg shadow$k();
    
    @Shadow
    public abstract wc a(@Nullable final ahg p0);
    
    @Shadow
    public abstract wc a(@Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((vl)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((vd)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final ahg resourceLocation = this.shadow$k();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, wc> setter) {
