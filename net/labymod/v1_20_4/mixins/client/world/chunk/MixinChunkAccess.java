...
public abstract class MixinChunkAccess implements Chunk
{
    ...
    @Shadow
    public abstract doq a(final doq.a p0);
    
    @Shadow
    public abstract dlp b(final int p0);
    ...
    public Heightmap heightmap(final HeightmapType type) {
        ...
        return (Heightmap)this.a(doq.a.b);
    }
    ...
    public BlockState getBlockState(final int x, final int y, final int z) {
        final int index = ((dld)this).e(y);
        if (index < 0 || index >= this.m.length) {
            return (BlockState)cws.a.o();
        }
        final dlp section = this.m[index];
        if (section == null) {
            return (BlockState)cws.a.o();
        }
    ...
    public BlockEntity[] getBlockEntities() {
        ...
        int index = 0;
        for (final Map.Entry<hx, dgv> entry : this.k.entrySet()) {
    ...
    public int getHeightBasedOnSection(final int startY) {
        final dlp[] sections = this.d();
        if (sections.length == 0) {
            return 0;
        }
        final int bottomY = this.J_();
        ...
        for (int index = startSectionIndex; index < sections.length; ++index) {
            final dlp section = sections[index];
            if (section != null) {
                if (!section.c()) {
