...
public abstract class MixinResourceLocation implements ResourceLocation
{
    ...
    public InputStream openStream() throws IOException {
        ...
        return evi.O().Z().getResource((ahg)this.getMinecraftLocation()).orElseThrow(IOException::new).d();
    }
    
    @Override
    public boolean exists() {
        return ResourcesUtil.hasResource(this.getMinecraftLocation()) || evi.O().Z().getResource((ahg)this.getMinecraftLocation()).isPresent();
    }
