...
package net.labymod.v1_20_4.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_20_4.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final blz<? extends cao> type, final ctp level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final cam part : this.cf) {
