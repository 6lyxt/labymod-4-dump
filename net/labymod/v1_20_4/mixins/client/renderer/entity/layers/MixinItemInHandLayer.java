...
public class MixinItemInHandLayer
{
    ...
    private void labyMod$callItemInHandLayerRenderEvent(final ftd renderer, final bml livingEntity, final cmy itemStack, final cmv type, final boolean leftHand, final eqb poseStack, final fth bufferSource, final int combinedLight) {
    ...
    private ItemInHandLayerRenderEvent labyMod$fireItemInHandLayerRenderEvent(final Phase phase, final bml livingEntity, final cmy itemStack, final cmv type, final boolean leftHand, final int combinedLight) {
