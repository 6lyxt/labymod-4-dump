...
package net.labymod.v1_20_4.mixins.client.renderer.shader;
...
import net.labymod.v1_20_4.client.renderer.ShaderInstanceExtension;
...
public abstract class MixinShaderInstance
{
    ...
    private void labyMod$registerCustomUniform(final epr shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (ftv)this);
    }
    ...
    @Dynamic
    private void labyMod$optifine$registerCustomUniform(final epr shader) {
        this.labyMod$shaderInstanceExtension.registerCustomUniform(shader, (ftv)this);
    }
