...
public class MixinClientHandshakePacketListener
{
    ...
    public vf labyMod$fireServerKickEvent(final vf reason) {
        ...
        return (vf)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.LOGIN)).reason());
    }
}
