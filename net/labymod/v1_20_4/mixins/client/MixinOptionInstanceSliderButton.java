...
{
    @Nullable
    private evl.g labyMod$wrappedIntRangeBase;
    @Shadow
    @Final
    private evl.k<T> e;
    ...
    private evl.g labyMod$createWrappedIntRangeBase() {
        ...
        if (evl.g.class.isAssignableFrom(cls)) {
            return (evl.g)new WrappedIntRangeBase((evl.g)this.e);
        }
        return null;
    }
}
