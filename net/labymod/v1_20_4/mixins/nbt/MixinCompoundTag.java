...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    ...
    @Shadow
    public abstract tk a(final String p0, final tk p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract tk shadow$c(final String p0);
    ...
    @Shadow
    public abstract sn shadow$p(final String p0);
    
    @Shadow
    public abstract st c(final String p0, final int p1);
