...
package net.labymod.v1_20_4.mixins.mojang.blaze3d.vertex;
...
public class MixinVertexBuffer
{
    ...
    private void labyMod$applyShaderInstance(final ftv shaderInstance) {
    ...
    private void labyMod$clearShaderInstance(final ftv shaderInstance) {
        final DefaultShaderProgramApplier program_APPLIER = MixinVertexBuffer.PROGRAM_APPLIER;
        Objects.requireNonNull(shaderInstance);
