...
@Mixin({ ftp.class })
public abstract class MixinRenderType extends fto implements Blaze3DRenderType
{
    @Shadow
    public abstract void a(final epw p0, final eqj p1);
    ...
    public void draw(final BufferConsumer consumer, final int cameraX, final int cameraY, final int cameraZ) {
        if (consumer instanceof final epw bufferBuilder) {
            this.a(bufferBuilder, eqj.a((float)cameraX, (float)cameraY, (float)cameraZ));
            return;
        }
