...
public class MixinConnection
{
    ...
    public vf labyMod$modifyReason(final vf component) {
        ...
        return (vf)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY)).reason());
    }
}
