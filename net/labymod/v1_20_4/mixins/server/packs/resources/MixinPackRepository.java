...
public class MixinPackRepository
{
    ...
    private void labyMod$rebuildSelected(final Collection<String> selected, final CallbackInfoReturnable<List<apq>> cir) {
        final List<apq> selectedPacks = (List<apq>)cir.getReturnValue();
