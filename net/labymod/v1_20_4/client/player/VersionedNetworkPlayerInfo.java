...
public class VersionedNetworkPlayerInfo extends DefaultNetworkPlayerInfo
{
    ...
    public VersionedNetworkPlayerInfo(final fob wrapped) {
    ...
    public Component displayName() {
        final vf displayName = this.wrapped.i();
        if (displayName == null) {
    ...
    public boolean isListed() {
        ...
        return connection == null || connection.n().contains(this.wrapped);
    }
    ...
    private vf decorateComponent(@NotNull final fob info, final vt mutableComponent) {
        return (vf)((info.e() == ctm.d) ? mutableComponent.a(n.u) : mutableComponent);
    }
