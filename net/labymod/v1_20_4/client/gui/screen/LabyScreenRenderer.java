...
public class LabyScreenRenderer extends fdb implements FileDropHandler, LabyScreenAccessor
{
    ...
    public void a(@NotNull final ewu graphics, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
    ...
    public void b(final ewu graphics, final int mouseX, final int mouseY, final float tickDelta) {
        final Stack stack = ((VanillaStackAccessor)graphics.c()).stack();
    ...
    public void a(@NotNull final evi mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
