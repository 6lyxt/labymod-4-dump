...
public class TabLayoutConverter extends AbstractMinecraftWidgetConverter<ezj, AbstractWidget<?>>
{
    ...
    @Override
    public void update(final ezj source, final AbstractWidget<?> destination) {
        final TabNavigationBarAccessor accessor = (TabNavigationBarAccessor)source;
        final ezi tabManager = accessor.getTabManager();
