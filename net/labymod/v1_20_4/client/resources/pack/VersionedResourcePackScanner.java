...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner
{
    ...
    private boolean isExternalPack(final aow pack) {
    ...
    private IncompatibleResourcePack scanPack(final aow pack) {
    ...
    private void scanPack(final aow pack, final String baseDirectory, final aow.a output) {
        pack.a(aox.a, "minecraft", baseDirectory, output);
    }
    
    private Collection<String> collectIgnoredFiles(final aow pack) {
        final Set<String> ignoredFiles = new HashSet<String>();
        for (final String namespace : pack.a(aox.a)) {
            final aqa<InputStream> resource = (aqa<InputStream>)pack.a(aox.a, new ahg(namespace, "labymod/ignored_files.json"));
            if (resource == null) {
                continue;
            }
