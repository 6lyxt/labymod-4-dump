...
public class VersionedGameImageTexture extends geg implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((ahg)location.getMinecraftLocation());
    ...
    public void a(final aqi resourceManager) {
        this.prepareImage();
    }
