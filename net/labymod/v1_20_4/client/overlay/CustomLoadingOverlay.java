...
public class CustomLoadingOverlay extends fcn
{
    ...
    public CustomLoadingOverlay(final evi minecraft, final aqe reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final ewu gui, final int mouseX, final int mouseY, final float partialTicks) {
        final epf window = this.minecraft.aM();
