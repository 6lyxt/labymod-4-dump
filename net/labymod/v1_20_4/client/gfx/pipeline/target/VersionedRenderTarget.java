...
package net.labymod.v1_20_4.client.gfx.pipeline.target;
...
{
    private final eon renderTarget;
    
    public VersionedRenderTarget(final eon renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final eon renderTarget2 = this.renderTarget;
        ...
        final eon renderTarget3 = this.renderTarget;
