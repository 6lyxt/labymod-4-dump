...
public class VersionedShopItemLayer extends gcy<fsg, flc<fsg>>
{
    ...
    public VersionedShopItemLayer(final gai<fsg, flc<fsg>> layerParent) {
        super((gai)layerParent);
        this.playerModel = (flc<fsg>)layerParent.a();
    }
    
    public void render(@NotNull final eqb poseStack, @NotNull final fth bufferSource, final int packedLight, @NotNull final fsg player, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch) {
