...
{
    private static final Supplier<ftv> NULLABLE_SUPPLIER;
    private final eqg vertexFormat;
    private final Supplier<ftv> shaderSupplier;
    private final Collection<String> attributeNames;
    
    public VersionedVertexFormat(final eqg format) {
        this(format, VersionedVertexFormat.NULLABLE_SUPPLIER);
    }
    
    public VersionedVertexFormat(final eqg vertexFormat, final Supplier<ftv> shaderSupplier) {
