...
import net.labymod.v1_20_4.client.renderer.LabyModRenderType;
...
public class VersionedBufferBuilder implements BufferBuilder
{
    ...
    private static final Function<RenderPhase, ftp> RENDER_TYPE_FUNCTION;
    private final eqd tesselator;
    private final OldVertexFormatRegistry vertexFormatRegistry;
    private eqf consumer;
    private epw bufferBuilder;
    @Deprecated
    private fth.a bufferSource;
    private RenderPhase renderPhase;
    private ftp renderType;
    private OldVertexFormat currentFormat;
    private epw.b renderedBuffer;
    
    public VersionedBufferBuilder() {
        this.tesselator = eqd.b();
        this.vertexFormatRegistry = Laby.labyAPI().renderPipeline().vertexFormatRegistry();
    }
    
    public VersionedBufferBuilder(final epw builder) {
        this();
    ...
    public BufferBuilder begin(final int mode, final String format) {
        this.reset();
        this.bufferBuilder = this.tesselator.d();
        ...
        this.bufferBuilder.a(LabyModRenderType.getMode(mode), (eqg)vertexFormat.getMojangVertexFormat());
    ...
    public BufferBuilder begin(final RenderPhase phase, final VertexSorter vertexSorter, final boolean shouldCache) {
        ...
        if (vertexSorter != null) {
            ...
            if (source instanceof final fth multiBufferSource) {
    ...
    public void uploadToBuffer() {
        ...
        this.renderType.a(this.bufferBuilder, eqj.a);
    }
    ...
    public boolean building() {
        if (this.bufferBuilder != null) {
            return this.bufferBuilder.k();
        }
        final eqf consumer = this.consumer;
        if (consumer instanceof final epw bufferBuilder) {
            return bufferBuilder.k();
        }
        return false;
    }
    ...
    private BufferBuilder beginBufferBuilder(@NotNull final RenderPhase phase) {
        this.consumer = null;
        if (this.bufferBuilder != null && this.bufferBuilder.k()) {
            return this;
        }
        this.bufferBuilder = this.tesselator.d();
        final VersionedVertexFormat format = (VersionedVertexFormat)phase.getVertexFormat();
        format.applyShader();
        this.currentFormat = format;
        this.bufferBuilder.a(LabyModRenderType.getMode(phase.getMode()), (eqg)format.getMojangVertexFormat());
        return this;
    }
    
    @Nullable
    public epw getBufferBuilder() {
        return this.bufferBuilder;
    }
    
    public epw.b renderedBuffer() {
