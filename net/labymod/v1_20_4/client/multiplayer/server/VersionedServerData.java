...
public class VersionedServerData extends fod
{
    ...
    public void a(@NotNull final fod.a packStatus) {
        super.a(packStatus);
    ...
    public static fod.a of(final ServerResourcePackStatus resourcePackStatus) {
        return switch (resourcePackStatus) {
            case ENABLED -> fod.a.a;
            case DISABLED -> fod.a.b;
            default -> fod.a.c;
        };
    }
    
    public static ServerResourcePackStatus of(final fod.a resourceMode) {
