...
package net.labymod.v1_20_4.client.util.math;
...
public class VersionedGameMathMapper implements GameMathMapper
{
    ...
    public AxisAlignedBoundingBox fromAABB(final Object aabb) {
        if (aabb instanceof final elo gameAABB) {
    ...
    public <T> T toAABB(final AxisAlignedBoundingBox aabb) {
        return (T)new elo(aabb.getMinX(), aabb.getMinY(), aabb.getMinZ(), aabb.getMaxX(), aabb.getMaxY(), aabb.getMaxZ());
    }
