...
public class VersionedTextComponent extends VersionedBaseComponent<TextComponent, vg> implements TextComponent
{
    ...
    public VersionedTextComponent(final vt holder, final boolean empty) {
        super(holder);
        this.empty = empty;
    }
    ...
    public String getText() {
        ...
        if (contents instanceof final wm.a literal) {
            return literal.b();
        }
    ...
    public TextComponent text(final String text) {
        if (this.empty) {
            ((MutableComponentAccessor)this.holder).setContents((vg)new wm.a(text));
            this.empty = false;
            return this;
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof VersionedBaseComponent)) {
            return obj instanceof vt && this.holder.equals(obj);
        }
