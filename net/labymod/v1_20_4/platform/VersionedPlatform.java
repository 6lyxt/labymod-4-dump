...
import net.labymod.v1_20_4.client.render.vertex.VersionedVertexFormat;
...
public class VersionedPlatform extends Platform
{
    public void onInitialization() {
        this.setMinecraft((Minecraft)evi.O());
    ...
    private void registerVertexFormats() {
        this.register(VertexFormatType.POSITION_COLOR, this.createFormat(epz.n, fta::q));
        this.register(VertexFormatType.POSITION_TEXTURE_COLOR, this.createFormat(epz.s, fta::t));
        this.register(VertexFormatType.POSITION_COLOR_NORMAL, this.createFormat(epz.o, fta::aq));
        this.register(VertexFormatType.ENTITY, this.createFormat(epz.k, fta::L));
        this.register(VertexFormatType.POSITION_COLOR_TEXTURE_LIGHTMAP, this.createFormat(epz.t, fta::w));
    }
    ...
    @NotNull
    private OldVertexFormat createFormat(final eqg format, final Supplier<ftv> shaderSupplier) {
