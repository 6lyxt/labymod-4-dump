...
public abstract class MixinCompoundTag implements NBTTagCompound
{
    @Final
    @Shadow
    private Map<String, un> x;
    
    @Shadow
    public abstract un a(final String p0, final un p1);
    
    @Shadow
    public abstract void r(final String p0);
    
    @Shadow
    public abstract un shadow$c(final String p0);
    ...
    @Shadow
    public abstract tq shadow$p(final String p0);
    
    @Shadow
    public abstract tw c(final String p0, final int p1);
