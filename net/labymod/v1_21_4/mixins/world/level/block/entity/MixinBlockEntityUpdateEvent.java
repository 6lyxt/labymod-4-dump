...
public class MixinBlockEntityUpdateEvent
{
    ...
    private static void labyMod$fireTileEntityUpdateEvent(final dgj level, final ji pos, final dwy state, final InsertInfo ci) {
        final dua blockEntity = level.c_(pos);
