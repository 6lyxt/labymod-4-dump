...
public class MixinVertexBuffer
{
    ...
    private void labyMod$applyShaderInstance(final glj compiledShader, final Operation<Void> original) {
    ...
    private void labyMod$clearShaderInstance(final glj compiledShader, final Operation<Void> original) {
