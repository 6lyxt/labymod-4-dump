...
public class MixinShareToLanScreen implements CompletableShareToLanScreen
{
    ...
    private void labyMod$handleLanWorldOpenSuccess(final hje server, final fou button, final InsertInfo ci) {
    ...
    private void labyMod$handleLanWorldOpenFail(final hje server, final fou button, final InsertInfo ci) {
        if (this.labyMod$finishHandler != null) {
