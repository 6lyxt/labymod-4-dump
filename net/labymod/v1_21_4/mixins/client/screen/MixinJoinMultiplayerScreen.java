...
public class MixinJoinMultiplayerScreen
{
    ...
    public void clearTitle(final fof param0, final fod param1, final wp param2, final int param3, final int param4, final int param5) {
    }
    
    @Insert(method = { "join(Lnet/minecraft/client/multiplayer/ServerData;)V" }, at = @At("TAIL"))
    private void getServerData(final ggp serverData, final InsertInfo ci) {
