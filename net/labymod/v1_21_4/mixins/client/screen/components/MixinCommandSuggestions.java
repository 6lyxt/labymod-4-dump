...
public class MixinCommandSuggestions implements CommandSuggestionsAccessor
{
    ...
    private void labyMod$modifyBackgroundPosition(final fof graphics, final int left, final int top, final int right, final int bottom, final int color) {
    ...
    private int labyMod$modifyTextPosition(final fof graphics, final fod font, final ayl text, final int x, final int y, final int color) {
