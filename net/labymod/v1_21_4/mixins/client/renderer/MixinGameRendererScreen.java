...
public class MixinGameRendererScreen
{
    ...
    private void labyMod$storeStack(final fum instance, final fof graphics, final int mouseX, final int mouseY, final float tickDelta, final Operation<Void> original) {
