...
public abstract class MixinStyle implements Style
{
    ...
    @Shadow
    public abstract xm a(@Nullable final wv p0);
    ...
    @Shadow
    public abstract xm a(@org.jetbrains.annotations.Nullable final wn p0);
    
    @Shadow
    public abstract xm a(@org.jetbrains.annotations.Nullable final xo p0);
    ...
    @Shadow
    public abstract xm a(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract xm b(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract xm c(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract xm d(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract xm e(@org.jetbrains.annotations.Nullable final Boolean p0);
    
    @Shadow
    public abstract akv shadow$l();
    
    @Shadow
    public abstract xm a(@org.jetbrains.annotations.Nullable final akv p0);
    
    @Shadow
    public abstract xm a(@org.jetbrains.annotations.Nullable final String p0);
    ...
    public Style hoverEvent(final HoverEvent<?> hoverEvent) {
        return (Style)this.a((wv)hoverEvent);
    }
    ...
    public Style clickEvent(final ClickEvent clickEvent) {
        return (Style)this.a((wn)clickEvent);
    }
    ...
    public ResourceLocation style$getFont() {
        if (this.labyMod$fontLocation == null) {
            final akv resourceLocation = this.shadow$l();
    ...
    private Style set(final Boolean value, final Supplier<Boolean> getter, final Function<Boolean, xm> setter) {
