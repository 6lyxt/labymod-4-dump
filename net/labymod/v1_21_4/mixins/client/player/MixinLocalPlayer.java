...
public abstract class MixinLocalPlayer extends MixinAbstractLocalPlayer implements ClientPlayer
{
    ...
    @Shadow
    public abstract void a(final bsk p0);
    ...
    public boolean isUsingBow() {
        return this.labyMod$getClientPlayer().fB().h() == cwu.pa;
    }
    ...
    public void swingArm(final LivingEntity.Hand hand, final boolean cancelPacket) {
        final bsk interactionHand = (hand == LivingEntity.Hand.MAIN_HAND) ? bsk.a : bsk.b;
    ...
    public float getForwardMovingSpeed() {
        return this.labyMod$getClientPlayer().k.c;
    }
    ...
    private void labyMod$cancelHandSwingPacket(final bsk hand, final InsertInfo ci) {
