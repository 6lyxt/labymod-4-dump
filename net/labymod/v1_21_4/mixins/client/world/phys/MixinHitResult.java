...
public abstract class MixinHitResult implements HitResult
{
    ...
    private void labyMod$createApiVector(final fbb vector, final InsertInfo info) {
        this.labyMod$hitLocation = new FloatVector3((float)vector.d, (float)vector.e, (float)vector.f);
    }
    ...
    protected HitType labyMod$getHitType(final faz.a type) {
        switch (type) {
            case a: {
                return HitType.MISS;
            }
