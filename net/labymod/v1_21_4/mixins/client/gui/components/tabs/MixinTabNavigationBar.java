...
public abstract class MixinTabNavigationBar<T extends AbstractWidget<?>> extends fqp implements ConvertableMinecraftWidget<T>, TabNavigationBarAccessor
{
    ...
    private final Map<fqx, VersionedTab> versionedTabs;
    @Shadow
    @Final
    ...
    public MixinTabNavigationBar() {
        ...
        this.versionedTabs = new HashMap<fqx, VersionedTab>();
    }
    ...
    public VersionedTab versionedTabOf(final fqx tab) {
