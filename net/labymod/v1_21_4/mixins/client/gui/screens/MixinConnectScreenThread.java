...
public class MixinConnectScreenThread
{
    ...
    private Optional<ghr> labyMod$resolveAddress(final ghu resolver, final ghs address) {
    ...
    public wp labyMod$fireServerKickEvent(final wp reason) {
        ...
        return (wp)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(ConnectableServerData.from(data), componentMapper.fromMinecraftComponent(reason), ServerKickEvent.Context.PRE_LOGIN)).reason());
    }
}
