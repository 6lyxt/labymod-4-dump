...
@Mixin({ fvr.class })
public abstract class MixinCreativeModeInventoryScreen extends fvb<fvr.b>
{
    ...
    public MixinCreativeModeInventoryScreen(final fvr.b pickerMenu, final cox inventory, final wp component) {
        super((csd)pickerMenu, inventory, component);
    }
    ...
    private void labyMod$setEntityToOldPosition(final fof graphics, final int x, final int y, final int width, final int height, final int scale, final float modelHeight, final float mouseX, final float mouseY, final bvi entity) {
    ...
    private void labyMod$setOldCreativeTexture(final fof graphics, final Function<akv, gmj> renderTypeMapper, final akv location, final int $$1, final int $$2, final float $$3, final float $$4, final int $$5, final int $$6, final int $$7, final int $$8) {
        if (!this.labyMod$oldCreativeLayoutTexture) {
        ...
        if (resourceLocation != null) {
            graphics.a((Function)renderTypeMapper, (akv)resourceLocation.getMinecraftLocation(), $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8);
        }
    }
    ...
    private void labyMod$onSelectTab(final cvf tab, final CallbackInfo ci) {
        this.labyMod$modifySlots();
    }
    
    private void labyMod$modifySlots() {
        if (this.labyMod$oldCreativeLayoutTexture) {
            for (final cua slot : ((fvr.b)this.F()).k) {
    ...
    @NotNull
    private cua getSlotByIndex(@NotNull final InventoryLayoutOldAnimation inventoryLayout, @NotNull final InventorySlotData legacySlot, @NotNull final cua slot) {
