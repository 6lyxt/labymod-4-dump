...
public class MixinPlayerTabOverlay implements TabList
{
    ...
    private void shouldRenderWidgetList(final fof graphics, final int screenWidth, final fcg scoreboard, final fby objective, final InsertInfo ci) {
