...
public abstract class MixinResourceLocation implements ResourceLocation
{
    ...
    public InputStream openStream() throws IOException {
        ...
        return flk.Q().ac().getResource((akv)this.getMinecraftLocation()).orElseThrow(IOException::new).d();
    }
    
    @Override
    public boolean exists() {
        return ResourcesUtil.hasResource(this.getMinecraftLocation()) || flk.Q().ac().getResource((akv)this.getMinecraftLocation()).isPresent();
    }
