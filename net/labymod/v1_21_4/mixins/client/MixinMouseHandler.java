...
public abstract class MixinMouseHandler implements MouseHandlerAccessor
{
    ...
    private void redirectPlayerRotation(final gkx player, final double x, final double y) {
    ...
    public void grabMouseNative() {
        feq.a(this.b.aO().h(), 212995, this.b.aO().m() / 2.0, this.b.aO().n() / 2.0);
    }
    
    @Override
    public void ungrabMouseNative() {
        feq.a(this.b.aO().h(), 212993, this.b.aO().m() / 2.0, this.b.aO().n() / 2.0);
    }
    ...
    private Vector2i labyMod$fireHotbarSlotChangeEvent(final flt instance, final double $$0, final double $$1, final Operation<Vector2i> original) {
        final Vector2i mouseScroll = (Vector2i)original.call(new Object[] { instance, $$0, $$1 });
        if (mouseScroll.y == 0) {
            return mouseScroll;
        }
        final gkx player = this.b.t;
