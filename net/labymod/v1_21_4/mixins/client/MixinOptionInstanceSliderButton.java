...
{
    @Nullable
    private fln.g labyMod$wrappedIntRangeBase;
    @Shadow
    @Final
    private fln.k<T> e;
    ...
    private fln.g labyMod$createWrappedIntRangeBase() {
        ...
        if (fln.g.class.isAssignableFrom(cls)) {
            return (fln.g)new WrappedIntRangeBase((fln.g)this.e);
        }
        return null;
    }
}
