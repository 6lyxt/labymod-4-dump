...
package net.labymod.v1_21_4.mixins.client.entity.boss.enderdragon;
...
import net.labymod.v1_21_4.mixins.client.entity.MixinMob;
...
public abstract class MixinEnderDragon extends MixinMob implements EnderDragon
{
    ...
    private void labyMod$subParts(final but<? extends cjw> type, final dgj level, final InsertInfo info) {
        this.labyMod$parts = new ArrayList<EnderDragonPart>();
        for (final cjt part : this.cj) {
