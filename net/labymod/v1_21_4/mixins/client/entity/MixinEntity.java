...
public abstract class MixinEntity implements Entity
{
    ...
    public MixinEntity() {
        ...
        this.labyMod$entityId = Lazy.of(() -> (ResourceLocation)mb.f.b((Object)this.aq()));
    ...
    public boolean isInvisibleFor(final Player player) {
        return this.labyMod$getEntity().d((coy)player);
    }
    ...
    @Shadow
    public abstract bup a(final bvu p0);
    ...
    public boolean canEnterEntityPose(final EntityPose pose) {
        ...
        return minecraftPose != null && this.s.a((bum)this, this.a((bvu)minecraftPose).a(this.shadow$dt()).h(1.0E-7));
    }
    ...
    private void labyMod$setBoundingBox(final faw aabb, final InsertInfo info) {
