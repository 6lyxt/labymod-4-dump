...
public abstract class MixinCamera implements ExtendedMinecraftCamera
{
    ...
    public FloatVector3 deprecated$position() {
        final fbb position = this.b();
        this.labymod$cameraPosition.set((float)position.a(jn.a.a), (float)position.a(jn.a.b), (float)position.a(jn.a.c));
    ...
    public DoubleVector3 position() {
        final fbb position = this.b();
        this.labyMod$position.set(position.a(jn.a.a), position.a(jn.a.b), position.a(jn.a.c));
