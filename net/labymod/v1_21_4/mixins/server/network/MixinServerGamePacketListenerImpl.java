...
public class MixinServerGamePacketListenerImpl
{
    ...
    private void labyMod$fireDisconnectEventPre(final wp reason, final InsertInfo ci) {
    ...
    private void labyMod$fireDisconnectEventPost(final wp reason, final InsertInfo ci) {
        final GameProfile profile = (GameProfile)this.f.gh();
