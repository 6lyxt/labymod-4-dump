...
public class MixinConnection
{
    ...
    public wp labyMod$modifyReason(final wp component) {
        ...
        return (wp)componentMapper.toMinecraftComponent(Laby.fireEvent(new ServerKickEvent(serverData, componentMapper.fromMinecraftComponent(component), ServerKickEvent.Context.PLAY)).reason());
    }
}
