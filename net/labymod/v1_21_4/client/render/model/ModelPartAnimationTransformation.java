...
{
    public ModelPartAnimationTransformation(final gfe modelPart, final Transformation modelPartTransform) {
    ...
    private static class ModelPartPositionVector extends FloatVector3
    {
        ...
        public ModelPartPositionVector(final gfe modelPart, final FloatVector3 modelPartTranslation) {
    ...
    private static class ModelPartRotationVector extends FloatVector3
    {
        ...
        public ModelPartRotationVector(final gfe modelPart) {
            this.modelPart = modelPart;
        }
    ...
    private static class ModelPartScaleVector extends FloatVector3
    {
        ...
        public ModelPartScaleVector(final gfe modelPart) {
            this.modelPart = modelPart;
        }
