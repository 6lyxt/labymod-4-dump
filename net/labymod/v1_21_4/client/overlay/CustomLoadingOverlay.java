...
package net.labymod.v1_21_4.client.overlay;
...
public class CustomLoadingOverlay extends fuc
{
    private final flk minecraft;
    ...
    public CustomLoadingOverlay(final flk minecraft, final aul reload, final Consumer<Optional<Throwable>> onFinish, final boolean fadeIn) {
    ...
    public void a(final fof gui, final int mouseX, final int mouseY, final float partialTicks) {
        final fey window = this.minecraft.aO();
