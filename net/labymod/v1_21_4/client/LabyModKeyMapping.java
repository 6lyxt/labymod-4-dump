...
{
    private static final Function<Hotkey, fli> KEY_MAPPINGS;
    ...
    private LabyModKeyMapping(final String name, final KeyAccessor accessor, final String category) {
        super(name, (accessor.get() instanceof MouseButton) ? feq.b.c : feq.b.a, accessor.get().getId(), category);
        this.keyAccessor = accessor;
    }
    
    public static fli create(final Hotkey hotkey) {
    ...
    public feq.a i() {
        ...
        final feq.b type = (key instanceof MouseButton) ? feq.b.c : feq.b.a;
        return type.a(key.getId());
    }
    
    public void b(@NotNull final feq.a key) {
        super.b(key);
        final Key mappedKey = (key.a() == feq.b.a || key.a() == feq.b.b) ? KeyMapper.getKey(key.b()) : KeyMapper.getMouseButton(key.b());
