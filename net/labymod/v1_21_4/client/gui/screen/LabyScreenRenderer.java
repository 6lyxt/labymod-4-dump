...
public class LabyScreenRenderer extends fum implements FileDropHandler, LabyScreenAccessor
{
    ...
    public void a(@NotNull final fof graphics, final int mouseX, final int mouseY, final float tickDelta) {
        this.screen.pushCustomFontStack();
        ...
        screenContext.runInContext(stack, mouseX, mouseY, tickDelta, context -> {
            ...
            context.setFlushGraphicsAction(graphics::d);
    ...
    public void b(final fof graphics, final int mouseX, final int mouseY, final float tickDelta) {
        final Stack stack = ((VanillaStackAccessor)graphics.c()).stack();
    ...
    public void a(@NotNull final flk mc, final int width, final int height) {
        this.screen.pushCustomFontStack();
