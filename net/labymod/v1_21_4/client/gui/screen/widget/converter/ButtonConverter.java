...
public class ButtonConverter extends AbstractMinecraftWidgetConverter<foj, ButtonWidget>
{
    ...
    @Override
    public ButtonWidget createDefault(final foj source) {
        final ButtonWidget destination = ButtonWidget.component((source instanceof fpz.b) ? null : this.mapComponent(source.B()), null, Pressable.NOOP);
    ...
    @Override
    public void update(final foj source, final ButtonWidget destination) {
    ...
    @Override
    public String getWidgetId(final foj source) {
        return this.componentMapper.getTranslationKeyOfComponent(source.B());
    }
    
    @Override
    public List<String> getWidgetIds(final foj source) {
    ...
    {
        @Override
        public ButtonWidget map(final foj source) {
            if (source instanceof final fpg imageButton) {
    ...
    class LockIconButtonMapper implements Mapper<foj, ButtonWidget>
    {
        ...
        @Override
        public ButtonWidget map(final foj source) {
            if (source instanceof final fpk lockIconButton) {
