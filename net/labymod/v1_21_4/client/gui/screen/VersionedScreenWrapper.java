...
public class VersionedScreenWrapper implements ScreenWrapper
{
    ...
    public VersionedScreenWrapper(final fum screen) {
        if (screen == null) {
    ...
    public void render(final Stack stack, final MutableMouse mouse, final float partialTicks) {
        ((GuiGraphicsAccessor)this.graphics).setPose((ffv)stack.getProvider().getPoseStack());
    ...
    public void render(final ScreenContext context) {
        ((GuiGraphicsAccessor)this.graphics).setPose((ffv)context.stack().getProvider().getPoseStack());
