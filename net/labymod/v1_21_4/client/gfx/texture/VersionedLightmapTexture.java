...
package net.labymod.v1_21_4.client.gfx.texture;

import net.labymod.v1_21_4.client.renderer.LightTextureAccessor;
...
public class VersionedLightmapTexture extends AbstractLightmapTexture
{
    ...
    protected void applyLightmap(final int slot) {
        RenderSystem.setShaderTexture(slot, this.getTextureId());
