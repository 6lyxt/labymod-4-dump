...
package net.labymod.v1_21_4.client.gfx.pipeline.target;
...
{
    private final fef renderTarget;
    
    public VersionedRenderTarget(final fef renderTarget) {
        this.renderTarget = renderTarget;
        final List<RenderTargetAttachment> attachments = this.attachments;
        final int index = 0;
        final fef renderTarget2 = this.renderTarget;
        ...
        final fef renderTarget3 = this.renderTarget;
