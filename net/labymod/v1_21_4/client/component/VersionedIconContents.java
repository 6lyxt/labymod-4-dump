...
public class VersionedIconContents implements wq
{
    ...
    private static final wq.a<VersionedIconContents> TYPE;
    private Icon icon;
    private int width;
    private int height;
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final wu.a<T> consumer) {
    ...
    @NotNull
    public <T> Optional<T> a(@NotNull final wu.b<T> consumer, @NotNull final xm style) {
    ...
    static {
        ...
        TYPE = new wq.a((MapCodec)VersionedIconContents.CODEC, "icon");
    }
}
