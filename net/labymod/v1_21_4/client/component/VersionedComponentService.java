...
public class VersionedComponentService extends ComponentService
{
    ...
    public TextComponent createTextComponent(final String text) {
        return (TextComponent)((MutableComponentAccessor)wp.b(text)).getLabyComponent();
    }
    
    @Override
    public TextComponent createTextComponent(final String text, final Style style, final List<Component> children) {
        final xw.a contents = new xw.a(text);
        return (TextComponent)this.applyStyleAndSiblings((wq)contents, style, children);
    }
    
    @Override
    public ScoreComponent createScoreComponent(final String name, final String objective) {
        return (ScoreComponent)((MutableComponentAccessor)wp.b(name, objective)).getLabyComponent();
    }
    ...
    public ScoreComponent createScoreComponent(final String name, final String objective, final Style style, final List<Component> children) {
        final xx contents = new xx(Either.right((Object)name), objective);
        return (ScoreComponent)this.applyStyleAndSiblings((wq)contents, style, children);
    }
    
    @Override
    public KeybindComponent createKeybindComponent(final String keybind) {
        return (KeybindComponent)((MutableComponentAccessor)wp.d(keybind)).getLabyComponent();
    }
    
    @Override
    public KeybindComponent createKeybindComponent(final String keybind, final Style style, final List<Component> children) {
        final xt contents = new xt(keybind);
        return (KeybindComponent)this.applyStyleAndSiblings((wq)contents, style, children);
    }
    
    @Override
    protected IconComponent createIconComponent(final Icon icon) {
        return (IconComponent)((MutableComponentAccessor)xd.a((wq)new VersionedIconContents(icon))).getLabyComponent();
    }
    ...
    protected IconComponent createIconComponent(final Icon icon, final Style style, final List<Component> children) {
        ...
        return (IconComponent)this.applyStyleAndSiblings((wq)contents, style, children);
    }
    
    @Override
    public TextComponent createEmptyComponent() {
        return (TextComponent)((MutableComponentAccessor)wp.i()).getLabyComponent();
    }
    ...
    public <T> HoverEvent<T> createHoverEvent(@NotNull final HoverEvent.Action<T> action, @NotNull final T value) {
        ...
        if (value instanceof VersionedBaseComponent) {
            ...
            return (HoverEvent<T>)new wv(wv.a.a, (Object)component.holder);
        }
    ...
    public ClickEvent createClickEvent(final ClickEvent.Action action, @NotNull final String value) {
        Objects.requireNonNull(action, "Action cannot be null!");
        Objects.requireNonNull(value, "Value cannot be null!");
        final wn.a vanillaAction = switch (action) {
            default -> throw new MatchException(null, null);
            case OPEN_URL -> wn.a.a;
            case OPEN_FILE -> wn.a.b;
            case RUN_COMMAND -> wn.a.c;
            case SUGGEST_COMMAND -> wn.a.d;
            case CHANGE_PAGE -> wn.a.e;
            case COPY_TO_CLIPBOARD -> wn.a.f;
        };
        return (ClickEvent)new wn(vanillaAction, value);
    }
    
    @Override
    public TextColor createTextColor(final int value) {
        return (TextColor)xo.a(value);
    }
    
    @Override
    public TextColor getParsedTextColor(final String value) {
        final DataResult<xo> result = (DataResult<xo>)xo.a(value);
        return result.result().get();
    }
    
    @Override
    public TranslatableComponent createTranslatableComponent(final String key, final Component... arguments) {
        return (TranslatableComponent)((MutableComponentAccessor)wp.a(key, (Object[])arguments)).getLabyComponent();
    }
    ...
    public TranslatableComponent createTranslatableComponent(final String key, final Style style, final List<Component> children, final List<Component> arguments) {
        ...
        if (arguments == null) {
            ...
            contents = new ya(key, key, (Object[])arguments.toArray(new Component[0]));
        }
        return (TranslatableComponent)this.applyStyleAndSiblings((wq)contents, style, children);
    }
    ...
    public Style createStyleFromBuilder(final TextColor color, final Integer shadowColor, final Boolean bold, final Boolean italic, final Boolean underlined, final Boolean strikethrough, final Boolean obfuscated, final ClickEvent clickEvent, final HoverEvent<?> hoverEvent, final String insertion, final ResourceLocation fontLocation) {
        return (Style)new xm((xo)color, shadowColor, bold, italic, underlined, strikethrough, obfuscated, (wn)clickEvent, (wv)hoverEvent, insertion, (fontLocation == null) ? null : fontLocation.getMinecraftLocation());
    }
    ...
    private Component applyStyleAndSiblings(final wq componentContents, final Style style, final List<Component> children) {
        xm vanillaStyle;
        if (style == null) {
            vanillaStyle = xm.a;
        }
        ...
        final xd component = new xd(componentContents, (List)new ArrayList(), vanillaStyle);
