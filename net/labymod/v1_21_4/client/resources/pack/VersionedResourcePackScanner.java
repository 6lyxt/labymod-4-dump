...
public class VersionedResourcePackScanner extends AbstractResourcePackScanner
{
    @Override
    public void scan() {
        final aup resourceManager = flk.Q().ac();
    ...
    private boolean isExternalPack(final atc pack) {
    ...
    private IncompatibleResourcePack scanPack(final atc pack) {
    ...
    private void scanPack(final atc pack, final String baseDirectory, final atc.a output) {
        pack.a(ate.a, "minecraft", baseDirectory, output);
    }
    
    private Collection<String> collectIgnoredFiles(final atc pack) {
        final Set<String> ignoredFiles = new HashSet<String>();
        for (final String namespace : pack.a(ate.a)) {
            final auh<InputStream> resource = (auh<InputStream>)pack.a(ate.a, akv.a(namespace, "labymod/ignored_files.json"));
            if (resource == null) {
                continue;
            }
