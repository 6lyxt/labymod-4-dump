...
public class VersionedGameImageTexture extends hel implements GameImageTexture
{
    ...
    public VersionedGameImageTexture(final ResourceLocation location) {
        super((akv)location.getMinecraftLocation());
    ...
    private void _upload() {
        ...
        TextureUtil.prepareImage(this.a(), 0, this.image.a(), this.image.b());
        this.image.a(0, 0, 0, false);
    }
    
    public void a(final heu contents) {
        this.prepareImage();
    }
    
    public heu a(final aup $$0) throws IOException {
