...
public class VersionedTextureRepository extends DefaultAbstractTextureRepository implements TextureRepository
{
    ...
    public void onTick() {
        ...
        for (ResourceLocation resourceLocation : this.labyAPI.renderPipeline().resources().resourceLocationFactory().getCachedResourceLocations().values()) {
            if (resourceLocation instanceof final PathResourceLocation path) {
                final hev textureManager = this.getTextureManager();
                final akv minecraftLocation = resourceLocation.getMinecraftLocation();
                ...
                final hee texture = textureManager.b(minecraftLocation);
                texture.c();
    ...
    public void register(final ResourceLocation location, final Texture texture, @Nullable final Runnable finishHandler) {
        final hee minecraftTexture = this.convertToVersionedTexture(texture);
    ...
    public void registerTexture(final ResourceLocation location, final Object texture, final Runnable finishHandler) {
        if (texture instanceof final hee minecraftTexture) {
        ...
        throw new IllegalStateException(texture.getClass().getName() + " is not a subtype of " + hee.class.getName());
    }
    
    @Override
    public void preloadTexture(final ResourceLocation location) {
        this.registerTexture(location, (hee)new hel((akv)location.getMinecraftLocation()));
    }
    ...
    public Texture getTexture(final ResourceLocation location) {
        ...
        final hee texture = this.getTextureManager().b((akv)location.getMinecraftLocation());
    ...
    private void release(final ResourceLocation location, final Runnable releaseHandler) {
        this.getTextureManager().c((akv)location.getMinecraftLocation());
    ...
    private void registerTexture(@NotNull final ResourceLocation location, final hee texture) {
        final hev textureManager = this.getTextureManager();
    ...
    private void registerTexture(@NotNull final ResourceLocation location, final hee texture, final Runnable finishHandler) {
    ...
    private hee convertToVersionedTexture(final Texture texture) {
        if (texture instanceof final LabyTexture labyTexture) {
            return (hee)new VersionedLabyTexture(labyTexture);
        }
        if (texture instanceof final hee abstractTexture) {
            return abstractTexture;
        }
        throw this.createSubtypeException(texture, hee.class);
    }
}
